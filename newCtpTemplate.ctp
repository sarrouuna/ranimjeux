...
$pdf->SetTitle('Devis client');
$ent = 'entete.jpg';
$ModelSociete = ClassRegistry::init('Pointdevente');
$pontdevente = $ModelSociete->find('first',array('conditions'=>array('Pointdevente.id'=>$devi['Devi']['pointdevente_id'])));
...
$zone = $ModelSociete->find('first',array('conditions'=>array('Zone.id'=>$devi['Client']['zone_id'])));
//debug($devi);die;
...
<tr>
    <td width="70%" align="left" >
            ...
            <br><br>
            <center><strong>'.$soc['Societe']['adresse'].'</strong></center><br>
            <center><strong>'.$soc['Societe']['tel'].'</strong></center><br>
            <center><strong>'.$soc['Societe']['rib'].'</strong></center><br>
            <center><strong>'.$soc['Societe']['rc'].'</strong></center>   <br> 
            <center><strong>'.$soc['Societe']['codetva'].'</strong></center>   <br> 
            </td>
            </tr>
            </table>
    </td>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="left" style="border: 1px solid black;" >
                        <strong style="font-size:15;">Devis NÂ° :'.$devi['Devi']['numero'].'</strong><br><br> 
                        <strong style="font-size:10;">LE  :'.date("d/m/Y", strtotime(str_replace('-', '/',  $devi['Devi']['date']))).' </strong> <br> 
                    </td> 
                </tr>
            </table>
        </td>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="left" style="border: 3px solid black;">
                        <strong>Code Client&nbsp;:&nbsp;'.$devi['Client']['code'].'</strong><br>
                        <strong>Client&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;'.$devi['Client']['name'].'</strong><br>
                        <strong>Adresse&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;'.$devi['Client']['adresse'].' </strong><br>    
                        <strong>Ville&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;'.$zone['Zone']['name'].' </strong><br> 
                        <strong>Mat.Fisc&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;'.$devi['Client']['matriculefiscale'].' </strong><br>    
                    </td>     
                </tr>
            </table>
        </td>
...
<table cellpadding="2" cellspacing="0" >
    ...
    <tr>
        ...
        <td align="center" style="border: 1px solid black;background-color:#b8b8b8" width="40%"><strong>Article</strong></td>
        <td align="center" style="border: 1px solid black;background-color:#b8b8b8" width="10%"><strong>QuantitÃ©</strong></td>
...
<table cellpadding="2" cellspacing="0" >
    ...
    <tr>
        ...
        $n=0;
        $kk=0;
        $nbr_tot=count($lignedevis);
        $tot_rest=  number_format($nbr_tot,0);
...
$tbl .='
     ...
     <tr> 
        ...
        <td align="left" '.$styl_cadr_bottom.' width="40%" >&nbsp;'.substr($lr['Article']['name'],0,40).'</td>
        <td align="center" '.$styl_cadr_bottom.' width="10%">&nbsp;'.$lr['Lignedevi']['quantite']."/".$kk.'</td>  
        <td align="right" '.$styl_cadr_bottom.' width="7%" >&nbsp;'.number_format($lr['Lignedevi']['tva'],2, '.', ' ').'</td>
        <td align="right" '.$styl_cadr_bottom.' width="10%" >&nbsp;'.$lr['Lignedevi']['prix'].'</td>
        <td align="right" '.$styl_cadr_bottom.' width="8%" >&nbsp;'.number_format($lr['Lignedevi']['remise'],2, '.', ' ').'</td>
        <td align="right" '.$styl_cadr_bottom.' width="10%" >&nbsp;'.number_format($lr['Lignedevi']['totalht'],3, '.', ' ').'</td>    
...
if(($kk==37)){
        ...
        <td align="center" '.$styl_cadr_fin.' width="40%"></td>
...
//debug($hauteur);die;
   $tbl .='
    <tr>
        ...
        <td align="center" '.$styl_cadr_hauteur.' width="40%">&nbsp;<br></td>  
...
<tr>
        ...
        <td align="left" style="border: 1px solid black;background-color:#b8b8b8" width="38%">
            ...
            <td align="right" width="50%">'.number_format($devi['Devi']['totalht']+$devi['Devi']['remise'],3, '.', ' ').'&nbsp;&nbsp;</td>
            </tr>
            </table>
        </td>  
        </tr>     
        ...
        <td  align="right">'.number_format($devi['Devi']['remise'],3, '.', ' ').'</td>
        </tr>
        <tr>
        <td height="24px" align="left">NET H.TVA&nbsp;&nbsp;:</td>
        <td align="right">'.number_format($devi['Devi']['totalht'],3, '.', ' ').'</td>
        </tr>
        <tr >
        <td height="24px" align="left">TOTAL TVA  :</td>
        <td align="right">'.number_format($devi['Devi']['tva'],3, '.', ' ').'</td>
        </tr>
        <tr>
        <td height="24px" align="left">TIMBRE FIS&nbsp;:</td>
        <td align="right">'.number_format(@$devi['Timbre']['timbre'],3, '.', ' ').'</td>
        </tr>
        <tr>
        ...
        <td style="border-left:none;border-right:none;border-bottom: none;border-top:none;" align="right"><strong style="font-size:10;">'.number_format($devi['Devi']['totalttc'],3, '.', ' ').'</strong></td>
        </tr>
        </table>
        </td>  
</tr>    
...
<table >
    <tr>
        <td   width="100%" align="left" >
            <strong style="font-size:10;">Arreter la prÃ©sente Devi Ã Â  la somme de :</strong><br>
            <strong style="font-size:15;">'.chifre_en_lettre($devi['Devi']['totalttc'],1,1).'</strong>
        </td>
    </tr>
</table> 
';
