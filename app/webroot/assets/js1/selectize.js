...
(function (root, factory) {
    ...
    $.extend(Selectize.prototype, {
        ...
        refreshOptions: function (triggerDropdown) {
            ...
            if (!self.settings.hideSelected) { //alert();
...
//            console.log(settings_element.items);
//            console.log(settings_element.placeholder);
            ...
            var addOption = function ($option, group) {
                ...
                //console.log(options.hasOwnProperty(2));
            ...
            return function (e) {
                ...
                if (e.keyCode === KEY_BACKSPACE && this.$control_input.val() === '' && !this.$activeItems.length) {
                    ...
                    if (index >= 0 && index < this.items.length) {
                        option = this.options[this.items[index]];//console.log(option);
