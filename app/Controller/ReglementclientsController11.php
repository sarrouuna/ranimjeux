...
class ReglementclientsController extends AppController {
    ...
    public function index() {
        ...
        $this->set(compact('personnels','pointdeventeid', 'libres', 'libre_id', 'reglementclients', 'collections', 'transferecommandebls', 'marques', 'familles', 'clients', 'ligneclients', 'Date_debut', 'marque_id', 'Date_fin', 'client_id', 'exerciceid', 'num_recu', 'pointdeventes', 'exercices'));
    }
...
//              $this->loadModel('Famille'); 
    ...
    public function add($client_id = 0, $poinvente = 0,$personnel=0) {
        $lien = CakeSession::read('lien_vente');
        $vente = "";
        if (!empty($lien)) {
            foreach ($lien as $k => $liens) {
...
//            
        ...
        $this->loadModel('Personnel');
        $personnels = $this->Personnel->find('list');
        $this->set(compact('personnel','personnels','nameclt','impayes', 'poinvente', 'mm', 'numspecial', 'clients', 'client_id', 'facture', 'paiements', 'valeurs', 'pointdeventes'));
    }
    ...
    public function edit($id = null) {
        ...
        $this->loadModel('Personnel');
        $personnels = $this->Personnel->find('list');
        $this->set(compact('personnels','nameclt','id', 'impayes', 'pointdeventes', 'clients', 'client_id', 'facture', 'paiements', 'valeurs', 'facregclient', 'totalfacture', 'piecesregclient', 'retenue', 'date'));
    }
