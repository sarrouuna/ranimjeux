...
//        $condasos = 'Factureavoir.pointdevente_id in (' . $liste_pv . ')';
        ...
        $bonlivraisonparprix1s = $this->Lignelivraison->find('all', array(
            'fields' => array('EXTRACT(MONTH FROM Bonlivraison.date) as mois', 'sum(Lignelivraison.prix*(1-(Lignelivraison.remise/100))*(1+(Lignelivraison.tva/100))*Lignelivraison.quantite) as total', 'sum(Lignelivraison.quantite) as quantite')
...
//debug($bonlivraisonparprix1s) ;  
        ...
        $bonlivraisonparprix2s = $this->Lignelivraison->find('all', array(
            'fields' => array('EXTRACT(MONTH FROM Bonlivraison.date) as mois', 'sum(Lignelivraison.prix*(1-(Lignelivraison.remise/100))*(1+(Lignelivraison.tva/100))*Lignelivraison.quantite) as total', 'sum(Lignelivraison.quantite) as quantite')
            , 'conditions' => array( @$pvb, @$condb3, @$condb5, @$condb6, @$condb7, @$condb8, @$condb9, @$condb10, @$condbsos)
            , 'group' => array('EXTRACT(MONTH FROM Bonlivraison.date)')
...
//debug($bonlivraisonparprix2s) ;
        ...
        $factureclientparprix1s = $this->Lignefactureclient->find('all', array(
            'fields' => array('EXTRACT(MONTH FROM Factureclient.date) as mois', 'sum(Lignefactureclient.prix*(1-(Lignefactureclient.remise/100))*(1+(Lignefactureclient.tva/100))*Lignefactureclient.quantite) as total', 'sum(Lignefactureclient.quantite) as quantite')
        ...
        $factureavoirparprix1s = $this->Lignefactureavoir->find('all', array(
            'fields' => array('EXTRACT(MONTH FROM Factureavoir.date) as mois', 'sum(Lignefactureavoir.prix*(1-(Lignefactureavoir.remise/100))*(1+(Lignefactureavoir.tva/100))*Lignefactureavoir.quantite) as total', 'sum(Lignefactureavoir.quantite) as quantite')
        ...
        $factureavoirparprix2s = $this->Lignefactureavoir->find('all', array(
            'fields' => array('EXTRACT(MONTH FROM Factureavoir.date) as mois', 'sum(Lignefactureavoir.prix*(1-(Lignefactureavoir.remise/100))*(1+(Lignefactureavoir.tva/100))*Lignefactureavoir.quantite) as total', 'sum(Lignefactureavoir.quantite) as quantite')
...
//$articles = $this->Article->find('list');
        ...
        $this->set(compact('societes', 'countsos', 'factureavoirparprix2s', 'factureavoirparprix1s', 'pointdeventes', 'exerciceid2', 'exerciceid1', 'factureclientparprix2s', 'factureclientparprix1s', 'bonlivraisonparprix2s', 'bonlivraisonparprix1s', 'moiid', 'mois', 'familleid', 'personnelid', 'articleid', 'familles', 'totaleBLF', 'articles', 'tab', 'bonlivraisons', 'personnels', 'exerciceid1', 'exercice1s', 'exerciceid2', 'exercice2s', 'date1', 'date2', 'clientid', 'clients', 'factureclients'));
    }
    ...
    public function imprimerrecherche() {
        ...
        $bonlivraisonparprix1s = $this->Lignelivraison->find('all', array(
            'fields' => array('EXTRACT(MONTH FROM Bonlivraison.date) as mois', 'sum(Bonlivraison.totalttc) as total', 'sum(Lignelivraison.quantite) as quantite')
...
//debug($bonlivraisonparprix2s) ;
        ...
        $factureclientparprix1s = $this->Lignefactureclient->find('all', array(
            'fields' => array('EXTRACT(MONTH FROM Factureclient.date) as mois', 'sum(Factureclient.totalttc) as total', 'sum(Lignefactureclient.quantite) as quantite')
