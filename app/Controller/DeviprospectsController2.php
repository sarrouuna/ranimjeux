	...
	public function delete($id = null) {
      ...
      public function notifdevis() {
            ...
            $this->loadModel('Fournisseur');
             ...
             echo json_encode(array('fournisseurs'=>$fournisseurs,'notifdevis'=>$notifdevis,'devis'=>$devis,'d'=>$d,'listedevis'=>$listedevis,'lignevalides'=>$lignevalides,'nbdevis'=>$nbdevis,'nbrworkflows'=>$nbrworkflows));
             die;
	}   
