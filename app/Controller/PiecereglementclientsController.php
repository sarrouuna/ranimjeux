...
//                      ));
        ...
        public function recap() {
            ...
            $this->loadModel('Compte');
             ...
             $situationpiecereglements= $this->Situationpiecereglementclient->find('all',array('conditions'=>array('Situationpiecereglementclient.piecereglementclient_id'=>$piecereglement_id),false));                
             $comptes = $this->Compte->find('all');
             $this->set(compact('piecereglement_tab','comptes','piecereglement_id','etatpiecereglements','situationpiecereglements'));
        ...
        public function misajourrecap() {
            ...
            $this->loadModel('Situationpiecereglementclient');
             $this->layout = null;
             $data=$this->request->data;
             $piecereglement_id_tab= $data['piecereglementclient_id'];
             ...
             $situationfrs=$this->Situationpiecereglementclient->find('all',array('conditions'=>array('Situationpiecereglementclient.piecereglementclient_id'=>$piecereglement_id)));   
             foreach ($situationfrs as $k=>$situation){ 
             if($data['situation']==$situation['Situationpiecereglementclient']['situation']){
             $data['id']=$situation['Situationpiecereglementclient']['id'];    
             }else{
             $data['id']="";    
             }
             }
             ...
             $this->Situationpiecereglementclient->create();
             $this->Situationpiecereglementclient->save($data);
             $this->Piecereglementclient->updateAll(array('Piecereglementclient.datesituation' =>'"'.date("Y-m-d").'"','Piecereglementclient.situation' =>'"'.$stut.'"','Piecereglementclient.compte_id' =>$compte), array('Piecereglementclient.id' =>$piecereglement_id));
             $piecereg=$this->Piecereglementclient->find('first',array('conditions'=>array('Piecereglementclient.id'=>$piecereglement_id),'recursive'=>-1)); 
             $this->misejour("Reglementclient", "edit", $piecereg['Piecereglementclient']['reglementclient_id']);
             }}
