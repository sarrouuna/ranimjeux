...
//                      ));
        ...
        public function recapansiensituation() {
            $this->loadModel('Etatpiecereglement');
            $this->loadModel('Situationpiecereglement');
             $this->layout = null;
             $data=$this->request->data;
             $piecereglement_id= $data['piece_id'];
             $etatpiecereglements = $this->Etatpiecereglement->find('list',array('recursive'=>1));
             $situationpiecereglements= $this->Situationpiecereglement->find('all',array('conditions'=>array('Situationpiecereglement.piecereglement_id'=>$piecereglement_id)));                
             $piecereglement= $this->Piecereglement->find('first',array('conditions'=>array('Piecereglement.id'=>$piecereglement_id)));                
             $this->set(compact('piecereglement','piecereglement_id','etatpiecereglements','situationpiecereglements'));
        ...
        public function misajourrecap() {
            ...
            $this->loadModel('Piecereglement');
             ...
             //debug($data);die;
             if(!empty($data['id'])){
             $situationfrs=$this->Situationpiecereglement->find('first',array('conditions'=>array('Situationpiecereglement.id'=>$data['id'])));   
             if($data['situation']!=$situationfrs[Situationpiecereglement]['etatpiecereglement_id']){
             $data['id']='';    
             }
             }
