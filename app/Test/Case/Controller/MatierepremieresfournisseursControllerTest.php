<?php
App::uses('MatierepremieresfournisseursController', 'Controller');

/**
 * MatierepremieresfournisseursController Test Case
 *
 */
class MatierepremieresfournisseursControllerTest extends ControllerTestCase {
