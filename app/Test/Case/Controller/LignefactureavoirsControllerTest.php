<?php
App::uses('LignefactureavoirsController', 'Controller');

/**
 * LignefactureavoirsController Test Case
 *
 */
class LignefactureavoirsControllerTest extends ControllerTestCase {
