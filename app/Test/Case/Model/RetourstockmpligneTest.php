<?php
App::uses('Retourstockmpligne', 'Model');

/**
 * Retourstockmpligne Test Case
 *
 */
class RetourstockmpligneTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Retourstockmpligne = ClassRegistry::init('Retourstockmpligne');
	}
