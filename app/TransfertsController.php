		...
		if ($this->request->is('post') || $this->request->is('put')) {
			...
			if ($this->Transfert->save($this->request->data)) {
                           ...
                           foreach (  $lignetransfets as $lra   ){
                            $this->Stockdepot->updateAll(array('Stockdepot.quantite' => 'Stockdepot.quantite-'.$lra['Lignetransfert']['quantite']), array('Stockdepot.article_id' =>$lra['Lignetransfert']['article_id'],'Stockdepot.depot_id' =>$depotarriveans));
