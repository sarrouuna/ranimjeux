...
<!--                    <a  onClick="flvFPW1(wr+'Etatcaarticles/imprimerrecherche?clientid=<?php echo @$clientid;?>&exercice1=<?php echo @$exerciceid1;?>&exercice2=<?php echo @$exerciceid2;?>&familleid=<?php echo @$familleid;?>&personnelid=<?php echo @$personnelid;?>&articleid=<?php echo @$articleid;?>&moiid=<?php echo @$moiid;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>-->
...
<div class="row" style="width:100%">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Etat CA Article/Année'); ?></h3>
                                </div>
                                <div class="panel-body">
