...
<div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Modification Ordre de paiement'); ?></h3>
                                </div>
		...
		echo $this->Form->input('date',array('value'=>date("d/m/Y",strtotime(str_replace('-','/',$ordre['Ordre']['date']))),'div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly','type'=>'text','required data-bv-notempty-message'=>'Champ Obligatoire') );
	     ?>
                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                                ...
                                <tr>
                                    ...
                                    <td align="center" nowrap="nowrap">Annuler</td>    
                                ...
                                <tr class="cc" >
                                   <td style="width:24%">
                                    ...
                                    <td style="width:4%"> <input type="checkbox" name="data[Facture][<?php echo $i ;?>][ok]" index="<?php echo $i ;?>" class="postedit" value="1"></td>
