...
$pdf->SetTitle('Ordre de paiement');
...
<tr>
    ...
    <td  width="45%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>Ordre de paiement N°: '.$ordre['Ordre']['numero'].'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Date</strong>
                        <br>
                        '.date("d/m/Y",strtotime(str_replace('-','/',($ordre['Ordre']['date'])))).'
                    </td>
                    
                       <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Fournisseur</strong>
                        <br>
                        '.$ordre['Fournisseur']['name'].'
                    </td>
...
<table cellpadding="2" cellspacing="0" >
    ...
    <tr>
         <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="25%"><strong>Numero</strong></td>
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="25%"><strong>Total TTC</strong></td>
        <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="25%"><strong>Reste</strong></td>
          </tr>
    </thead>';

$long="670";
          $n=0;  
                     foreach ($factures as $i=>$f){ $reste=$f['Facture']['totalttc']-$f['Facture']['Montant_Regler'];
...
$tbl .='
     ...
     <tr> 
        <td align="center" style="border-bottom:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="25%" >&nbsp;<br>'.$f['Facture']['numero'].'</td>
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="25%">&nbsp;<br>'.date("d/m/Y",strtotime(str_replace('-','/',$f['Facture']['date']))).'</td>  
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="25%">&nbsp;<br>'.$f['Facture']['totalttc'].'</td>  
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="25%">&nbsp;<br>'.$reste.'</td>               
</tr>
...
';
    ...
    <tr>
        ...
        <td  height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;"  width="50%">'.$ordre['Ordre']['Montant'].'</td>  
