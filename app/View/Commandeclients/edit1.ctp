...
<br>
<input type="hidden" value="commandecommercial" id="page" />
                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                               ...
                               <tr class="tr" style="display:none;" >
                                    ...
                                    <td  >
                                        <?php echo $this->Form->input('article_id',array('div'=>'form-group','label'=>'', 'name' => '','table'=>'Lignecommandeclient','index'=>'','id'=>'article_id','champ'=>'article_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control articlecommandecomercial','empty'=>'Veuillez Choisir !!') );?>
                                    </td>
                                    <td >
                                ...
                                $stockdepots=$obj->find('all',array('conditions'=>array('Stockdepot.article_id'=>$l['Article']['id']),false)); 
                                //debug($stockdepots);
                                $qtestock=0;
                                ...
                                <tr class="cc testclientvide" >
                                    ...
                                    <td  >
                                       <?php echo $this->Form->input('article_id',array('value'=>$l['Article']['id'],'div'=>'form-group','label'=>'',  'name' => 'data[Lignecommandeclient]['.$i.'][article_id]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'article_id'.$i,'champ'=>'article_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select articlecommandecomercial','empty'=>'Veuillez choisir !!') );?>               
                                    </td> 
                                     <td >
