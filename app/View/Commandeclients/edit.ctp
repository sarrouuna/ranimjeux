                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                               ...
                               <tr class="tr" style="display:none;" >
                                    ...
                                    <td >
                                     <?php 
                                     echo $this->Form->input('prixachat',array('div'=>'form-group','label'=>'', 'name' => '','table'=>'Lignecommandeclient','index'=>'','id'=>'','champ'=>'prixachat','type'=>'hidden','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );
                                 ...
                                 <tr class="tr" style="display:none;" >
                                    ...
                                    <td colspan="12" id="" index="" champ="tddesg">
                                     ...
                                     //debug($lignecommandeclients);die;
                                            foreach ($lignecommandeclients as $i=>$l){ //debug($l);

                                                $qtestock=0;
                                                $objStockdepot = ClassRegistry::init('Stockdepot');
                                                $stock = $objStockdepot->find('first',array('conditions'=> array('Stockdepot.article_id' => $l['Lignecommandeclient']['article_id'],
                                                    'Stockdepot.depot_id' => $l['Lignecommandeclient']['depot_id']), 'fields' => array('ifnull(sum(Stockdepot.quantite),0) as qte')));
//debug($stock);die;
                                                $qtestock=$stock[0]['qte']+$l['Lignecommandeclient']['quantite'];
                                ...
                                <tr class="cc testclientvide" >
                                    ...
                                    <td>
                                    	 <?php	echo $this->Form->input('depot_id',array('value'=>$l['Depot']['id'],'onchange'=>'fuckfocus("select","'.$i.'",this.getAttribute("name"))','label'=>'','div'=>'form-group', 'name' => 'data[Lignecommandeclient]['.$i.'][depot_id]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'depot_id'.$i,'champ'=>'depot_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select depot_qte_s','empty'=>'Veuillez Choisir !!') );?>
                                    </td> 
                                    <td  >
                                     ...
                                     <td >
                                        <?php echo $this->Form->input('quantite',array('value'=>$l['Lignecommandeclient']['quantite'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','label'=>'','div'=>'form-group', 'name' => 'data[Lignecommandeclient]['.$i.'][quantite]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'quantite'.$i,'champ'=>'quantite','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control   calculefacture') );?>
                                    </td>
                                    <td >
                                     ...
                                     <?php echo $this->Form->input('prix',array('value'=>$l['Lignecommandeclient']['prix'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][prixhtva]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'prixhtva'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeinverseputtc') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('remise',array('value'=>$l['Lignecommandeclient']['remise'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][remise]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'remise'.$i,'champ'=>'remise','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeprix_net_ttc calculefacture') );
                                    ...
                                    <td >
                                     <?php echo $this->Form->input('prixnet',array('value'=>@$l['Lignecommandeclient']['prixnet'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][prixnet]','table'=>'Lignecommande','index'=>$i,'id'=>'prixnet'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  calculeremisenet') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('puttc',array('value'=>@$l['Lignecommandeclient']['puttc'],'div'=>'form-group','onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][puttc]','table'=>'Lignecommande','index'=>$i,'id'=>'puttc'.$i,'champ'=>'puttc','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  calculeprixvente') );
                                    ...
                                    <td >
                                     <?php echo $this->Form->input('totalttc',array('readonly'=>'readonly','value'=>$l['Lignecommandeclient']['totalttc'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][totalttc]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'totalttc'.$i,'champ'=>'totalttc','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
