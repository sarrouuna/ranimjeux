...
<table align="center" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" width="100%" >
    ...
    <tr bgcolor="#FFFFFF" align="center">
                       <th width="19%" align="center"  height="30px" ><strong>Client</strong></th>
                        ...
                        <th width="17%" align="center"  ><strong>Date Liv</strong></th>
    ...
    <?php
    $i=0; $ttc=$ht=0;
       foreach ($commandeclients as $br){  
        $ht=$ht+$br['Commandeclient']['totalht'];
        $ttc=$ttc+$br['Commandeclient']['totalttc'];
        $dateliv="";
        if(!empty($br['Commandeclient']['dateliv'])){
        $dateliv=date("d/m/Y",strtotime(str_replace('-','/',$br['Commandeclient']['dateliv'])));
        }
        ?>
        <tr bgcolor="#FFFFFF" align="center">    
        <td width="19%" nobr="nobr" align="center" height="30px" ><?php  echo $br['Client']['name'];?></td>
        <td width="10%" nobr="nobr" align="center"  ><?php  echo date("d/m/Y",strtotime(str_replace('-','/',$br['Commandeclient']['date'])));?></td>
        <td width="14%" nobr="nobr" align="center"  ><?php  echo $br['Commandeclient']['numero'];?></td>
        <td width="17%" nobr="nobr" align="center"  ><?php  echo $dateliv;?></td>
        <td width="12%" nobr="nobr" align="right"  ><?php  echo $br['Commandeclient']['totalht'];?></td>
        <td width="14%" nobr="nobr" align="right"  ><?php  echo $br['Commandeclient']['totalttc'];?></td>
    </tr>
