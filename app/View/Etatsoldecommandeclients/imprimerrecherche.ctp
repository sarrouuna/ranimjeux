...
$tbl .='
       <tr>
        ...
        <td  align="right"><strong>'.number_format(@$totttc,3, '.', ' ').'</strong></td>
...
$tbl .= 
    '<tr  align="center">    
        ...
        <td width="8%" nobr="nobr" align="right"  >'.number_format($b,3, '.', ' ').'</td> 
 ...
 if(($testclient==1)&&($testarticle==0)){$val="Client"; }else { $val="Article";  }       
 $tottt=sprintf('%.3f',$totttc);
      $tbl .=  
       ' 
           <tr  align="center">  
                <td colspan="3" bgcolor="#F2D7D5" align="center"    ><strong>Total'. $val.'</strong></td>
                ...
                <td  align="right" width="8%"><strong>'.number_format(@$tottt,3, '.', ' ').'</strong></td>
                <td colspan="2" bgcolor="#F2D7D5" align="center"><strong>   </strong></td>
           </tr>';
...
$tbl .=  
       ' 
           <tr  align="center">  
                <td colspan="3" bgcolor="#F2D7D5" align="center"    ><strong>Total Générale</strong></td>
                <td  align="right" width="6%"><strong>'.@$totqteg.'</strong></td>
                <td  align="right" width="6%"><strong>'.@$totqtelivg.'</strong></td>     
                <td  align="right" width="8%"><strong>'.@$totsoldeg.'</strong></td>
                <td  align="right" width="8%"><strong>'.number_format($totttcg,3, '.', ' ').'</strong></td>
                <td colspan="2" bgcolor="#F2D7D5" align="center"><strong>   </strong></td>
           </tr>';           
