...
<div class="row" >
		...
		echo $this->Form->input('montant',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );
                ...
                <?php
                echo $this->Form->input('carnetcheque_id',array('label'=>'Souche chequier','div'=>'form-group','between'=>'<div class="col-sm-10">','index'=>0,'champ'=>'carnetcheque_id','after'=>'</div>','class'=>'form-control select getnumcheque','required data-bv-notempty-message'=>'Champ Obligatoire','empty'=>'Veuillez choisir !!') );
	       ?>
               ...
               <?php
		echo $this->Form->input('echance',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly','type'=>'text','required data-bv-notempty-message'=>'Champ Obligatoire') );
	       ?>
  </div>               
