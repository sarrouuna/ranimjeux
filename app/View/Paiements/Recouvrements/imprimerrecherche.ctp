...
<tr>
    <td bgcolor="#EAEAEA" width="40%" align="center" colspan="3"><strong> Solde départ </strong></td> 
...
$clt_id=$relefe['Client']['id'];                    
   if($relefe['Recouvrement']['debit']!=null) {
    ...
    '<tr  align="center">    
        ...
        <td width="10%" nobr="nobr" align="right"   >'.number_format(@$relefe['Recouvrement']['debit'],3, '.', ' ').'</td>
        <td width="10%" nobr="nobr" align="right"   >'.number_format(@$relefe['Recouvrement']['credit'],3, '.', ' ').'</td>
        <td width="10%" nobr="nobr" align="right"  >'.number_format(@$relefe['Recouvrement']['impaye'],3, '.', ' ').'</td>
        <td width="10%" nobr="nobr" align="right"  >'.number_format(@$relefe['Recouvrement']['reglement'],3, '.', ' ').'</td> 
        <td width="10%" nobr="nobr" align="right"  >'.number_format(@$relefe['Recouvrement']['avoir'],3, '.', ' ').'</td> 
