...
<ul class="mainNav" id="divparametrage" style="display:none">
     <?php 
...
<ul  class="mainNav" id="divstock" style="display:none">
<?php
...
<ul class="mainNav" id="divachat" style="display:none">
...
<ul class="mainNav" id="divvente" style="display:none">
<?php 
...
<ul class="mainNav" id="divfinance" style="display:none">
<?php
