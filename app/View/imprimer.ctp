...
$tbl .='
     ...
     <tr> 
        ...
        <td align="left" '.$styl_cadr_bottom.' width="36%" >&nbsp;'.substr($lr[$ligne_model]['designation'],0,40).'</td>
        ...
        <td align="right" '.$styl_cadr_bottom.' width="5%" >&nbsp;'.number_format($lr[$ligne_model]['remise'],2, '.', ' ').'</td>
