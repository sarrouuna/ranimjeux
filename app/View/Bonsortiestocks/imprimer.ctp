...
<table>
    ...
    <td width="25%"></td>
        <td width="50%">
            <table >
                <tr>
                    <td align="center" width="100%" colspan="4" '.$styl_cadr.'  ><strong> Bon Sortie stock </strong></td>
                </tr>
                <tr>
                 ...
                 <tr>
                    <td align="center" width="50%" '.$styl_cadr.' >'.$bonsortiestock['Bonsortiestock']['numero'].'</td>
                    <td align="center" width="50%" '.$styl_cadr.' > '.date("d/m/Y", strtotime(str_replace('-', '/',  $bonsortiestock['Bonsortiestock']['date']))).'  </td>
                 </tr>
            </table>
        </td>
...
$long="670";
          $n=0;   //debug($deviprospect);die;
                                                        foreach ($lignebonsortiestocks as $i=>$lr){
                                            $n=$n+30;    
...
<tr> 
        <td align="left" style="border-bottom:1px solid black;border-left:1px solid black;border-right:1px solid black;" width="20%">&nbsp;'. $lr['Depot']['designation'].'</td> 
        <td align="left" style="border-bottom:1px solid black;border-left:1px solid black;border-right:1px solid black;" width="20%" >&nbsp;'.$lr['Article']['code'] .'</td>
        <td align="left" style="border-bottom:1px solid black;border-right:1px solid black;" width="50%">&nbsp;'.$lr['Article']['name'].'</td>  
        <td align="center" style="border-bottom:1px solid black;border-right:1px solid black;" width="10%">&nbsp;'.$lr['Lignebonsortiestock']['quantite'].'</td>  
