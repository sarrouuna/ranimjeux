...
<!--                    <li><a class="refresh" href="javascript:void(0)"><i class="fa fa-refresh"></i></a></li>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">                  
                    ...
                    echo $this->Form->input('fournisseur_id', array('multiple'=>'multiple','id' => 'client_id', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control', 'required data-bv-notempty-message' => 'Champ Obligatoire', 'empty' => 'Veuillez choisir..'));
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3" >
                        ...
                        <a  onClick="flvFPW1(wr + 'Recouvrements/imprimerrecherchefrs?date1=<?php echo @$date1; ?>&date2=<?php echo @$date2; ?>&name=<?php echo @$name; ?>', 'UPLOAD', 'width=800,height=1150,scrollbars=yes', 0, 2, 2);
                                ...
                                <?php if (!empty($name)) { ?>                     
                                    ...
                                    <tr><td colspan="9" style="height: 10px;" ></td></tr> </thead><tbody>
                                        ...
                                        foreach ($relefes as $i => $relefe) {
                                            ...
                                            <?php if ($relefe['Recouvrement']['fournisseur_id'] != $clt_id) { 
                                            $client_ans = ClassRegistry::init('Fournisseur')->find('first', array('conditions' => array('Fournisseur.id' =>$clt_id), 'recursive' => 0));
                                            ?>
                                                <?php if ($i != 0) {
                                                    ?>
                                                    <tr><td colspan="9" style="height: 10px;" ></td></tr>
                                                    <tr>
                                                        <td colspan="3" style="background-color: #F2D7D5;" align="center"><strong> Total <?php echo @$client_ans['Fournisseur']['code'] . "  " . @$client_ans['Fournisseur']['name']; ?>  </strong></td>    
                                                ...
                                                ?> 
                                                <?php
                                                $clientt = ClassRegistry::init('Fournisseur')->find('first', array('conditions' => array('Fournisseur.id' => $relefe['Recouvrement']['fournisseur_id']), 'recursive' => 0));
                                                if(!empty($clientt['Fournisseur']['solderecouvrement'])){
                                                    //debug("1");
                                                $soldeint = $clientt['Fournisseur']['solderecouvrement'];
                                                }else{
                                                   // debug("2");
                                                $soldeint =0;    
                                                }
                                                ...
                                                $clientid = @$relefe['Recouvrement']['fournisseur_id'];
                                                $sldd = 0;
                                                $sld = 0;
                                                //$sldtot=$soldeint;
                                                $sld = $soldeint;
...
//            $sldd=$soldeint;
                                        ...
                                        <tr><td colspan="9" style="height: 10px;" ></td></tr>
                                        <tr>
                                            <td colspan="3" style="background-color: #F2D7D5;" align="center"><strong> Total <?php echo @$relefe['Fournisseur']['code'] . "  " . @$relefe['Fournisseur']['name']; ?> </strong></td>    
                                            <td  align="right"><strong><?php echo number_format(@$totdebit, 3, '.', ' '); ?></strong></td>
                                            <td  align="right"><strong><?php echo number_format(@$totcredit, 3, '.', ' '); ?></strong></td>
                                            <td  align="right"><strong><?php echo number_format(@$totimpayer, 3, '.', ' '); ?></strong></td>
                                            <td  align="right"><strong><?php echo number_format(@$totreg, 3, '.', ' '); ?></strong></td>
