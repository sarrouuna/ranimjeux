...
<!--                    <li><a class="refresh" href="javascript:void(0)"><i class="fa fa-refresh"></i></a></li>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">                  
                    ...
                    echo $this->Form->input('client_id', array('multiple'=>'multiple','id' => 'client_id', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control', 'required data-bv-notempty-message' => 'Champ Obligatoire', 'empty' => 'Veuillez choisir..'));
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3" >
                        ...
                        <a  onClick="flvFPW1(wr + 'Recouvrements/imprimerrecherche?date1=<?php echo @$date1; ?>&date2=<?php echo @$date2; ?>&name=<?php echo @$name; ?>', 'UPLOAD', 'width=800,height=1150,scrollbars=yes', 0, 2, 2);
...
//            $sldd=$soldeint;
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="6"  ><strong>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$relefe['Client']['code'] . "  " . @$relefe['Client']['name']; ?></strong></td>
                                                    <td colspan="2"  >FINANCIER : <?php echo @$relefe['Client']['tel']; ?></td>
                                                </tr>
                                                <tr>
