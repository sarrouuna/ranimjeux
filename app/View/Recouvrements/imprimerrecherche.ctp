    ...
    foreach ($relefes as $i => $relefe) {
       ...
       <tr>
        ...
        <td  align="right"><strong>' . number_format(@$totsolde, 3, '.', ' ') . '</strong></td>
            ...
            $tbl .='<tr>
    <td bgcolor="#EAEAEA" align="center"><strong> Client </strong></td>    <td colspan="8" align="left" ><strong>&nbsp;&nbsp;&nbsp;&nbsp;' . @$relefe['Client']['code'] . '  ' . @$relefe['Client']['name'] . ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TEL '.@$relefe['Client']['tel'] .'</strong></td>
</tr>
<tr>
