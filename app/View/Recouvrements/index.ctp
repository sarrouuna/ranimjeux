            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3" >
                        ...
                        <a  onClick="flvFPW1(wr + 'Recouvrements/imprimerrecherche_html?date1=<?php echo @$date1; ?>&date2=<?php echo @$date2; ?>&name=<?php echo @$name; ?>', 'UPLOAD', 'width=800,height=1150,scrollbars=yes', 0, 2, 2);
