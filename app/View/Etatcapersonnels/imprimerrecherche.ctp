...
<tr>
    ...
    <td  width="45%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>CA Par Personnel  '.@$m.'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr bgcolor="#FFFFFF" align="center">
        ...
        $totcl=0;        
               ...
               $hh=1;$st=0;     
              if($cl!=$action['Tabetatcaparpersonnel']['clientid']){
                       $cl=$action['Tabetatcaparpersonnel']['clientid'];
                       $nom=$action['Tabetatcaparpersonnel']['name'];
...
$i++;
    ...
    '<tr bgcolor="#FFFFFF" align="center">    
        ...
        <td width="35%" nobr="nobr" align="center"  $zz>'.$action['Tabetatcaparpersonnel']['article'].'</td>
