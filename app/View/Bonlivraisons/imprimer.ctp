...
$pontdevente = $ModelSociete->find('first',array('conditions'=>array('Pointdevente.id'=>$bonlivraison['Bonlivraison']['pointdevente_id'])));
...
$zone = $ModelSociete->find('first',array('conditions'=>array('Zone.id'=>$bonlivraison['Client']['zone_id'])));
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border: 1px solid black;" >
                        <strong style="font-size:15;">Bon de livraison N°:'.$bonlivraison['Bonlivraison']['numero'].'</strong><br><br> 
                        <strong style="font-size:10;">LE  :'.date("d/m/Y", strtotime(str_replace('-', '/',  $bonlivraison['Bonlivraison']['date']))).' </strong> <br> 
                    </td> 
                </tr>
            </table>
        </td>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="left" style="border: 3px solid black;">
                        <strong>Code Client&nbsp;:&nbsp;'.$bonlivraison['Client']['code'].'</strong><br>
                        <strong>Client&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;'.$bonlivraison['Client']['name'].'</strong><br>
                        <strong>Adresse&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;'.$bonlivraison['Client']['adresse'].' </strong><br>    
                        <strong>Ville&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;'.$zone['Zone']['name'].' </strong><br> 
                        <strong>Mat.Fisc&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;'.$bonlivraison['Client']['matriculefiscale'].' </strong><br>    
                    </td>     
                </tr>
            </table>
        </td>
    ...
    <tr >
        <td width="49%" '.$styl_cadr.'>
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border: 1px solid black;" >
                        <strong style="font-size:15;">BL N°:'.$bonlivraison['Bonlivraison']['numero'].'</strong><br><br> 
                        <strong style="font-size:10;">LE  :'.date("d/m/Y", strtotime(str_replace('-', '/',  $bonlivraison['Bonlivraison']['date']))).' </strong> <br> 
                    </td> 
                </tr>
            </table>
...
<table cellpadding="2" cellspacing="0" >
    ...
    ';
        ...
        $n=0;
        $kk=0;
        $nbr_tot=count($lignelivraisons);
        $tot_rest=$nbr_tot;
        $hauteur=380;
        foreach ($lignelivraisons as $i=>$lr){
        ...
        $n=$n+10;   
        $long=$long-10;
        if($lr['Lignelivraison']['prix']==0){
        $lr['Lignelivraison']['prix']="";
        }
        if($lr['Lignelivraison']['remise']==0){
        $lr['Lignelivraison']['remise']="";
        }
        if($lr['Lignelivraison']['tva']==0){
        $lr['Lignelivraison']['tva']="";
        }
        if($lr['Lignelivraison']['totalht']==0){
        $lr['Lignelivraison']['totalht']="";
        }
        if($lr['Lignelivraison']['totalttc']==0){
        $lr['Lignelivraison']['totalttc']="";
        }
$tbl .='
    
     <tr> 
        <td align="left" '.$styl_cadr_bottom.' width="15%" >&nbsp;'. $lr['Article']['code'].'</td>
        <td align="left" '.$styl_cadr_bottom.' width="30%" >&nbsp;'.substr($lr['Lignelivraison']['designation'],0,40).'</td>
        <td align="center" '.$styl_cadr_bottom.' width="10%">&nbsp;'.$lr['Lignelivraison']['quantite'].'</td>  
        <td align="right" '.$styl_cadr_bottom.' width="7%" >&nbsp;'.number_format($lr['Lignelivraison']['tva'],2, '.', ' ').'</td>
        <td align="right" '.$styl_cadr_bottom.' width="10%" >&nbsp;'.$lr['Lignelivraison']['prix'].'</td>
        <td align="right" '.$styl_cadr_bottom.' width="8%" >&nbsp;'.number_format($lr['Lignelivraison']['remise'],2, '.', ' ').'</td>
        <td align="right" '.$styl_cadr_bottom.' width="10%" >&nbsp;'.$lr['Lignelivraison']['puttc'].'</td>
        <td align="right" '.$styl_cadr_bottom.' width="10%" >&nbsp;'.number_format($lr['Lignelivraison']['totalht'],3, '.', ' ').'</td>    
        
        
</tr>
    
';
//debug($lr['Lignelivraison']);die;
$hauteur=$hauteur-13;
if($tot_rest !=37){
if(($kk==37)){
...
<tr>
        ...
        <td align="left" style="border: 1px solid black;background-color:#b8b8b8" width="38%">
            ...
            <td align="right" width="50%">'.number_format($bonlivraison['Bonlivraison']['totalht']+$bonlivraison['Bonlivraison']['remise'],3, '.', ' ').'&nbsp;&nbsp;</td>
            </tr>
            </table>
        </td>  
        </tr>     
        ...
        <table >';
        $obj = ClassRegistry::init('Lignelivraison');
        $lignefactureclientstva = $obj->find('all',array('fields'=>array(
        'SUM((Lignelivraison.totalht*Lignelivraison.tva)/100)  mtva'
        ,'SUM(Lignelivraison.totalht) totalht'
        ,'AVG(Lignelivraison.tva) tva'),
        'conditions'=>array('Lignelivraison.bonlivraison_id' => $bonlivraison['Bonlivraison']['id'])
        ,'group'=>array('Lignelivraison.tva')       
        ));
        $tva=0;
        ...
        <td  align="right">'.number_format($bonlivraison['Bonlivraison']['remise'],3, '.', ' ').'</td>
        </tr>
        <tr>
        <td height="24px" align="left">NET H.TVA&nbsp;&nbsp;:</td>
        <td align="right">'.number_format($bonlivraison['Bonlivraison']['totalht'],3, '.', ' ').'</td>
        </tr>
        <tr >
        <td height="24px" align="left">TOTAL TVA  :</td>
        <td align="right">'.number_format($bonlivraison['Bonlivraison']['tva'],3, '.', ' ').'</td>
        </tr>
        <tr>
        <td height="24px" align="left">TIMBRE FIS&nbsp;:</td>
        <td align="right">'.number_format($bonlivraison['Timbre']['timbre'],3, '.', ' ').'</td>
        </tr>
        <tr>
        ...
        <td style="border-left:none;border-right:none;border-bottom: none;border-top:none;" align="right"><strong style="font-size:10;">'.number_format($bonlivraison['Bonlivraison']['totalttc'],3, '.', ' ').'</strong></td>
        </tr>
        </table>
        </td>  
</tr>    
...
<table >
    <tr>
        <td   width="100%" align="left" >
            <strong style="font-size:10;">Arreter la présente Bonlivraison à  la somme de :</strong><br>
            <strong style="font-size:15;">'.chifre_en_lettre($bonlivraison['Bonlivraison']['totalttc'],1,1).'</strong>
        </td>
    </tr>
</table> 
';
