...
//debug($stock);die;
                             ...
                             <?php	//echo $this->Form->input('article_id',array('value'=>$l[0]['article_id'],'label'=>'','div'=>'form-group', 'name' => 'data[Lignelivraison]['.$i.'][article_id]','table'=>'Lignelivraison','index'=>$i,'id'=>'article_id'.$i,'champ'=>'article_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select articleidbl','empty'=>'Veuillez Choisir !!') );?>
                               ...
                               <!--     <td style="width:15%"  champ="tdarticle" id="tdarticle0" >
                                     ...
                                     <td >
                                        <?php echo $this->Form->input('quantite',array('value'=>$l[0]['quantite'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','label'=>'','div'=>'form-group', 'name' => 'data[Lignelivraison]['.$i.'][quantite]','table'=>'Lignelivraison','index'=>$i,'id'=>'quantite'.$i,'champ'=>'quantite','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control testqte  calculefacture') );?>
                                    </td>
                                    <td >
                                     <?php //echo $this->Form->input('prixachat',array('value'=>$l['Lignelivraison']['prixachat'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignelivraison]['.$i.'][prixachat]','table'=>'Lignelivraison','index'=>'0','id'=>'prixachat0','champ'=>'prixachat','type'=>'hidden','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                     <?php echo $this->Form->input('prix',array('value'=>$l[0]['prix']/$l[0]['quantite'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','div'=>'form-group','label'=>'', 'name' => 'data[Lignelivraison]['.$i.'][prixhtva]','table'=>'Lignelivraison','index'=>$i,'id'=>'prixhtva'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeinverseputtc') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('remise',array('value'=>$l[0]['remise']/$l[0]['quantite'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','div'=>'form-group','label'=>'', 'name' => 'data[Lignelivraison]['.$i.'][remise]','table'=>'Lignelivraison','index'=>$i,'id'=>'remise'.$i,'champ'=>'remise','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeprix_net_ttc calculefacture') );
                                    ...
                                    <td >
                                     ...
                                     echo $this->Form->input('totalhtans',array('value'=>$l[0]['prix']/$l[0]['quantite'],'type'=>'hidden','div'=>'form-group','label'=>'','name' => 'data[Lignelivraison]['.$i.'][totalhtans]','table'=>'Lignecommande','index'=>$i,'id'=>'totalhtans'.$i,'champ'=>'totalhtans','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('totalht',array('value'=>$l[0]['totalht'],'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','div'=>'form-group','label'=>'','readonly'=>'readonly', 'name' => 'data[Lignelivraison]['.$i.'][totalht]','table'=>'Lignelivraison','index'=>$i,'id'=>'totalht'.$i,'champ'=>'totalht','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php echo $this->Form->input('tva',array('value'=>$l[0]['tva'],'readonly'=>'readonly','div'=>'form-group','label'=>'', 'name' => 'data[Lignelivraison]['.$i.'][tva]','table'=>'Lignelivraison','index'=>$i,'id'=>'tva'.$i,'champ'=>'tva','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control editfacture calculefacture') );?>
                                    </td>
                                    <td >
