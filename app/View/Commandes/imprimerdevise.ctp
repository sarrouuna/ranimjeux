...
<table width="100%">
                <tr>
                    <td align="right" width="100%"  ><strong> Commande en fonction de devise</strong></td>
                    <br><br>
                </tr> 
    <tr>
...
<tr> 
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="10%">&nbsp;'.$lr['Lignecommande']['prix'].'</td>  
        <td align="right" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="10%">&nbsp;'.sprintf('%.3f',$lr['Lignecommande']['prix']*$lr['Lignecommande']['quantite']).'</td> 
...
$devise=$commande['Importation']['devise_id'];
