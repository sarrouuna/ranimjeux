...
<div class="row" >
  ...
  <div class="col-md-6"> 
	...
	echo $this->Form->input('paiement_id',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','empty'=>'Veuillez choisir') );
        ...
        ?>
                ...
                <div class="form-group">
                 ...
                 <a class="btn btn-primary" href="<?php echo $this->webroot;?>Piecereglements/index"/>Afficher Tout </a>
                    
<a onClick="flvFPW1(wr+'Piecereglements/imprimerindex?Date_debut=<?php echo @$Date_debut;?>&Date_deb=<?php echo @$Date_deb;?>&situation=<?php echo @$situation;?>&Date_fin=<?php echo @$Date_fin;?>&Date_fn=<?php echo @$Date_fn;?>&fournisseur_id=<?php echo @$fournisseur_id;?>&compte_id=<?php echo @$compte_id;?>&paiement_id=<?php echo @$paiement_id;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
...
<br><input type="hidden" id="page" value="1"/>
 <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Engagment Fournisseur Interne'); ?></h3>
                                </div>
                                <div class="panel-body">
