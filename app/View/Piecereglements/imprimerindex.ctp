...
<tr>
    ...
    <td  width="45%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>liste des Pieces '.$m.'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
...
$bn=0;$compt=0;
            $bn= $piece['Compte']['banque'];  //debug($bn);die;
            $compt= $piece['Compte']['rib'];
            $tot_esc=$tot_esc+$piece['Piecereglement']['montant'];
 ...
 $tbl .= '      
                <tr bgcolor="#FFFFFF" align="center">  
                    <td colspan="5"width="84%" nobr="nobr" align="center" height="30px" ></td>
                    <td width="16%" nobr="nobr" align="center"  $zz><strong>'.$tot_esc.'</strong></td>
                </tr>';
}
//------------------------------------- Impaye ----------------------
        if(!empty($piece_imp)){
