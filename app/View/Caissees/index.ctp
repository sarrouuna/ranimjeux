        ...
        <?php echo $this->Form->create('Caissee',array('autocomplete' => 'off','class'=>'form-horizontal ls_form')); ?>
               ...
               <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php // if($imprimer==1){ ?>
      <a  onClick="flvFPW1(wr+'Caissees/imprimer?date1=<?php echo @$date1;?>&date2=<?php echo @$date2;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
                    <?php //}?>
...
<div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Caisse'); ?></h3>
                                </div>
                                <div class="panel-body">
...
<?php endforeach; ?>
       <tr>
                 ...
                 <td colspan="5" >
		<center><strong> <?php  echo('Caisse arretée à la somme de :') ?></strong></center>
                 </td>
