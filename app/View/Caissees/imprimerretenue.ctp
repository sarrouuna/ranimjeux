...
<tr>
    ...
    <td  width="55%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>Suivie Retenues à la sources des clients </strong>'.$listmois.' '.$annee.'</td> 
            </tr> 
        </table>
    </td>
</tr>
...
<table cellpadding="2" cellspacing="0" >
    ...
    <tr>
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="20%"><strong>Client</strong></td>
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="20%"><strong>N° facture</strong></td>
        <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="20%"><strong>Date Retenue</strong></td>
    </tr>
    </thead>';

$long="670";
          $n=0;$total=0;
                                                foreach ($retenues as $i=>$retenue){ 
                                                            $total=$total+$retenue['montant'];
                                                            $n=$n+30;    
...
$tbl .='
     ...
     <tr> 
        <td align="center" style="border-bottom:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="20%" >&nbsp;<br>'.($i+1).'</td>
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="20%">&nbsp;<br>'.$clients[$retenue['Client']].'</td>  
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="20%">&nbsp;<br>'.$retenue['montant'].'</td>  
        <td align="right" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="20%">'
            
    ;  foreach($retenue['numfactures'] as $lignereg){  $year=explode( '-',$datefactureclients[$lignereg['factureclient_id']]);  
   $tbl .='  
          <table  cellpadding="2" cellspacing="3" border="">
            <tr>
              <td align="center" style="" >'.$factureclients[$lignereg['factureclient_id']].' / '.$year[0].'</td>
           </tr> 
           </table>
   '; } 
$tbl .=' 
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="20%">&nbsp;<br>'.date("d/m/Y",strtotime(str_replace('-','/',$retenue['date']))).'</td>  
</tr>
