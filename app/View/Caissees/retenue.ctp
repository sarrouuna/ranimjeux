		   ...
		   <?php echo $this->Form->input('moi_id',array('id'=>'moi_id','multiple'=>'multiple','empty'=>'veuillez choisir','div'=>'form-group','label'=>'Mois','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control'));?>
               ...
               <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php // if($imprimer==1){ ?>
      <a  onClick="flvFPW1(wr+'Caissees/imprimerretenue?annee=<?php echo @$annee;?>&moiid=<?php echo @$moiid;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
                    <?php //}?>
...
<div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Retenue Clients'); ?></h3>
                                </div>
                                <div class="panel-body">
	...
	<tr>
		<td ><?php echo h($i+1); ?>&nbsp;</td>
                <td >
                <?php echo $this->Html->link($clients[$retenue['Client']], array('controller' => 'clients', 'action' => 'view', $retenue['Client'])); ?>
                </td>
		...
		<td >
                 <table class="table table-bordered table-striped table-bottomless" id="addtable" style="width:100%" align="center" >
                  <?php  foreach($retenue['numfactures'] as $lignereg){ ?>
                   <tr>
                    <td >
                <?php $year=explode( '-',$datefactureclients[$lignereg['factureclient_id']]);
                 echo $this->Html->link($factureclients[$lignereg['factureclient_id']], array('controller' => 'factureclients', 'action' => 'view', $lignereg['factureclient_id'])); echo(' / '.$year[0]) ;?>
                    </td >
                   </tr>
                  <?php } ?>
                  </table>
