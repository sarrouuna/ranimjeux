...
<tr>
    ...
    <td  width="55%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>Suivie Retenues à la sources des fournisseurs </strong>'.$listmois.' '.$annee.'</td> 
            </tr> 
        </table>
    </td>
</tr>
...
<table cellpadding="2" cellspacing="0" >
    ...
    <tr>
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="20%"><strong>Fournisseur</strong></td>
...
$tbl .='
     ...
     <tr> 
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="20%">&nbsp;<br>'.$fournisseurs[$retenue['Fournisseur']].'</td>  
    ...
    ;  foreach($retenue['numfactures'] as $lignereg){  $year=explode( '-',$datefactures[$lignereg['facture_id']]);  
   $tbl .='  
          <table  cellpadding="2" cellspacing="3" border="">
            <tr>
              <td align="center" style="" >'.$factures[$lignereg['facture_id']].' / '.$year[0].'</td>
           </tr> 
           </table>
   '; } 
$tbl .=' 
