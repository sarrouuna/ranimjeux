...
$le_numero=$facture['Bonreception']['numero'];
if($facture['Bonreception']['importation_id']!=0){
    $le_numero=$facture['Bonreception']['numero'];
}
$tbl .=' 
...
<tr>
    ...
    <td  width="45%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>Bon Reception N°: '.$le_numero.'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" >
                        <strong>'.$facture['Fournisseur']['name'].'</strong>
                        <br>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        ...
                        <br>
                        '.$facture['Fournisseur']['matriculefiscale'].'
                    </td> 
        ...
        <td width="49%">
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" >
                       <br><br> 
                       <strong>Facture N° </strong>  '.$le_numero.'
                    </td> 
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Date</strong>
                        <br>
                        '.date("d/m/Y",strtotime(str_replace('-','/',($facture['Bonreception']['date'])))).'
                    </td>
...
if($facture['Bonreception']['importation_id']!=0) {
    $tbl .= '<br><br>
            <table>
                <tr>
                    <td width="20%"></td>
                    <td height="30px" width="60%" colspan="2" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                ...
                <tr>
                    <td width="20%"></td>
                    <td height="40px" width="30%" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Numero</strong>
                        <br>
                        ' . $facture['Importation']['numero'] . '
                    </td>
                    
                    <td height="40px" width="30%" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Designation</strong>
                        <br>
                        ' . $facture['Importation']['name'] . '
                    </td>
                    <td width="20%"></td>
...
<table cellpadding="2" cellspacing="0" >
    ...
    <tr>
     ...
     <tr>
        ...
        <br>   <br>
            <strong>Arretée la présente Bon Livraison à la somme de :</strong>
            <br>
            '.chifre_en_lettre($facture['Bonreception']['totalttc'],1,1).'
        </td>
