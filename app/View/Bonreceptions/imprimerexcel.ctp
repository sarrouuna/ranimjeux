...
<table align="center" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" width="100%" >
    ...
    $i=0;$total=0;$dev="";
       foreach ($bonreceptions as $br){  
        ...
        <td width="10%" nobr="nobr" align="center"  ><?php  echo date("d/m/Y",strtotime(str_replace('-','/',$br['Bonreception']['date'])));?></td>
        <td width="14%" nobr="nobr" align="center"  ><?php  echo $br['Bonreception']['numero'];?></td>
        <td width="17%" nobr="nobr" align="right"  ><?php  echo $br['Importation']['name'];?></td>
        <td width="14%" nobr="nobr" align="right"  ><?php  echo $br['Bonreception']['totalttc'];?></td>
    </tr>
