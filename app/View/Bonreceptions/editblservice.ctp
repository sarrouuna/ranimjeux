...
<div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Modification BL Service'); ?></h3>
                                </div>
        ...
        <?php echo $this->Form->create('Bonreception',array('autocomplete' => 'off','class'=>'form-horizontal ls_form','id'=>'defaultForm','data-bv-message'=>'This value is not valid','data-bv-feedbackicons-valid'=>'fa fa-check','data-bv-feedbackicons-invalid'=>'fa fa-bug','data-bv-feedbackicons-validating'=>'fa fa-refresh')); ?>
            ...
            <div class="col-md-6">                  
              	<?php
                echo $this->Form->input('id',array('div'=>'form-group','type'=>'hidden','between'=>'<div class="col-sm-10">','after'=>'</div>','id'=>'','class'=>'form-control','empty'=>'Veuillez Choisir !!') );
                ...
                <div class="fournisseurexterne" >
                    <div class='form-group' >
                        ...
                        <div class='col-sm-10' champ="divimpor" id="divimpor" >
                            <select name="data[Facture][importation_id]"   table="Facture" champ="importation_id" class="select  " >

                                <option value="0">--Veuillez choisir--</option>
                                <?php  foreach($importations as $m => $importation){  ?>
                                    <option value="<?php echo $m;?>"

                                        <?php
                                        if($m==$this->request->data['Bonreception']['importation_id']){
                                            echo 'selected';
                                        }
                                        ?>
                                    >
                                        <?php echo $importation; ?></option>
                                <?php }?>
                            </select>
                ...
                <?php $ddf=date("d/m/Y",strtotime(str_replace('-','/',$this->request->data['Bonreception']['date'])));
		        echo $this->Form->input('date',array('div'=>'form-group','value'=>$ddf,'type'=>'text','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly') );
