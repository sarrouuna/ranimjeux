...
$pontdevente = $ModelSociete->find('first',array('conditions'=>array('Pointdevente.id'=>$factureclient['Bonreception']['pointdevente_id'])));
                ...
                <tr>
                    <td width="45%">
                        <table cellpadding="2" cellspacing="0" border="1">
                            <tr>
                                <td align="center" width="100%" colspan="3" style="background-color:#b8b8b8"  ><strong> BON RECEPTION </strong></td>
                            </tr>
							...
							<tr>
                             ...
                             <tr>
                                <td height="20px" align="center" width="34%"  >' . $factureclient['Bonreception']['numero'] . '</td>
								<td height="20px" align="center" width="33%"  >' . $factureclient['Bonreception']['numerofrs'] . '</td>
                                <td align="center" width="33%"  > ' . date("d/m/Y", strtotime(str_replace('-', '/', $factureclient['Bonreception']['date']))) . '  </td>
                            </tr>
                        </table>
                    </td>
...
<table cellpadding="2" cellspacing="0"  >
    ...
    <tr>       
        ...
        <td align="center" '.$styl_cadr_ent.' '.$lgcode.'><strong>Article</strong></td>
  ...
  $tbl .='      <td align="center" '.$styl_cadr_ent.'  '.$lgqte.'><strong>Qte</strong></td>
        ...
        $n=0;  $kk=0;
            foreach ($lignefactureclients as $i=>$lr){
                 if($lr['Lignereception']['remise'] !=0){
                    $remise=sprintf('%.0f',$lr['Lignereception']['remise']);
                }else{
                   $remise="" ;
                }
                
                  if($lr['Lignereception']['fodec'] !=0){
                    $fodec=sprintf('%.0f',$lr['Lignereception']['fodec']);
                }else{
                   $fodec="" ;
                }
         ...
         $n=$n+30;   
         $decimal=$lr['Lignereception']['tva'] - floor($lr['Lignereception']['tva']);
if ($decimal==0){
    $tvaa=floor($lr['Lignereception']['tva']);
}else{
    $tvaa=$lr['Lignereception']['tva'];
}
       
$tbl .='
    
    <tr> 
        <td  align="left" '.$styl_cadr.' '.$lgcode.' >&nbsp;'.$lr['Article']['code'].'</td>
        <td  align="left" '.$styl_cadr.' '.$lgarticle.' >&nbsp;'. $lr['Article']['name'].'</td>
        <td align="center" '.$styl_cadr.' '.$lgremise.'>&nbsp;'.$remise.'</td> ';
 if($factureclient['Fournisseur']['devise_id']==1){
      $tbl .='  <td height="20px" '.$styl_cadr.' align="center"  '.$lgfodec.'>&nbsp;'.$fodec.'</td> ';
 }
      $tbl .='  <td align="right" '.$styl_cadr.' '.$lgqte.'>&nbsp;'.$lr['Lignereception']['quantite'].'</td>  
        <td align="right" '.$styl_cadr.' '.$lgprixht.'>&nbsp;'.number_format($lr['Lignereception']['totalht']/$lr['Lignereception']['quantite'],3, '.', ' ').'</td>  
        <td align="right" '.$styl_cadr.' '.$lgtotht.'>&nbsp;'.number_format($lr['Lignereception']['totalht'],3, '.', ' ').'</td> 
                ...
                <table border="1">
                    ...
                    $tva=0;
                     foreach ($lignefactureclientstva as $i=>$lr){
                         ...
                         $mnt=0;$mnt_ttc=0;
                         $mnt=($lr['Lignereception']['totalht']*$lr['Lignereception']['tva'])/100;
                         $mnt_ttc=$lr['Lignereception']['totalht']+$mnt;
                         
                         $tbl .='
                             <tr>
                                <td align="center" >&nbsp;'.number_format($this->requestAction('App/arrd/'.$lr[0]['totalht'].'/3'), 3, '.', ' ').' </td>
                                <td align="center" >&nbsp;'.sprintf('%.0f',$lr[0]['tva']).' %</td>
                                <td align="center" >&nbsp;'.number_format($this->requestAction('App/arrd/'.$lr[0]['mtva'].'/3'), 3, '.', ' ').'</td>
                             </tr>';
                     }
            ...
            <td width="36%">
                <table border="1">
                    <tr>
                        ...
                        <td align="right"  width="50%">' . number_format($factureclient['Bonreception']['totalht'] + $factureclient['Bonreception']['remise'], 3, '.', ' ') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                    </tr>
                    <tr>
                        <td align="left" style="background-color:#b8b8b8;" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total remise  </strong></td>  
                        <td align="right"  width="50%">'.number_format($factureclient['Bonreception']['remise'],3, '.', ' ').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" style="background-color:#b8b8b8;" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total NET HT  </strong></td>  
                        <td align="right"  width="50%">'.number_format($factureclient['Bonreception']['totalht'],3, '.', ' ').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                    </tr>
                    <tr>
                        <td align="left" style="background-color:#b8b8b8;" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total fodec  </strong></td>  
                        <td align="right"  width="50%">'.number_format($factureclient['Bonreception']['fodec'],3, '.', ' ').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" style="background-color:#b8b8b8;" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total TVA  </strong></td>  
                        <td align="right"  width="50%">'.number_format($factureclient['Bonreception']['tva'],3, '.', ' ').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>  
                     </tr> 
                   <tr>
                    ...
                    <tr>
                        ...
                        <td align="right"  width="50%">'.number_format($factureclient['Bonreception']['totalttc'],3, '.', ' ').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>  
                    </tr>   
...
<table cellpadding="2" cellspacing="0" border="1">
    <tr>
        ...
        <br>   <br>
            <strong>Arreter la présente Bonreception à la somme de :</strong>
            <br>
            '.chifre_en_lettre($factureclient['Bonreception']['totalttc'],1,1).'
        </td>
