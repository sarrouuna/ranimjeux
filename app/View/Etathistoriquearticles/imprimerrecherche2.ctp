...
<br><br><br>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr bgcolor="#FFFFFF" align="center">
                        ...
                        <th width="37%" align="center" $zz ><strong>Nom / Raison social</strong></th>
                        ...
                        <th width="10%" align="center" $zz ><strong>Tot_TTC</strong></th>
   </tr>';
        $i=0;$style=""; 
        $qte_ent=0;
        $qte_sor=0;
...
<br><br>
    ...
    $qtesortie= $historiquearticle['Historiquearticle']['qte'];
        ...
        $tbl .= 
    '<tr  align="center">    
        <td width="8%" nobr="nobr" align="center" height="30px" $zz><strong>'.$date.'</strong></td>
        ...
        <td width="37%" nobr="nobr" align="'.$style.'"  $zz>'.$cfu.'</td>';
        if($historiquearticle['Historiquearticle']['indice']==10){ 
        ...
        <td width="10%" nobr="nobr" align="right"  $zz>'.$historiquearticle['Historiquearticle']['ptot'].'</td>    
            ...
            $tbl .='<tr>
                        <td align="center"   width="70%"><strong>TOTAL Qte</strong></td>  
