...
<tr class='gradeX'>                                    <th style="display:none">id</th>
	...
	<td class="actions" align="center">
            ...
            <?php if($journee['Journee']['etat']==0) {?>	
                <?php echo $this->Html->link($this->Html->image('modification.png'), array('action' => 'edit', $journee['Journee']['id']),array('escape' => false)); ?>
            <?php }?>
 ...
 <td>
 	<?php if(CakeSession::read('users')==16){?> <a onClick="flvFPW1('<?php echo $this->webroot;?>journees/imprimerart/<?php echo $journee['Journee']['id']; ?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><?php echo  $this->Html->image('imprimer.png')?></a><?php }?>
 </td>
	</tr>
<?php endforeach; ?>
 </tbody>        <tfoot>
