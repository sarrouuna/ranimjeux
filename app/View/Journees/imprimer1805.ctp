...
/*  $tbl .='   <tr>
 ...
 <td align="right">'.sprintf('%.3f',$esp).'</td>
  </tr>
	 <tr>
 ...
 <td align="right"><font  color="#FF0000">'.sprintf('%.3f',$esp+$ch+$cart+$tickres).'</font></td>
  </tr> 
         </table> <br><br>
			';
	 $espt+= $esp;
 ...
 if($this->params['pass'][1]=='')
  ...
  $tbl .='
	 ...
	 <tr>
 <td align="left" >Total Espéce </td>
 <td align="right">'.sprintf('%.3f',$espt).'</td>
  </tr>
	 <tr>
 <td align="left" >Total Chéque </td>
 ...
 <td align="right">'.sprintf('%.3f',$tickrest).'</td>
    ...
    <tr>
 <td align="left">Total   </td>
 <td align="right"><font  color="#FF0000">'.sprintf('%.3f',$espt+$cht+$cartt+$tickrest).'</font></td>
  </tr>  
  
   <tr>
 <td align="left">Reste   </td>
 <td align="right"><font  color="#FF0000">'.sprintf('%.3f',$Rest).'</font></td>
  </tr> 
  <tr>
