...
<table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" nobr="true">       
    <tr align="center">
        <td bgcolor="#CCCCCC" width="<?php echo $w; ?>%" align="center"  ><strong>Num IMP</strong></td> 
        ...
        <td bgcolor="#CCCCCC" width="<?php echo $w; ?>%" align="center"  ><strong>MONT.IMPAY</strong></td>
...
header("Content-Disposition: attachment; filename=Listeimpayesansdetails.xls");
?>