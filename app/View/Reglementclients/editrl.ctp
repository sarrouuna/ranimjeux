...
<div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Modification Reglement  libre'); ?></h3>
                                </div>
		...
		echo $this->Form->input('Date',array('value'=>$date,'div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly','type'=>'text','required data-bv-notempty-message'=>'Champ Obligatoire') );
	?></div><div class="col-md-6"><?php
		...
		echo $this->Form->input('Montant',array('id'=>'Montant','readonly'=>'readonly','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','type'=>'text','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );
	?>
  </div>    
...
<!--                                            <tr >
                                            ...
                                            <tr>
                                                <td >Montant</td>  
                                                <td  ><?php
                                                    echo $this->Form->input('sup',array('div'=>'form-group','type'=>'hidden','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'','index'=>'','champ'=>'sup','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][sup]') );
...
<!--                                            <tr <?php  if($piece['Piecereglementclient']['paiement_id']!=5){?>   style="display:none" <?php }?> id="trmontantbrut<?php echo $i  ?>"   >
                                          ...
                                          <tr>
                                                    <td>Montant</td>  
                                                    <td  ><?php
                                                        echo $this->Form->input('sup',array('div'=>'form-group','type'=>'hidden','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'','index'=>$i,'champ'=>'sup','id'=>'sup'.$i,'table'=>'pieceregelemnt','name'=>'data[pieceregelemnt]['.$i.'][sup]') );
...
<!--                                            <tr  <?php  if($piece['Piecereglementclient']['paiement_id']!=5){?>   style="display:none" <?php }?> id="trmontantnet<?php echo $i  ?>" >
                                            ...
                                            <tr  <?php  if(($piece['Piecereglementclient']['paiement_id']==1)||($piece['Piecereglementclient']['paiement_id']==5)||($piece['Piecereglementclient']['paiement_id']==6)){?>   style="display:none" <?php }?> id="trechance<?php echo $i  ?>" >
                                                    ...
                                                    <td name="data[piece][<?php echo $i?>][trechance]" id="trechanceb[<?php echo $i?>" index="[<?php echo $i?>"  champ="trechanceb" table="piece"  class="modecheque"><?php 
                                                     echo $this->Form->input('echance',array('value'=>date("d/m/Y",strtotime(str_replace('-','/',$piece['Piecereglementclient']['echance']))),'div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly','label'=>'','type'=>'text','index'=>$i,'champ'=>'echance','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt]['.$i.'][echance]') );   
                                                   ?> </td>  
                                              </tr>
