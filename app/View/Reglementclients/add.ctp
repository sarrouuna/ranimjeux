...
<!--                                                 <td><input type="text" name="data[Lignereglement][<?php echo $i; ?>][remise]" id="remise<?php echo $i;?>" class="form-control remisel " index="<?php echo $i; ?>" value="0.000">
					  ...
					  <tr>
						  <td align="center" colspan="6" bgcolor="#F2D7D5"><strong>Facture Avoir</strong></td>
					  </tr>
					  <tr>
						  <td>Numéro</td>
						  <td>Date</td>
					  ...
					  <?php
					  //debug($bonliv);die();
					  foreach($factureavoir as $j=>$fac){//debug($b);die;?>
						  <tr>
							  <td style="width:10%;"><?php echo $fac['Factureavoir']['numero']; ?></td>
							  <td style="width:10%;"><?php echo $fac['Factureavoir']['date']; ?></td>
							  <td><?php echo number_format($fac['Factureavoir']['totalttc'],3, '.', ' '); ?></td>
							  <td><?php echo number_format($fac['Factureavoir']['Montant_Regler'],3, '.', ' '); ?></td>
							  <td style="width:10%;"><?php echo number_format($fac['Factureavoir']['totalttc']-$fac['Factureavoir']['Montant_Regler'],3, '.', ' '); ?></td>
							  <!--                                                 <td><input type="text" name="data[Lignereglement][<?php echo $j; ?>][remise]" id="remise<?php echo $j;?>" class="form-control remisel " index="<?php echo $j; ?>" value="0.000">
                                                            -->
							  <td style="width:15%;">
								  <table>
									  <tr>
										  <td style="width:1%;">
											  <input type="checkbox" champ="facture" name="data[LignereglementFactureavoir][<?php echo $j; ?>][factureclient_id]" id="bonliv_id<?php echo $j; ?>" index="<?php echo $j; ?>" class="calculereglementclient afficheinputmontantreglementclientbonliv" value="<?php echo $fac['Factureavoir']['id'] ?>" mnt="<?php echo sprintf("%.3f",$fac['Factureavoir']['totalttc']-$fac['Factureavoir']['Montant_Regler']);?>" >
										  </td>
										  <td style="width:99%;" align="left">
											  <?php
											  echo $this->Form->input('Montanttt',array('style'=>'display:none','index'=>$j,'name'=>'data[LignereglementFactureavoir]['.$j.'][Montant]','id'=>'Montantreglerbonliv'.$j,'label'=>'','div'=>'','between'=>'<div class="col-sm-12">','after'=>'','type'=>'text','class'=>'form-control testmontantreglementclientbonliv calculemontanttotal') );
											  ?>
										  </td>
									  </tr>
								  </table>
					  ...
					  <?php }?>
					  <input type="hidden" name="max" value="<?php echo @$j;?>" id="maxfactureavoir">

					  <tr>
						  <td align="center" colspan="6" bgcolor="#F2D7D5"><strong>Facture Avoir Financier</strong></td>
					  </tr>
					  <tr>
						  <td>Numéro</td>
						  <td>Date</td>
					  ...
					  <?php }?>
					  <input type="hidden" name="max" value="<?php echo @$j;?>" id="maxfactureavoirfinancier">
					  <!--
					  <input type="hidden" name="max" value="<?php /*echo @$i; */?>" id="max">
...
/*											  echo $this->Form->input('Montanttt',array('style'=>'display:none','index'=>$im,'name'=>'data[Lignereglementimpaye]['.$im.'][Montant]','id'=>'Montantreglerimpaye'.$im,'label'=>'','div'=>'','between'=>'<div class="col-sm-12">','after'=>'','type'=>'text','class'=>'form-control testmontantreglementclientimpaye') );
					  ...
					  <tr>
						  <td colspan="4"> Total factures</td>
						  <td colspan="2">
							  <input type="text" name="data[Reglementclient][ttpayer]" id="ttpayer" class="form-control"  value="<?php echo $ttselect;?>" readonly>
						  </td>
					  </tr>
					  <tr>
						  <td colspan="4">Montant à payer</td>
                                        ...
                                        <table>
											...
											<tr >
                                                ...
                                                <td name="data[piece][0][trmontantbrut]" id="trmontantbrutb0" index="0"  champ="trmontantbrutb" table="piece"  style="display:none" class="modecheque"><?php
                                                 echo $this->Form->input('montant_brut',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control montantbrut1','label'=>'','type'=>'text','index'=>0,'champ'=>'montantbrut','id'=>'montantbrut0','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][montant_brut]') );
                                               ?> </td>
                                            </tr>
                                            <tr>
											...
											<!-- <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    // echo $this->Form->input('montant_brut',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt montantbrut1','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'','index'=>0,'champ'=>'montantbrut','id'=>'montantbrut0','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][montantbrut]') );
											...
											<!-- <tr>
                                                ...
                                                <td><?php
                                                //  	echo $this->Form->input('sup',array('div'=>'form-group','type'=>'hidden','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'','index'=>0,'champ'=>'sup','id'=>'sup0','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][sup]') );
                                                //     echo $this->Form->input('montant_net',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'','index'=>0,'champ'=>'montantnet','id'=>'montant0','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][montantnet]') );
                                                //     echo $this->Form->input('favid',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt','required data-bv-notempty-message'=>'Champ Obligatoire','type'=>'hidden','index'=>0,'champ'=>'favid','id'=>'favid0','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][favid]') );
                                                //  ?> </td>
                                            </tr> -->
											<tr >
							  ...
							  <table>
								  ...
								  ?> </td>
									  ...
									  <td  ><?php
										  ...
										  echo $this->Form->input('montant_brut',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt montantbrut1','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'','index'=>'','id'=>'','champ'=>'montantbrut','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][montantbrut]') );
								  ...
								  <tr>
									  ...
									  <td  ><?php
										  echo $this->Form->input('sup',array('div'=>'form-group','type'=>'hidden','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'','index'=>'','id'=>'','champ'=>'sup','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][sup]') );
										  echo $this->Form->input('montant_net',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'','index'=>'','id'=>'','champ'=>'montantnet','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][montantnet]') );
										  echo $this->Form->input('favid',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control mnt','required data-bv-notempty-message'=>'Champ Obligatoire','type'=>'hidden','index'=>'','champ'=>'favid','id'=>'','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt][0][favid]') );
										  ?>
									  </td>
								  </tr>
