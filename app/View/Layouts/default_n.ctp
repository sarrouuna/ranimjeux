...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $this->webroot;?>assets/css/plugins/icheck/skins/all.css">
...
<script type="text/javascript" src="<?php echo $this->webroot;?>assets/js/color.js"></script>
    ...
    <script src="<?php echo $this->webroot;?>assets/js/pages/buttonSwitch.js"></script>
    ...
    <script src="<?php echo $this->webroot;?>assets/js/icheck.min.js"></script>
    <script src="<?php echo $this->webroot;?>assets/js/pages/checkboxRadio.js"></script>
...
<style>
   ...
   width: 42px;
   height: 42px;
   background: url(<?php echo $this->webroot;?>img/top.png) 0 bottom no-repeat;
   display: none;
   transition: none;
   z-index: 9999;
}
