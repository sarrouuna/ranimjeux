...
<html lang="en" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <title><?php echo CakeSession::read('nomste'); ?></title>
...
//                }
        ...
        <script src="<?php echo $this->webroot; ?>assets/js/hafedh.js"></script>
		<script src="<?php echo $this->webroot; ?>assets/js/ansar.js"></script>
        <script src="<?php echo $this->webroot; ?>assets/js/haitham.js"></script>
         <script src="<?php echo $this->webroot; ?>assets/js/zeinab.js"></script>
