...
<!--Left navigation section start-->
  <?php if (in_array(strtolower($this->params['controller']), array('stocks','articles','inventaires','ligneproductions','tailles', 'familles','modeles','couleurs','references','types','depots','stockdepots','mouvementstocks'))): ?>
                    <?php echo $this->element('Stock'); ?> 
                <?php endif; ?>
 <?php if (in_array(strtolower($this->params['controller']), array('releves','ventes','banques','piecereglements','pieces','clients', 'boncommandes', 'bonlivraisons','devis','factures','reglements','collections', 'entreecaisses', 'sortiecaisses', 'especes'))): ?>
                    <?php echo $this->element('Vente'); ?> 
                <?php endif; ?>
<?php if (in_array(strtolower($this->params['controller']), array('prods','productions'))): ?>
                    <?php echo $this->element('production'); ?> 
                <?php endif; ?>
<?php if (in_array(strtolower($this->params['controller']), array('achats','matierepremieres','unites','fournisseurs','mpfournisseurs','deposits','inventories','lineinventories','stockmatierepremieres', 'emplacements', 'colors', 'families', 'machines', 'typestocks', 'types', 'colors',
