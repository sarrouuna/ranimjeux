...
<tr>
    ...
    <td  width="55%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>liste des Transfert  '.$m.'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
...
<br><br><br>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr bgcolor="#FFFFFF" align="center">
        <th width="40%" align="center" $zz height="30px" ><strong>Depot</strong></th>
       ...
       foreach ($transferts as $c){
        ...
        $tbl .= 
    '<tr bgcolor="#FFFFFF" align="center">    
        <td width="40%" nobr="nobr" align="left" height="30px" $zz>'.$depots[$c['Transfert']['depotarrive']].'</td>
        <td width="30%" nobr="nobr" align="center"  $zz>'.date("d/m/Y",strtotime(str_replace('-','/',$c['Transfert']['date']))).'</td>
        <td width="30%" nobr="nobr" align="center"  $zz>'.$c['Transfert']['numero'].'</td>
    </tr>' ;     
}
