...
<tr>
    ...
    <td  width="55%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>Bon Transfert N° : '.$transfers['Transfert']['numero'].'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" >
                        <strong>Depot Arrivé</strong>
                        <br>
                        '.$depotdeparts[$transfers['Transfert']['depotarrive']].'
                        <br>    
                        <strong>Date</strong>    
                        <br>
                        '.date("d/m/Y",strtotime(str_replace('-','/',($transfers['Transfert']['date'])))).'
                    </td> 
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        ...
                        <br>
                        '.$transfers['Transfert']['chauffeur'].'
                        <br>    
                        <strong>Véhicule</strong>    
                        <br>
                        '.$transfers['Transfert']['vehicule'].'    
                    </td>
...
$tbl .='
     ...
     <tr> 
        <td align="center" style="border-bottom:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="20%" >&nbsp;'.$lr['Depot']['code']." ".$lr['Depot']['designation'].'</td>
        <td align="center" style="border-bottom:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="60%" >&nbsp;'. $lr['Article']['code']." ".$lr['Article']['name'].'</td>
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="20%">&nbsp;'.$lr['Lignetransfert']['quantite'].'</td>  
