...
<!--                                            <tr>
                     ...
                     <!-- //***************************************************--->
                       ...
                       <!-- //***************************************************--->
                                ...
                                <?php  //debug($piecesreg);die;
                                foreach ($piecesreg as $i=>$piece){ ?> 
                                      
                                            
                                <?php if($piece['Piecereglement']['paiement_id']==1){ ?>        
                                                <tr>
                                                    <td colspan="5">
                                            <table>
                                                <tr>
                                ...
                                <?php } else  if($piece['Piecereglement']['paiement_id']==2){ ?>    
                 ...
                 <!-- //***************************************************--->
                                                <tr><td name="data[piece][<?php echo $i?>][trcarnetnum]" id="trcarnetnuma<?php echo $i?>" index="<?php echo $i?>"  champ="trcarnetnuma" table="piece"   class="modecheque" >Numéro de carnet</td>  
                 ...
                 <!-- //***************************************************--->
                                    ...
                                    <?php  }  else if($piece['Piecereglement']['paiement_id']==5){ ?>    
                                                <tr>
                                            <td colspan="5">
                                            <table>
                                                <tr>
                                    ...
                                    <?php  } else { ?>    
                                            ...
                                            <table>
                                                ...
                                                <tr >
                                                    <td name="data[piece][<?php echo $i  ?>][trechance]" id="trechancea<?php echo $i  ?>" index="<?php echo $i  ?>"  champ="trechancea" table="piece"  style="display:none" class="modecheque">Echéance</td>  
                                                    <td name="data[piece][<?php echo $i  ?>][trechance]" id="trechanceb<?php echo $i  ?>" index="<?php echo $i  ?>"  champ="trechanceb" table="piece"  style="display:none" class="modecheque"><?php 
                                                     echo $this->Form->input('echance',array('value'=>date("d/m/Y",strtotime(str_replace('-','/',$piece['Piecereglement']['echance']))),'div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly','label'=>'','type'=>'text','index'=>$i,'champ'=>'echance','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt]['.$i.'][echance]') );   
                                                   ?> </td>  
                                                </tr>
             
                                                 <tr >
                                                    <td name="data[piece][<?php echo $i  ?>][trnum]" id="trnuma<?php echo $i  ?>" index="<?php echo $i  ?>"  champ="trnuma" table="piece"  style="display:none" class="modecheque" >Numéro pièce</td>  
                                                    <td  name="data[piece][<?php echo $i  ?>][trnum]" id="trnumb<?php echo $i  ?>" index="<?php echo $i  ?>"  champ="trnumb" table="piece"  style="display:none" class="modecheque"><?php 
                                                 echo $this->Form->input('num_piece',array('value'=>$piece['Piecereglement']['num_piece'],'div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control ','label'=>'','type'=>'text','index'=>$i,'champ'=>'num_piece','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt]['.$i.'][num_piece]') );   
                                                ?></td>   
                                                </tr>
                                                 <tr>
                                                    <td name="data[piece][<?php echo $i  ?>][banque]" id="trbanquea<?php echo $i  ?>" index="<?php echo $i  ?>"  champ="banquea" table="piece"  style="display:none" class="modecheque" >Banque</td>  
                                                    <td  name="data[piece][<?php echo $i  ?>][banque]" id="trbanqueb<?php echo $i  ?>" index="<?php echo $i  ?>"  champ="banqueb" table="piece"  style="display:none" class="modecheque"><?php 
                                                     echo $this->Form->input('banque',array('value'=>$piece['Piecereglement']['num_piece'],'div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control ','label'=>'','type'=>'text','index'=>$i,'champ'=>'banque','table'=>'pieceregelemnt','name'=>'data[pieceregelemnt]['.$i.'][banque]') );   
                                                   ?> </td>  
                                                </tr>
                                                </table>
                                                        </td>
