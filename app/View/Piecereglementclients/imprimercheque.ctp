...
<tr>
    ...
    <td  width="55%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>liste des chèques clients'.$m.'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
...
$tbl .= '
 ...
 <tr><td align="center" '.$ff.'><strong>'.$az.'</strong></td></tr>     
     <tr bgcolor="#FFFFFF" align="center">
        <th width="18%" align="center" $zz height="30px" ><strong>Client</strong></th>
...
$bn=0;$compt=0;
        ...
        $tbl .= 
    '<tr bgcolor="#FFFFFF" align="center">    
        <td width="18%" nobr="nobr" align="center" height="30px" $zz>'.$piece['Reglementclient']['Client']['name'].'</td>
...
$bn=0;$compt=0;
    ...
    '<tr bgcolor="#FFFFFF" align="center">    
        <td width="18%" nobr="nobr" align="center" height="30px" $zz>'.$piece['Reglementclient']['Client']['name'].'</td>
        <td width="16%" nobr="nobr" align="center"  $zz>'.$piece['Compte']['num'].' </td>
        <td width="16%" nobr="nobr" align="center"  $zz> '.$piece['Compte']['Compte']['banque'].'</td>
        <td width="18%" nobr="nobr" align="center"  $zz>'.date("d/m/Y",strtotime(str_replace('-','/',($piece['Reglementclient']['Date'])))).'</td>
        <td width="16%" nobr="nobr" align="center"  $zz>'.date("d/m/Y",strtotime(str_replace('-','/',($piece['Piecereglementclient']['echance'])))).'</td>
        <td width="16%" nobr="nobr" align="center"  $zz>'.$piece['Piecereglementclient']['montant'].'</td>
...
$bn=0;$compt=0;
            $bn= $piece['Compte']['banque'];
            $compt= $piece['Compte']['rib'];
            $tot_pre=$tot_pre+$piece['Piecereglementclient']['montant'];
