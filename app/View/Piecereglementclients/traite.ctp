                            ...
                            <label>Situation</label>
                               <div class="col-sm-10">
                                <select class="form-control select selectized" placeholder="Veuillez choisir" name="data[Piecereglementclient][situation]" id="stut" >
                                    ...
                                    <option value="On caissé"       >Payé</option>
                ...
                <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                <button type="submit" class="btn btn-primary">Afficher</button> 
                                                 <a href="<?php echo $this->webroot;?>Piecereglementclients/traite" class="btn btn-primary">Afficher Tout</a>
                                                 <?php  if($imprimer==1){ ?>
         <a onClick="flvFPW1(wr+'Piecereglementclients/imprimertraite?Date_debut=<?php echo @$Date_debut;?>&Date_deb=<?php echo @$Date_deb;?>&situation=<?php echo @$situation;?>&Date_fin=<?php echo @$Date_fin;?>&Date_fn=<?php echo @$Date_fn;?>&client_id=<?php echo @$client_id;?>&compte_id=<?php echo @$ciete_id;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
                                                 <?php  } ?>
