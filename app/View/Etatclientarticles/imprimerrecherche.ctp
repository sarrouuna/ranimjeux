...
<br><br><br>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr bgcolor="#FFFFFF" align="center">
                       ...
                       <th width="10%" align="center" $zz ><strong>CA HT</strong></th>
                       <th width="10%" align="center" $zz ><strong>CA TTC</strong></th> 
        ...
        $totcl=0;        
               ...
               $totalecat=$totalecat+$action[0]['totalttc']; 
               $hh=1;$st=0;     
...
if($hh==8888){
$tbl .='<tr><td colspan="2" align="right"><strong>Total</strong></td><td align="right"><strong>'.$totqte.'</strong></td><td align="right"><strong>'.sprintf("%01.3f",$totcl).'</strong></td><td align="right"><strong>'.sprintf("%01.3f",$totclt).'</strong></td></tr>';
$totcl=0;
$totqte=0;
$totqte=$totqte+$action[0]['qte'];
$totcl=$totcl+$action[0]['tot'];
...
$i++;
    ...
    '<tr bgcolor="#FFFFFF" align="center">    
        ...
        <td width="10%" nobr="nobr" align="right"  $zz>'.sprintf("%01.3f",$action[0]['tot']).'</td>
        <td width="10%" nobr="nobr" align="right"  $zz>'.sprintf("%01.3f",$action[0]['totalttc']).'</td>
    </tr>' ;     
}
$tbl .='<tr><td colspan="2" align="right"><strong>Total</strong></td><td align="right"><strong>'.$totqte.'</strong></td><td align="right"><strong>'.sprintf("%01.3f",$totcl).'</strong></td><td align="right"><strong>'.sprintf("%01.3f",$totclt).'</strong></td></tr>';
$tbl .= '
   <tr bgcolor="#FFFFFF" align="center">    
        ...
        <td width="10%" nobr="nobr" align="right"  $zz>'.sprintf("%01.3f",$totaleca).'</td>
         <td width="10%" nobr="nobr" align="right"  $zz>'.sprintf("%01.3f",$totalecat).'</td>
