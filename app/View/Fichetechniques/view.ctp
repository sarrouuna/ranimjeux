...
<div class="row" >
		...
		echo $this->Form->input('nvarticle',array('disabled'=>'disabled','label'=>'Article Crée','empty'=>'choix','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control select') );
	        ?></div><div class="col-md-6"><?php
	        echo $this->Form->input('date',array('readonly'=>'readonly','value'=>date("d/m/Y",strtotime(str_replace('/','-',$this->request->data['Fichetechnique']['date']))),'div'=>'form-group','type'=>'text','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control ') );		
	?>
  </div>
                            ...
                            <div class="panel panel-default" >
                                ...
                                <tr class="cc" >
                                    <td style="width:49%">
                                        ...
                                        <?php    echo $this->Form->input('article_id',array('disabled'=>'disabled','value'=>$l['Lignefichetechnique']['article_id'],'name'=>'data[Ligneworkflow]['.$i.'][article_id]','index'=>$i,'id'=>'article_id'.$i,'label'=>'','div'=>'form-group','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select ','empty'=>'Veuillez Choisir !!') );?>
                                    </td>
                                    <td style="width:49%" >
                                        <?php echo $this->Form->input('qte',array('readonly'=>'readonly','value'=>$l['Lignefichetechnique']['qte'],'name'=>'data[Ligneworkflow]['.$i.'][qte]','div'=>'form-group','label'=>'','table'=>'Ligneworkflow','index'=>$i,'id'=>'qte'.$i,'champ'=>'qte','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control') );?>
                                    </td>
