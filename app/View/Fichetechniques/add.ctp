...
<div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Ajout Fiche technique'); ?></h3>
                                </div>
        ...
        <?php echo $this->Form->create('Fichetechnique',array('autocomplete' => 'off','class'=>'form-horizontal ls_form','id'=>'defaultForm','data-bv-message'=>'This value is not valid','data-bv-feedbackicons-valid'=>'fa fa-check','data-bv-feedbackicons-invalid'=>'fa fa-bug','data-bv-feedbackicons-validating'=>'fa fa-refresh')); ?>
            ...
            <div class="col-md-6">                  
              	<?php
	        echo $this->Form->input('numero',array('value'=>@$mm,'div'=>'form-group','readonly'=>'readonly','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
                            ...
                            <div class="panel panel-default" >
                                ...
                                <tr class="cc" >
                                    <td style="width:49%">
                                        ...
                                        <?php    echo $this->Form->input('article_id',array('name'=>'data[Ligneworkflow][0][article_id]','index'=>'0','id'=>'article_id0','label'=>'','div'=>'form-group','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select ','empty'=>'Veuillez Choisir !!') );?>
                                    </td>
                                    <td style="width:49%" >
                                        <?php echo $this->Form->input('qte',array('name'=>'data[Ligneworkflow][0][qte]','div'=>'form-group','label'=>'','table'=>'Ligneworkflow','index'=>'0','id'=>'qte0','champ'=>'qte','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control') );?>
                                    </td>
