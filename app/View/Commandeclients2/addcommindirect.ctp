...
<!--                                 <tr class="tr" style="display:none;" >
                                ...
                                <tr class="cc testclientvide" >
                                    ...
                                    <td>
                                    	 <?php	echo $this->Form->input('depot_id',array('value'=>$l[0]['depot_id'],'label'=>'','div'=>'form-group', 'name' => 'data[Lignecommandeclient]['.$i.'][depot_id]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'depot_id'.$i,'champ'=>'depot_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select depot_qte_s','empty'=>'Veuillez Choisir !!') );?>
                                    </td> 
                                    <td>
                                     ...
                                     <td >
                                        ...
                                        <?php echo $this->Form->input('quantitestock',array('readonly'=>'readonly','value'=>@$tabqtestock[$l[0]['depot_id']][$l['Lignedevi']['article_iddd']]['qtestock'],'label'=>'','div'=>'form-group', 'name' => 'data[Lignecommandeclient]['.$i.'][quantitestock]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'quantitestock'.$i,'champ'=>'quantitestock','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control') );?>
                                     </td>
                                     <td >
                                        <?php echo $this->Form->input('quantite',array('value'=>$l[0]['quantite'],'label'=>'','div'=>'form-group', 'name' => 'data[Lignecommandeclient]['.$i.'][quantite]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'quantite'.$i,'champ'=>'quantite','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control   calculefacture') );?>
                                    </td>
                                    <td >
                                     ...
                                     <?php echo $this->Form->input('prix',array('value'=>$l[0]['prix']/$l[0]['quantite'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][prixhtva]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'prixhtva'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeinverseputtc') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('remise',array('value'=>$l[0]['remise']/$l[0]['quantite'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][remise]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'remise'.$i,'champ'=>'remise','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeprix_net_ttc calculefacture') );
                                    ...
                                    <td >
                                     <?php echo $this->Form->input('prixnet',array('value'=>$l[0]['prixnet']/$l[0]['quantite'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommande]['.$i.'][prixnet]','table'=>'Lignecommande','index'=>$i,'id'=>'prixnet'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  calculeremisenet') );?>
                                    </td>
                                    <td>
                                     <?php
                                     echo $this->Form->input('puttc',array('value'=>$l[0]['puttc']/$l[0]['quantite'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommande]['.$i.'][puttc]','table'=>'Lignecommande','index'=>$i,'id'=>'puttc'.$i,'champ'=>'puttc','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  calculeprixvente') );
                                     echo $this->Form->input('totalhtans',array('value'=>$l[0]['prix']/$l[0]['quantite'],'type'=>'hidden','div'=>'form-group','label'=>'', 'name' => 'data[Lignecommande]['.$i.'][totalhtans]','table'=>'Lignecommande','index'=>$i,'id'=>'totalhtans'.$i,'champ'=>'totalhtans','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('totalht',array('value'=>$l[0]['totalht'],'div'=>'form-group','label'=>'','readonly'=>'readonly', 'name' => 'data[Lignecommandeclient]['.$i.'][totalht]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'totalht'.$i,'champ'=>'totalht','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php echo $this->Form->input('tva',array('value'=>$l[0]['tva'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][tva]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'tva'.$i,'champ'=>'tva','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculefacture') );?>
                                    </td>
                                    <td >
