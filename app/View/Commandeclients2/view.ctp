    ...
    <div class="row">
                            ...
                            <div class="panel panel-default" >
                               ...
                               <tr class="cc" >
                                    ...
                                    <td style="width:52%"  champ="tdarticle" id="tdarticle0" >
                                       <?php echo $this->Form->input('articleid',array('value'=>$l['Article']['name'],'div'=>'form-group','label'=>'',  'name' => 'data[Lignecommandeclient]['.$i.'][article_id]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'article_id'.$i,'champ'=>'article_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ','type'=>'text','readonly'=>'readonly') );?>               
                                    </td> 
                                    ...
                                    <td style="width:16%">
                                     <?php
                                     echo $this->Form->input('remise',array('value'=>$l['Lignecommandeclient']['remise'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][remise]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'remise'.$i,'champ'=>'remise','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control','readonly'=>'readonly') );?>
                                    </td>
		...
		echo $this->Form->input('remise',array('value'=>$l['Commandeclient']['remise'],'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'text','readonly'=>'readonly','after'=>'</div>','id'=>'remise','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );
		  ...
		  $lien_vente=  CakeSession::read('lien_vente');
                ...
                if(@$marge==1){ echo $this->Form->input('marge',array('div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'text','readonly'=>'readonly','after'=>'</div>','id'=>'marge','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );}
