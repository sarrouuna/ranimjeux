...
<div class="row">
    <div class="col-md-12">
        <a class="btn btn btn-danger" href="<?php echo $this->webroot;?>Commandeclients/add"/> <i class="fa fa-plus-circle"></i> Ajouter </a>
...
<div class="row" >
    <div class="col-md-12" >
        ...
        <?php echo $this->Form->create('Commandeclient',array('autocomplete' => 'off','class'=>'form-horizontal ls_form')); ?>
...
<div class="row">
	...
	<tr>
		<td style="display:none"><?php echo h($commandeclient['Commandeclient']['id']); ?></td>
		...
		<td align="center">
			<?php echo $this->Html->link("<button class='btn btn-xs btn-success'><i class='fa fa-search'></i></button>", array('action' => 'view', $commandeclient['Commandeclient']['id']),array('escape' => false)); ?>
                <?php if($commandeclient['Commandeclient']['type']==0) {?>       
                        <?php if(($edit==1)&($test==1)){ echo  $this->Html->link("<button class='btn btn-xs btn-warning'><i class='fa fa-edit'></i></button>", array('action' => 'edit', $commandeclient['Commandeclient']['id']),array('escape' => false)); } ?>
                <?php } else { ?> 
