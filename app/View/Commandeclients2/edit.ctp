...
<div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Modification Commandeclient'); ?></h3>
                                </div>
		...
		echo $this->Form->input('dateliv',array('div'=>'form-group','value'=>$dateliv,'type'=>'text','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly') );
                ?>
  </div>        
                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                               ...
                               <tr class="tr" style="display:none;" >
                                    ...
                                    <td  >
                                        <?php echo $this->Form->input('article_id',array('div'=>'form-group','label'=>'', 'name' => '','table'=>'Lignecommandeclient','index'=>'','id'=>'article_id','champ'=>'article_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control articleidbl','empty'=>'Veuillez Choisir !!') );?>
                                    </td>
                                    <td >
                                ...
                                <tr class="cc testclientvide" >
                                    ...
                                    <td>
                                    	 <?php	echo $this->Form->input('depot_id',array('value'=>$l['Depot']['id'],'label'=>'','div'=>'form-group', 'name' => 'data[Lignecommandeclient]['.$i.'][depot_id]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'depot_id'.$i,'champ'=>'depot_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select depot_qte_s','empty'=>'Veuillez Choisir !!') );?>
                                    </td> 
                                    <td  >
                                       <?php echo $this->Form->input('article_id',array('value'=>$l['Article']['id'],'div'=>'form-group','label'=>'',  'name' => 'data[Lignecommandeclient]['.$i.'][article_id]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'article_id'.$i,'champ'=>'article_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select articleidbl','empty'=>'Veuillez choisir !!') );?>               
                                    </td> 
                                     <td >
                                        <?php echo $this->Form->input('id',array('value'=>$l['Lignecommandeclient']['id'],'name'=>'data[Lignecommandeclient]['.$i.'][id]','id'=>'id'.$i,'champ'=>'id','table'=>'Lignecommandeclient','index'=>$i,'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control','label'=>'Nom') );?>
                                        ...
                                        <?php echo $this->Form->input('quantitestock',array('readonly'=>'readonly','value'=>@$tabqtestock[$l['Depot']['id']][$l['Article']['id']]['qtestock'],'label'=>'','div'=>'form-group', 'name' => 'data[Lignecommandeclient]['.$i.'][quantitestock]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'quantitestock'.$i,'champ'=>'quantitestock','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control') );?>
                                     </td>
                                     <td >
                                        <?php echo $this->Form->input('quantite',array('value'=>$l['Lignecommandeclient']['quantite'],'label'=>'','div'=>'form-group', 'name' => 'data[Lignecommandeclient]['.$i.'][quantite]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'quantite'.$i,'champ'=>'quantite','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control   calculefacture') );?>
                                    </td>
                                    <td >
                                     ...
                                     <?php echo $this->Form->input('prix',array('value'=>$l['Lignecommandeclient']['prix'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][prixhtva]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'prixhtva'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeinverseputtc') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('remise',array('value'=>$l['Lignecommandeclient']['remise'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][remise]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'remise'.$i,'champ'=>'remise','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeprix_net_ttc calculefacture') );
                                     echo $this->Form->input('remiseans',array('type'=>'hidden','div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][remiseans]','table'=>'Lignecommande','index'=>$i,'id'=>'remiseans'.$i,'champ'=>'remiseans','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  ') );?>
                                    </td>
                                    <td >
                                     <?php echo $this->Form->input('prixnet',array('value'=>@$l['Lignecommandeclient']['prixnet'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][prixnet]','table'=>'Lignecommande','index'=>$i,'id'=>'prixnet'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  calculeremisenet') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('puttc',array('value'=>@$l['Lignecommandeclient']['puttc'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][puttc]','table'=>'Lignecommande','index'=>$i,'id'=>'puttc'.$i,'champ'=>'puttc','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  calculeprixvente') );
                                     echo $this->Form->input('totalhtans',array('value'=>@$l['Lignecommandeclient']['totalhtans'],'type'=>'hidden','div'=>'form-group','label'=>'','name' => 'data[Lignecommandeclient]['.$i.'][totalhtans]','table'=>'Lignecommande','index'=>$i,'id'=>'totalhtans'.$i,'champ'=>'totalhtans','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('totalht',array('value'=>$l['Lignecommandeclient']['totalht'],'div'=>'form-group','label'=>'','readonly'=>'readonly', 'name' => 'data[Lignecommandeclient]['.$i.'][totalht]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'totalht'.$i,'champ'=>'totalht','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php echo $this->Form->input('tva',array('value'=>$l['Lignecommandeclient']['tva'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][tva]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'tva'.$i,'champ'=>'tva','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculefacture') );?>
                                    </td>
                                    <td >
                                     <?php echo $this->Form->input('totalttc',array('readonly'=>'readonly','value'=>$l['Lignecommandeclient']['totalttc'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][totalttc]','table'=>'Lignecommandeclient','index'=>$i,'id'=>'totalttc'.$i,'champ'=>'totalttc','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                ...
                                <tr class="cc0" >
                                    ...
                                    <td colspan="12">
                                     <?php echo $this->Form->input('designation',array('value'=>@$l['Lignecommandeclient']['designation'],'div'=>'form-group','label'=>'', 'name' => 'data[Lignecommandeclient]['.$i.'][designation]','table'=>'Lignecommandeclient','index'=>'0','id'=>'designation0','champ'=>'designation','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control') );?>
                                    </td>
                                    </tr>
                                  <?php } ?>
                                </tbody>
        ...
        <div class="col-md-6">                  
              	<?php
		echo $this->Form->input('remise',array('value'=>$l['Commandeclient']['remise'],'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'text','readonly'=>'readonly','after'=>'</div>','id'=>'remise','class'=>'form-control') );
	        echo $this->Form->input('tva',array('label'=>'TVA','value'=>$l['Commandeclient']['tva'],'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'text','readonly'=>'readonly','after'=>'</div>','id'=>'tva','class'=>'form-control') );
		  $lien_vente=  CakeSession::read('lien_vente');
                ...
                ?></div><div class="col-md-6"><?php
		echo $this->Form->input('totalht',array('label'=>'Total HT','value'=>$l['Commandeclient']['totalht'],'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'text','readonly'=>'readonly','after'=>'</div>','id'=>'Total_HT','class'=>'form-control') );
		echo $this->Form->input('totalttc',array('label'=>'Total TTC','value'=>$l['Commandeclient']['totalttc'],'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'text','readonly'=>'readonly','after'=>'</div>','id'=>'Total_TTC','class'=>'form-control') );
	?>
  </div>                                                        
                                                   
<div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                <button type="submit" class="btn btn-primary testlignedevente testpv test-edit-numerofacture">Enregistrer</button>
                                            </div>
                                        </div>
