                ...
                <tr>
                    <td width="40%">
                        <table border="1" cellpadding="2" cellspacing="0">
                            <tr>
                                <td align="center" width="100%" colspan="2" style="background-color:#b8b8b8"  ><strong> COMMANDE </strong></td>
                            </tr>
                            <tr>
                                <td height="32px" align="center" width="50%"  ><strong>Numero</strong></td>
                                <td align="center" width="50%" height="35px" ><strong>Date</strong></td>
                            </tr>
                             <tr>
                                <td height="32px" align="center" width="50%"  >'.$commandeclient['Commandeclient']['numero'].'</td>
                                <td align="center" width="50%"  height="35px"> '.date("d/m/Y", strtotime(str_replace('-', '/',  $commandeclient['Commandeclient']['date']))).'  </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td width="50%">
                        <table border="1" cellpadding="2" cellspacing="0">
                            <tr>
                                <td align="center" width="100%"  style="background-color:#b8b8b8;" ><strong>CLIENT </strong></td>
                            </tr>
                            <tr>
                                <td>
                                    <table >
                                        ...
                                        <tr>
                                            <td align="center" width="100%"   ><strong>'.$commandeclient['Commandeclient']['name'].' </strong></td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="100%"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Matricule Fiscal :</strong>'.$commandeclient['Client']['matriculefiscale'].'</td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="100%"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Telephone :</strong>'.$commandeclient['Client']['tel'].'</td>
                                        </tr>
                                        <tr>
                                            <td align="left" width="100%"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Adresse :</strong>'.$commandeclient['Client']['adresse'].'</td>
                                        </tr>
...
$tbl .='
     ...
     <tr> 
        <td align="left" '.$styl_cadr.' width="55%" >&nbsp;'. $lr['Lignecommandeclient']['designation'].'</td>
        <td align="center" '.$styl_cadr.' width="5%">&nbsp;'.$lr['Lignecommandeclient']['quantite'].'</td>  
        <td align="center" '.$styl_cadr.' width="10%">&nbsp;'.$lr['Lignecommandeclient']['prix'].'</td>  
        <td align="center" '.$styl_cadr.' width="5%">&nbsp;'.$lr['Lignecommandeclient']['remise'].'</td>  
        <td align="center" '.$styl_cadr.' width="5%">&nbsp;'.$lr['Lignecommandeclient']['tva'].'</td>  
        <td align="right" '.$styl_cadr.' width="10%">&nbsp;'.$lr['Lignecommandeclient']['totalht'].'&nbsp;&nbsp;</td>  
        <td align="right" '.$styl_cadr.' width="10%">&nbsp;'.$lr['Lignecommandeclient']['totalttc'].'&nbsp;&nbsp;</td>  
            ...
            <td width="36%">
                <table border="1">
                    <tr>
                        ...
                        <td align="right"  width="50%">'.$commandeclient['Commandeclient']['remise'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" style="background-color:#b8b8b8" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total TVA  </strong></td>  
                        <td align="right"  width="50%">'.$commandeclient['Commandeclient']['tva'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>  
                     </tr> 
                   
                    <tr>
                        <td align="left" style="background-color:#b8b8b8" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total HT  </strong></td>  
                        <td align="right"  width="50%">'.$commandeclient['Commandeclient']['totalht'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                    </tr>    
                    <tr>
                        <td align="left" style="background-color:#b8b8b8" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total TTC  </strong></td>  
                        <td align="right"  width="50%">'.$commandeclient['Commandeclient']['totalttc'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>  
                    </tr>   
...
<table border="1">
    <tr>
        ...
        <br>   <br>
            <strong>Arreter la présente Commande à la somme de :</strong>
            <br>
