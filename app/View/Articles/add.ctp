...
//                    echo $this->Form->input('stockoptimal', array('label' => 'Stock Optimal', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control'));
                    ...
                    echo $this->Form->input('marge', array('readonly', 'label' => 'Marge %', 'type' => 'text', 'id' => 'margepourcentage', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control calculmarge calculputtc calculecommercial'));
