                ...
                ?>	 
                   ...
                   <div class="row ligne" style="width:180%">
                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Ligne facture client'); ?></h3>
                                ...
                                <tr class="cc0 testclientvide" >
                                    ...
                                    <td colspan="12">
                                     <?php echo $this->Form->input('designation',array('div'=>'form-group','label'=>'', 'name' => 'data[Lignefactureclient][0][designation]','table'=>'Lignefactureclient','index'=>'0','id'=>'designation0','champ'=>'designation','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control') );?>
                                    </td>
                                    </tr>
                                </tbody>
                                </table>
