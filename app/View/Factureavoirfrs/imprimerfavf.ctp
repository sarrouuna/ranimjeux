...
$pdf->SetTitle('Facture a voir fournisseur');
...
<tr>
    ...
    <td  width="45%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>Facture à voir N°: ' . $factureavoir['Factureavoirfr']['numero'] . '</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" >
                        <strong>' . $factureavoir['Fournisseur']['name'] . '</strong>
                        <br>
                        ' . $factureavoir['Fournisseur']['adresse'] . '
                    </td> 
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        ...
                        <br>
                        ' . $factureavoir['Fournisseur']['matriculefiscale'] . '
                    </td> 
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" >
                       ...
                       <strong>Total TTC</strong> <br>  ' . $factureavoir['Factureavoirfr']['totalttc'] . '
                    </td> 
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Date</strong>
                        <br>
                        ' . date("d/m/Y", strtotime(str_replace('-', '/', ($factureavoir['Factureavoirfr']['date'])))) . '
                    </td>
                    
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Fournisseur N°</strong>
                        <br>
                        ' . $factureavoir['Fournisseur']['code'] . '
                    </td>
...
foreach ($imputationfactureavoirs as $imp) {
    $tbl .= ' <tr>
        <td height="40px" width="50%" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
           ' . $imp['Facture']['numerofrs'] . '</td>
       <td height="40px" width="50%" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
             ' . $imp['Imputationfactureavoirfr']['montant'] . '</td>
...
<tr>
        ...
        <br>   <br>
            ...
            <br>
            ' . chifre_en_lettre($factureavoir['Factureavoirfr']['totalttc'], 1, 1) . '
        </td>
    </tr>
</table>
        ';
