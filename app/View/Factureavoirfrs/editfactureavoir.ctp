        ...
        <div class="panel panel-default">
            <div class="panel-heading not_padinng">
                <h3 class="panel-title taille_titre">
                    ...
                    <strong><?php echo __('Modifier Facture Avoir'); ?></strong>
                </h3>
            </div>
...
//                    debug($facture[0]['facture']['fournisseur_id']);die;
                    if ($p == 0) {
                        echo $this->Form->input('pointdevente_id', array('type' => 'hidden', 'id' => 'pointdevente_id', 'empty' => 'veuillez choisir', 'div' => 'form-group', 'label' => 'Point de Vente', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control'));
                        echo $this->Form->input('pointdeventename', array('readonly', 'value' => $this->request->data['Pointdevente']['name'], 'id' => 'pointdevente_id', 'empty' => 'veuillez choisir', 'div' => 'form-group', 'label' => 'Point de Vente', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control numspecial inputspcial'));
                    }
                    echo $this->Form->input('id', array('id' => 'id', 'type' => 'hidden', 'div' => 'form-group', 'type' => 'hidden', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control'));
                    ...
                    echo $this->Form->input('facture_id', array('type' => 'hidden', 'div' => 'form-group', 'id' => 'facture_id', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control '));
                    echo $this->Form->input('depot_id', array('type' => 'hidden', 'label' => 'Depot ', 'div' => 'form-group', 'id' => 'depot_id', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control '));
                    echo $this->Form->input('depotname', array('readonly', 'value' => $this->request->data['Depot']['designation'], 'label' => 'Depot ', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control inputspcial'));
                    echo $this->Form->input('fournisseur_id', array('type' => 'hidden', 'id' => 'fournisseur_id', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control inputspcial'));
                    echo $this->Form->input('fournisseurname', array('label' => 'Fournisseur', 'readonly', 'value' => $this->request->data['Fournisseur']['name'], 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control inputspcial'));
                    ...
                    echo $this->Form->input('numero', array('label' => 'Numéro Interne', 'id' => 'numero', 'div' => 'form-group', 'readonly' => 'readonly', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control inputspcial'));
...
//                                debug($l);
                                $ligne = ClassRegistry::init('Lignefacture')->find('first', array('conditions' => array('Lignefacture.id' => $l['Lignefactureavoirfr']['lignefacture_id']), 'recursive' => -1));
...
//                                debug($ligne);
                                ...
                                <tr class="cc" >
                                    ...
                                    <td style="width:6%">
                                        <?php echo $this->Form->input('lignefacture_id', array('value' => $l['Lignefactureavoirfr']['lignefacture_id'], 'name' => 'data[Lignefacture][' . $i . '][lignefacture_id]', 'id' => 'lignefacture_id' . $i, 'champ' => 'lignefacture_id', 'table' => 'Lignefacture', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'type' => 'hidden', 'after' => '</div>', 'class' => 'form-control', 'label' => 'Nom')); ?>

                                        <?php echo $this->Form->input('id', array('value' => $l['Lignefactureavoirfr']['id'], 'name' => 'data[Lignefacture][' . $i . '][id]', 'id' => 'id' . $i, 'champ' => 'id', 'table' => 'Lignefacture', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'type' => 'hidden', 'after' => '</div>', 'class' => 'form-control', 'label' => 'Nom')); ?>
                                        ...
                                        <?php echo $this->Form->input('quantite', array('value' => $ligne['Lignefacture']['quantite'] - $ligne['Lignefacture']['qtebonus'], 'label' => '', 'div' => 'form-group', 'readonly' => 'readonly', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'quantitett' . $i, 'champ' => 'quantitett', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control   calculefacture')); ?>
                                    </td>
                                    <td style="width:6%">
                                        <?php echo $this->Form->input('quantite', array('value' => $l['Lignefactureavoirfr']['quantite'], 'label' => '', 'div' => 'form-group', 'name' => 'data[Lignefacture][' . $i . '][quantite]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'quantite' . $i, 'champ' => 'quantite', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control testfavr  calculfactureamine')); ?>
                                    </td>
                                    <td style="width:10%">
                                        <?php echo $this->Form->input('prix', array('readonly', 'value' => $l['Lignefactureavoirfr']['prix'], 'div' => 'form-group', 'label' => '', 'name' => 'data[Lignefacture][' . $i . '][prix]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'prixhtva' . $i, 'champ' => 'prixhtva', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculeinverseputtc')); ?>
                                    </td>
                                    <td style="width:6%">
                                        <?php echo $this->Form->input('remise', array('readonly', 'value' => $l['Lignefactureavoirfr']['remise'], 'div' => 'form-group', 'label' => '', 'name' => 'data[Lignefacture][' . $i . '][remise]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'remise' . $i, 'champ' => 'remise', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculefacture')); ?>
                                    </td>
                                    <td style="width:9%">
                                        <?php echo $this->Form->input('prixnet', array('readonly', 'value' => @$l['Lignefactureavoirfr']['prixnet'], 'div' => 'form-group', 'label' => '', 'name' => 'data[Lignefacture][' . $i . '][prixnet]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'prixnet' . $i, 'champ' => 'prix', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  calculeremisenet')); ?>
                                    </td>
                                    <td style="width:9%">
                                        <?php
                                        echo $this->Form->input('puttc', array('readonly', 'value' => @$l['Lignefactureavoirfr']['puttc'], 'div' => 'form-group', 'label' => '', 'name' => 'data[Lignefacture][' . $i . '][puttc]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'puttc' . $i, 'champ' => 'puttc', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  calculeprixvente'));
                                        echo $this->Form->input('totalhtans', array('value' => @$l['Lignefactureavoirfr']['prix'], 'type' => 'hidden', 'div' => 'form-group', 'label' => '', 'readonly' => 'readonly', 'name' => 'data[Lignefacture][' . $i . '][totalhtans]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'totalhtans' . $i, 'champ' => 'totalhtans', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control '));
                                        ?>
                                    </td>
                                    <td style="width:9%">
                                        <?php echo $this->Form->input('totalht', array('value' => $l['Lignefactureavoirfr']['totalht'], 'div' => 'form-group', 'label' => '', 'readonly' => 'readonly', 'name' => 'data[Lignefacture][' . $i . '][totalht]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'totalht' . $i, 'champ' => 'totalht', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control ')); ?>
                                    </td>
                                    <td width="3%">
                                        <?php echo $this->Form->input('fodec', array('value' => $l['Lignefactureavoirfr']['fodec'], 'readonly' => 'readonly', 'div' => 'form-group', 'label' => '', 'name' => 'data[Lignefacture][' . $i . '][fodec]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'fodec' . $i, 'champ' => 'fodec', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control ')); ?>
                                    </td>
                                    <td style="width:5%">
                                        <?php echo $this->Form->input('tva', array('readonly', 'value' => $l['Lignefactureavoirfr']['tva'], 'div' => 'form-group', 'label' => '', 'name' => 'data[Lignefacture][' . $i . '][tva]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'tva' . $i, 'champ' => 'tva', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculefacture')); ?>
                                    </td>
                                    <td style="width:9%">
                                        <?php echo $this->Form->input('totalttc', array('readonly' => 'readonly', 'value' => $l['Lignefactureavoirfr']['totalttc'], 'div' => 'form-group', 'label' => '', 'readonly' => 'readonly', 'name' => 'data[Lignefacture][' . $i . '][totalttc]', 'table' => 'Lignefacture', 'index' => $i, 'id' => 'totalttc' . $i, 'champ' => 'totalttc', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control ')); ?>
                                    </td>
