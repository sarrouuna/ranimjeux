...
<br><br>
        ...
        $tbl .= 
    '<tr bgcolor="#FFFFFF" align="center">    
        <td width="50%" nobr="nobr" align="left" height="30px" $zz>'.$br['Tabetatclient']['name'].'</td>
        <td width="25%" nobr="nobr" align="right"  $zz>'.number_format($br[0]['tot'],3, '.', ' ').'</td>
        <td width="25%" nobr="nobr" align="right"  $zz>'.number_format($br[0]['ttc'],3, '.', ' ').'</td>
...
$tbl .= '
   <tr bgcolor="#FFFFFF" align="center">    
        ...
        <td width="50%" colspan="3" nobr="nobr" align="center"  $zz>Total</td>
        <td width="25%" nobr="nobr" align="right"  $zz>'.number_format($total,3, '.', ' ').'</td>
        <td width="25%" nobr="nobr" align="right"  $zz>'.number_format($totalttc,3, '.', ' ').'</td>
    </tr>
</table>';
