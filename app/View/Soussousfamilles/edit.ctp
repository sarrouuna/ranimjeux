...
<div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Modification Sous Sous Famille'); ?></h3>
                                </div>
		...
		echo $this->Form->input('famille_id',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','id'=>'famille_id','class'=>'form-control select getsousfamille','required data-bv-notempty-message'=>'Champ Obligatoire','empty'=>'Veuillez Choisir !!') );
               ...
               <div class="sf"><?php  echo $this->Form->input('sousfamille_id',array('label'=>'Sous Famille','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','id'=>'sousfamille_id','class'=>'form-control select getsoussousfamille','required data-bv-notempty-message'=>'Champ Obligatoire','empty'=>'Veuillez Choisir !!') ); ?></div> 
