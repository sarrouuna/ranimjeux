...
<div class="row" >
		...
		echo $this->Form->input('numero',array('label'=>'Num&eacute;ro','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
                echo $this->Form->input('responsable',array('value'=>explode(',',$this->request->data['Affaire']['responsable']),'multiple'=>'multiple','id'=>'responsable','empty'=>'veuillez choisir','div'=>'form-group','label'=>'Responsables','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control'));
                ?>
                <div class="" style="display:inline; position: relative;">
                <?php
                echo $this->Form->input('name',array('id' => 'Designation','label'=>'D&eacute;signation','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control selectidd') );
		?>
		...
		echo $this->Form->input('entreprisedefluide',array('label'=>'entreprise de fluide','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
                echo $this->Form->input('contact',array('label'=>'premi&eacute;re contact entreprise','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
		echo $this->Form->input('telcontact',array('label'=>'Tel contact ','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
		echo $this->Form->input('emailcontact',array('label'=>'Email contact ','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
                ?>
  </div>  
				...
				<tr class="tr" style="display:none;">
			                ...
			                <?php echo $this->Form->input('namepiecejointe',array('value'=>$piecejointe['Piecejointeaffaire']['namepiecejointe'],'div'=>'form-group','label'=>'', 'name' => 'data[Piecejointeaffaire]['.$i.'][namepiecejointe]','table'=>'Piecejointeaffaire','index'=>'0','id'=>'name','champ'=>'name','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control') );?>
                                </td>
                                <td>
