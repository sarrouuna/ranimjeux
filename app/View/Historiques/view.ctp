                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Consultation Bonreception'); ?></h3>
                                </div>
                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                                ...
                                <tr>
                                    ...
                                    <td style="width:12%">
                                          <input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo @$datefabrication ?>'>  
                                    </td>
                                    <td  style="width:12%">
                                          <input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo @$datevalidite ?>'>  
                                    </td>
                                     <td style="width:10%">
                                          <input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo $lr['Lignereception']['numerolot'] ?>'>  
                                    </td>
                                     <td style="width:8%">
