...
$tbl .='
     ...
     <tr> 
        <td align="left" '.$styl_cadr.' width="55%" >&nbsp;'. $lr['Lignedevi']['designation'].'</td>
        <td align="center" '.$styl_cadr.' width="5%">&nbsp;'.$lr['Lignedevi']['quantite'].'</td>  
        <td align="center" '.$styl_cadr.' width="10%">&nbsp;'.$lr['Lignedevi']['prix'].'</td>  
        <td align="center" '.$styl_cadr.' width="5%">&nbsp;'.$lr['Lignedevi']['remise'].'</td>  
        <td align="center" '.$styl_cadr.' width="5%">&nbsp;'.$lr['Lignedevi']['tva'].'</td>  
        <td align="right" '.$styl_cadr.' width="10%">&nbsp;'.$lr['Lignedevi']['totalht'].'</td>  
        <td align="right" '.$styl_cadr.' width="10%">&nbsp;'.$lr['Lignedevi']['totalttc'].'</td>  
                ...
                <table border="1">
                    ...
                    $tva=0;
                     foreach ($lignefactureclientstva as $i=>$lr){
                         ...
                         $mnt=0;$mnt_ttc=0;
                         $mnt=($lr['Lignedevi']['totalht']*$lr['Lignedevi']['tva'])/100;
                         $mnt_ttc=$lr['Lignedevi']['totalht']+$mnt;
...
<table border="1">
    <tr>
        ...
        <br>   <br>
            <strong>Arreter la présente Devi à la somme de :</strong>
            <br>
