			...
			<div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' class='input' value='<?php echo h($devi['Devi']['date']); ?>'>
                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                                ...
                                <tr class="cc" >
                                     <td style="width:30%">
                                        <?php echo $this->Form->input('article_id',array('value'=>$l['Article']['name'],'div'=>'form-group','readonly'=>'readonly', 'type' => 'text','label'=>'',  'name' => 'data[Lignedevi]['.$i.'][article_id]','table'=>'Lignedevi','index'=>$i,'id'=>'article_id'.$i,'champ'=>'article_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ','empty'=>'Veuillez choisir !!') );?>               
 </td>
                                     <td style="width:16%">
                                    ...
                                    <td style="width:16%">
                                     <?php
                                     echo $this->Form->input('remise',array('value'=>$l['Lignedevi']['remise'],'div'=>'form-group','readonly'=>'readonly','label'=>'', 'name' => 'data[Lignedevi]['.$i.'][remise]','table'=>'Lignedevi','index'=>$i,'id'=>'remise'.$i,'champ'=>'remise','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td style="width:16%">
    ...
    <div class="col-md-6">                  
		...
		echo $this->Form->input('remise',array('value'=>$l['Devi']['remise'],'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'text','readonly'=>'readonly','after'=>'</div>','id'=>'remise','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );
		  ...
		  $lien_vente=  CakeSession::read('lien_vente');
                ...
                if(@$marge==1){ echo $this->Form->input('marge',array('value'=>$l['Devi']['marge'],'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'text','readonly'=>'readonly','after'=>'</div>','id'=>'marge','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );}
