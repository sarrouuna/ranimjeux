...
<div class="row">
    <div class="col-md-12">
        <a class="btn btn btn-danger" href="<?php echo $this->webroot;?>Devis/add/1"/> <i class="fa fa-plus-circle"></i> Ajouter </a>
    </div>
...
<div class="row">
	...
	<?php foreach ($devis as $i=>$devi): if($devi['Devi']['type']==1){ ?>
	...
	<tr>
		...
		<td ><?php echo h($devi['Devi']['totalttc']); ?></td>
            <?php  if((($addindirect==1)||($addbonlivraison==1)||($addcommandeclient==1))&($devi['Devi']['etat']==0)){?>           
                <td align="center">
		...
		<td align="center">
			<?php echo $this->Html->link("<button class='btn btn-xs btn-success'><i class='fa fa-search'></i></button>", array('action' => 'view', $devi['Devi']['id'],1),array('escape' => false)); ?>
                        <?php if(($edit==1)&($devi['Devi']['etat']==0)){ echo $this->Html->link("<button class='btn btn-xs btn-warning'><i class='fa fa-edit'></i></button>", array('action' => 'edit', $devi['Devi']['id'],1),array('escape' => false)); }?>
                ...
                <?php  if($imprimer==1) { ?>
                <a onClick="flvFPW1(wr+'Devis/imprimer/'+<?php  echo  $devi['Devi']['id'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
              <?php  } ?>
