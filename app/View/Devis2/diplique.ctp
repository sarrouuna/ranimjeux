                   ...
                   <div class="row ligne" style="width:180%">
                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                               ...
                               <tr class="cc" >
                                     <td>
                                    	 <?php	echo $this->Form->input('depot_id',array('value'=>$l['Depot']['id'],'label'=>'','div'=>'form-group', 'name' => 'data['.$ligne.']['.$i.'][depot_id]','table'=>'Lignedevi','index'=>$i,'id'=>'depot_id'.$i,'champ'=>'depot_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select depot_qte_s','empty'=>'Veuillez Choisir !!') );?>
                                    </td> 
                                    <td >
                                     ...
                                     <td >
                                        ...
                                        <?php echo $this->Form->input('quantitestock',array('readonly'=>'readonly','value'=>@$tabqtestock[$l['Depot']['id']][$l['Article']['id']]['qtestock'],'label'=>'','div'=>'form-group', 'name' => 'data['.$ligne.']['.$i.'][quantitestock]','table'=>'Lignedevi','index'=>$i,'id'=>'quantitestock'.$i,'champ'=>'quantitestock','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control') );?>
                                     </td>
                                     <td >
                                        <?php echo $this->Form->input('quantite',array('value'=>$l[$ligne_ans]['quantite'],'label'=>'','div'=>'form-group', 'name' => 'data['.$ligne.']['.$i.'][quantite]','table'=>'Lignedevi','index'=>$i,'id'=>'quantite'.$i,'champ'=>'quantite','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control   calculefacture') );?>
                                    </td>
                                    <td >
                                     ...
                                     <?php echo $this->Form->input('prix',array('value'=>$l[$ligne_ans]['prix'],'div'=>'form-group','label'=>'', 'name' => 'data['.$ligne.']['.$i.'][prixhtva]','table'=>'Lignedevi','index'=>$i,'id'=>'prixhtva'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeinverseputtc') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('remise',array('value'=>$l[$ligne_ans]['remise'],'div'=>'form-group','label'=>'', 'name' => 'data['.$ligne.']['.$i.'][remise]','table'=>'Lignedevi','index'=>$i,'id'=>'remise'.$i,'champ'=>'remise','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculefacture') );
                                    ...
                                    <td>
                                     <?php echo $this->Form->input('prixnet',array('value'=>@$l[$ligne_ans]['prixnet'],'div'=>'form-group','label'=>'', 'name' => 'data['.$ligne.']['.$i.'][prixnet]','table'=>'Lignedevi','index'=>$i,'id'=>'prixnet'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  calculeremisenet') );?>
                                    </td>
                                     <td >
                                     <?php
                                     echo $this->Form->input('puttc',array('value'=>@$l[$ligne_ans]['puttc'],'div'=>'form-group','label'=>'', 'name' => 'data['.$ligne.']['.$i.'][puttc]','table'=>'Lignedevi','index'=>$i,'id'=>'puttc'.$i,'champ'=>'puttc','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  calculeprixvente') );
                                    ...
                                    <td >
                                     <?php
                                     echo $this->Form->input('totalht',array('readonly'=>'readonly','value'=>$l[$ligne_ans]['totalht'],'div'=>'form-group','label'=>'','readonly'=>'readonly', 'name' => 'data['.$ligne.']['.$i.'][totalht]','table'=>'Lignedevi','index'=>$i,'id'=>'totalht'.$i,'champ'=>'totalht','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php echo $this->Form->input('tva',array('value'=>$l[$ligne_ans]['tva'],'div'=>'form-group','label'=>'', 'name' => 'data['.$ligne.']['.$i.'][tva]','table'=>'Lignedevi','index'=>$i,'id'=>'tva'.$i,'champ'=>'tva','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculefacture') );?>
                                    </td>
                                    <td >
                                     <?php echo $this->Form->input('totalttc',array('readonly'=>'readonly','value'=>$l[$ligne_ans]['totalttc'],'div'=>'form-group','label'=>'', 'name' => 'data['.$ligne.']['.$i.'][totalttc]','table'=>'Lignedevi','index'=>$i,'id'=>'totalttc'.$i,'champ'=>'totalttc','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
