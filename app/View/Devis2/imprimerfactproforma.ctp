...
$pdf->SetTitle('Devi Proforma Client');
...
<table>
    <tr>
        <td width="45%">
            <table >
                <tr>
                    <td align="center" width="100%" colspan="4" '.$styl_cadr.'  ><strong> FACTURE PROFORMA </strong></td>
                </tr>
                <tr>
...
$tbl .='
     ...
     <tr> 
        <td align="center" style="border-bottom:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="30%" >&nbsp;'. $lr['Lignedevi']['designation'].'</td>
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="15%">&nbsp;'.$lr['Lignedevi']['totalht'].'</td>  
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="15%">&nbsp;'.$lr['Lignedevi']['totalttc'].'</td>  
...
<tr>
        ...
        <br>   <br>
            <strong>Arretée la présente Facture proforma à la somme de :</strong>
            <br>
