...
<tr>
    ...
    <td  width="45%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>liste des reglements clients  '.$m.'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
...
//debug($reglements);die;
        foreach ($reglements as $reglement){
            ...
            foreach($reglement['Lignereglementclient'] as $y=>$li ){
...
//                 ---------- Supp Decalage entre l en Tete et Le Tableau ------------
        ...
        $cli=$reglement['Client']['name'];
        $date=$reglement['Reglementclient']['Date'];
        $date=date("d/m/Y",strtotime(str_replace('-','/',$date)));
        $mont=$reglement['Reglementclient']['Montant'];
        $totR=$totR+$rem;
        $tot=$tot+$mont;
        ...
        $tbl .= 
    '<tr bgcolor="#FFFFFF" align="center">    
        <td width="35%" nobr="nobr" align="center" height="30px" $zz>'.$cli.'</td>
