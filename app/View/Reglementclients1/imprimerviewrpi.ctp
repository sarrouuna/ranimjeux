...
$pdf->SetTitle('Reglement des impayes');
...
<tr>
    ...
    <td  width="45%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>Reglement des impayes N°: '.$reglement['Reglementclient']['id'].'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
...
<tr>
    ...
    <thead>
        ...
        <tr>
            ...
            <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="20%"><strong>Echéance</strong></td>
...
//$long="670";
        ...
        $numero = $l['Piecereglementclient']['num']; 
        $date = date("d/m/Y",strtotime(str_replace('-','/',$l['Piecereglementclient']['echance'])));
        $total_ttc = $l['Piecereglementclient']['montant'];
        $mnt_reg = $l['Piecereglementclient']['montant'];
...
$tbl .='
    <tbody>
     <tr> 
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="20%">0</td>
