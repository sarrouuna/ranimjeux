                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Consultation règlement des impayés '); ?></h3>
                                </div>
           ...
           <div class="col-md-6"> 
			...
			<?php  //debug($reglement);die;?>
                                  <div class='col-sm-10'><input type='text'  class='form-control' readonly='readonly' value='<?php echo $reglement['Client']['name']; ?>'>
                                	 ...
                                	 <div class='form-group'>	
                                 <label class='col-md-2 control-label'><?php echo __('Echéance'); ?></label>	
                                ...
                                <table class="table table-bordered table-striped table-bottomless" id="table">
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width:25%"> <?php echo $l['Piecereglementclient']['num']; ?></td>
                                                <td style="width:25%"><?php echo  date("d/m/Y",strtotime(str_replace('-','/',$l['Piecereglementclient']['echance']))); ?></td>
                                                <td style="width:25%"><?php echo $l['Piecereglementclient']['montant']; ?></td>
                                                <td style="width:25%"><?php echo 0 ?> </td>
                                                
                                            </tr>
                                            <?php }?>
                                             <tr>
                                                <td colspan="3" >Total</td>
                                                <td colspan="1" ><?php echo h($reglement['Reglementclient']['Montant']); ?></td>
                                            </tr>
