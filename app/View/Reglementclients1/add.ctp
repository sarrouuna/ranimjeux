...
<!--                                                 <td><input type="text" name="data[Lignereglement][<?php echo $i; ?>][remise]" id="remise<?php echo $i;?>" class="form-control remisel " index="<?php echo $i; ?>" value="0.000">
                                            ...
                                            <td style="width:15%;">
                                                ...
                                                <tr> 
                                                <td style="width:1%;">    
                                                 <input type="checkbox" name="data[Lignereglement][<?php echo $i; ?>][factureclient_id]" id="facture_id<?php echo $i; ?>" index="<?php echo $i; ?>" class="chekreglement afficheinputmontantreglementclient" value="<?php echo $fac['Factureclient']['id'] ?>" mnt="<?php echo $fac['Factureclient']['totalttc']-$fac['Factureclient']['Montant_Regler']; ?>" >
                                                </td>
                                                <td style="width:99%;" align="left">
                                                <?php
                                                echo $this->Form->input('Montant',array('style'=>'display:none','index'=>$i,'name'=>'data[Lignereglement]['.$i.'][Montant]','id'=>'Montantregler'.$i,'label'=>'','div'=>'','between'=>'<div class="col-sm-12">','after'=>'','type'=>'text','class'=>'form-control testmontantreglementclient') );
                                                ?>
                                                </td>    
                                                </tr>
                                                </table>
