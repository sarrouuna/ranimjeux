...
<div class="row" >
	...
	?></div><div class="col-md-6"><?php
                echo $this->Form->input('numero',array('id'=>'numero','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire') );
                  ...
                  <table class="table table-bordered table-striped table-bottomless" id="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $fac['Factureclient']['Montant_Regler']-@$lignereglementclient['Lignereglementclient']['Montant']; ?></td>
                                                <td><?php echo ($fac['Factureclient']['totalttc']-$fac['Factureclient']['Montant_Regler'])+@$lignereglementclient['Lignereglementclient']['Montant']; ?></td>
                                            
                                             <td style="width:15%;">
                                                <table >
                                                <tr> 
                                                <td style="width:1%;">
                                                 <input type="checkbox"<?php if(@$facregclient[@$fac['Factureclient']['id']]==1){?> checked="checked"<?php  } ?> name="data[Lignereglement][<?php echo $f; ?>][factureclient_id]" id="facture_id<?php echo $f; ?>" index="<?php echo $f; ?>" class="chekreglement afficheinputmontantreglementclient" value="<?php echo $fac['Factureclient']['id'] ?>" mnt="<?php echo $fac['Factureclient']['totalttc'] ?>" >
                                             </td>
