...
<!--                                                 <td><input type="text" name="data[Lignereglement][<?php echo $i; ?>][remise]" id="remise<?php echo $i;?>" class="form-control remisel " index="<?php echo $i; ?>" value="0.000">
                                             ...
                                             <td><input type="checkbox" name="data[Lignereglement][<?php echo $i; ?>][factureclient_id]" id="facture_id<?php echo $i; ?>" index="<?php echo $i; ?>" class="chekreglement" value="<?php echo $fac['Factureclient']['id'] ?>" mnt="<?php echo $fac['Factureclient']['totalttc']-$fac['Factureclient']['Montant_Regler']; ?>" >
                                           </td>
                                            </tr>
                                            <?php }?>
