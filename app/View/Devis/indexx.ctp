...
if ($add == 1) {
    ...
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn btn-danger" href="<?php echo $this->webroot; ?>Factureclients/add/Devi/Lignedevi/devi_id/1"/> <i class="fa fa-plus-circle"></i> Ajouter </a>
        </div>
...
<!--                                            <a href="#reModal_refuser" onClick="recap_devi(<?php echo $devi['Devi']['id'] ?>)"  ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>-->
                                            <a onClick="flvFPW1(wr + 'Factureclients/imprimer/<?php echo $devi['Devi']['id']; ?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("Devi"));?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("Lignedevi"));?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("devi_id"));?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("devis"));?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("Facture Proforma"));?>', 'UPLOAD', 'width=800,height=1150,scrollbars=yes', 0, 2, 2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
                                        <a onClick="flvFPW1(wr + 'Factureclients/imprimerhaithammatricielle/<?php echo $devi['Devi']['id']; ?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("Devi"));?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("Lignedevi"));?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("devi_id"));?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("devis"));?>/<?php echo urlencode(Appcontroller::encrypt_decrypt("Facture Proforma"));?>', 'UPLOAD', 'width=800,height=1150,scrollbars=yes', 0, 2, 2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs btn-success'><i class='fa fa-print'></i></button></a>
    <?php } ?>
