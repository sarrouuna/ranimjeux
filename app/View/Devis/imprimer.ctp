            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border: 1px solid black;" >
                        <strong style="font-size:15;">Devis N° :'.$devi['Devi']['numero'].'</strong><br><br> 
...
$tbl .='
     ...
     <tr> 
        ...
        <td align="left" '.$styl_cadr_bottom.' width="30%" >&nbsp;'.substr($lr['Lignefactureclient']['designation'],0,40).'</td>
        <td align="center" '.$styl_cadr_bottom.' width="10%">&nbsp;'.$lr['Lignedevi']['quantite'].'</td>  
        ...
        <td align="right" '.$styl_cadr_bottom.' width="10%" >&nbsp;'.$lr['Lignedevi']['puttc'].'</td>
...
<table >
    <tr>
        <td   width="100%" align="left" >
            <strong style="font-size:10;">Arreter la présente Devi à  la somme de :</strong><br>
