...
<tr>
    ...
    <td  width="55%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>liste des devis  '.$m.'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr bgcolor="#FFFFFF" align="center">
    ...
    '<tr bgcolor="#FFFFFF" align="center">    
        ...
        <td width="12%" nobr="nobr" align="center"  $zz>'.date("d/m/Y",strtotime(str_replace('-','/',$br['Devi']['date']))).'</td>
        <td width="12%" nobr="nobr" align="center"  $zz>'.$br['Devi']['numero'].'</td>
        <td width="12%" nobr="nobr" align="right"  $zz>'.$br['Devi']['remise'].'</td>
        <td width="12%" nobr="nobr" align="right"  $zz>'.$br['Devi']['tva'].'</td>
        <td width="16%" nobr="nobr" align="right"  $zz>'.$br['Devi']['totalht'].'</td>
        <td width="16%" nobr="nobr" align="right"  $zz>'.$br['Devi']['totalttc'].'</td>
    </tr>' ;     
}
