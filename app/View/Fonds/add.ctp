...
<fieldset>
    ...
    <div class="widget first">
        <div class="head"><h5 class="iList"><?php echo __('Ajout  Fond'); ?></h5></div>
		...
		echo $this->Form->input('fond',array('type'=>'text','div'=>'rowElem nobg','between'=>'<div class="formRight">','after'=>'</div><div class="fix"></div>') );
		           echo $this->Form->input('date',array('div'=>'rowElem nobg','between'=>'<div class="formRight">','type'=>'text','value'=>date('d/m/Y'),'after'=>'</div><div class="fix"></div>') );
	?>
