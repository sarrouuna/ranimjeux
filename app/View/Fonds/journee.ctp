...
<fieldset>
    ...
    <div class="widget first">
        <div class="head"><h5 class="iList"><?php echo __('Ouvrir  Journée'); ?></h5></div>
	  ...
	  echo $this->Form->input('date_fin',array('div'=>'rowElem nobg','between'=>'<div class="formRight">','value'=>date('d/m/Y H:i:s'),'type'=>'text','after'=>'</div><div class="fix"></div>') );
	?>
...
;?>   </td>
<td><?php  echo $this->Form->input('date',array('label'=>'','value'=>date('d/m/Y H:i:s'),'name'=>'data[detail]['.$k.'][date]','type'=>'text') );
;?>   </td>
