...
<div class="row" >
    <div class="col-md-12" >
        ...
        <?php echo $this->Form->create('Stockdepot',array('autocomplete' => 'off','class'=>'form-horizontal ls_form')); ?>
                ...
                <div class="col-md-6">                  
                    ...
                    <div class="col-dm-6" style="display:inline; position: relative;">
                        ...
                        echo $this->Form->input('designation', array('div' => 'form-group','placeholder'=>'Code ou Designation','label'=>'Article', 'index' => '0', 'id' => 'designation0', 'champ' => 'designation', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control amineselect', 'type' => 'text')); ?>
      ...
      <a  onClick="flvFPW1(wr+'Stockdepots/imprimer?article_id=<?php echo @$articleid;?>&depot_id=<?php echo @$depotid;?>&type=<?php echo @$type;?>&familleid=<?php echo @$familleid;?>&fournisseurid=<?php echo @$fournisseurid;?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class="btn btn-primary">Imprimer</button> </a>
                    <?php // }?>
      <a class="btn btn-primary" href="<?php echo $this->webroot; ?>Stockdepots/exp_etatexcel?article_id=<?php echo @$articleid;?>&depot_id=<?php echo @$depotid;?>&type=<?php echo @$type;?>&familleid=<?php echo @$familleid;?>&fournisseurid=<?php echo @$fournisseurid;?>"  >Imprimer Excel</a>
...
<div class="row">
	...
	<tr>
		...
		<td align="center"><?php echo ('Quantite'); ?></td>
	        <td align="center"><?php echo ('Qte T'); ?></td>
                <td align="center"><?php echo ('PR HT'); ?></td>
                <td align="center"><?php echo ('Prix Tot'); ?></td>
        </tr></thead><tbody>
	...
	<tr>
		...
		<td >
			<?php echo $this->Html->link($stockdepot['Article']['code']." ".$stockdepot['Article']['name'], array('controller' => 'etathistoriquearticles', 'action' => 'index', $stockdepot['Article']['id'],@$depotid)); ?>
		</td>
		<td align="center"><?php 
                ...
                <?php
                $test=strpos($qte_theorique, ".");
                if($test==true){
                echo sprintf('%.3f',$qte_theorique);
                }else{
                echo $qte_theorique;    
                }
                ?> 
