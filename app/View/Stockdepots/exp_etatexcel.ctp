...
<table align="center" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" width="100%" >
    ...
    <tr>
            <td align="left"><?php echo $stockdepot['Article']['code']." ".$stockdepot['Article']['name']; ?></td>
            <td align="center"><?php echo $qt; ?></td>
            <td align="center"><?php echo number_format($stockdepot[0]['prix'],3,'.',' '); ?></td>
            <td align="center"><?php echo number_format($stockdepot[0]['qte']*$stockdepot[0]['prix'],3,'.',' '); ?></td>
    </tr>
    <?php } ?>
    <tr>
        <td align="center" colspan="3">Total</td>
        <td align="center"><?php echo number_format($prixtot,3,'.',' ') ; ?></td>
    </tr>
</table>
