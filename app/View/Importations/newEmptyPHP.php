...
<div class="row" >
		...
		echo $this->Form->input('tauxderechenge',array('readonly'=>'readonly','type'=>'text','id'=>'tauxderechenge','label'=>'Taux de Rechange','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculecoefficient') );
		...
		echo $this->Form->input('avis',array('readonly'=>'readonly','id'=>'avis','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculecoefficient') );
		echo $this->Form->input('transitaire',array('readonly'=>'readonly','id'=>'transitaire','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculecoefficient') );
		echo $this->Form->input('ddttva',array('readonly'=>'readonly','id'=>'ddttva','label'=>'DDT TVA','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculecoefficient') );
		echo $this->Form->input('assurence',array('readonly'=>'readonly','id'=>'assurence','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculecoefficient') );
		echo $this->Form->input('divers',array('readonly'=>'readonly','id'=>'divers','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculecoefficient') );
		echo $this->Form->input('fraisfinancie',array('readonly'=>'readonly','id'=>'fraisfinancie','label'=>'Frais Financié','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculecoefficient') );
		echo $this->Form->input('coefficien',array('readonly'=>'readonly','type'=>'text','readonly'=>'readonly','id'=>'coefficien','label'=>'Coefficient','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculecoefficient') );
	?>
  </div>  
                                    ...
                                    ?>
                                        ...
                                        <table  style="width: 100%;" border="1" align="center" id="tablet">
                                            <tr bgcolor="#F2D7D5">
                                                ...
                                                <?php foreach ($credit as $n=>$c){ $m=$n+1;?>
