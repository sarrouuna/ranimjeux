                    ...
                    <table style="width: 100%; border-radius: 3mm;-moz-border-radius: 1mm;" border="0" align="center">
                        <tr >
                            <td style="width: 100%;border: 3px solid black;height:80px; border-radius: 3mm;-moz-border-radius: 1mm;" align="center"  >
                                ...
                                <?php }?>
								<?php if($factureclient[$model]['nummarche']!=" "){ ?>
                                <strong style="font-size:3mm;">Numero Marché  :<?php echo @$factureclient[$model]['nummarche']; ?> </strong> <br> 
                                <?php }?>
                                <?php }?>
                            </td> 
                        </tr>
...
//debug($lignefactureclients);die;
        ...
        foreach ($lignefactureclients as $i => $lr) {
            ...
            <tr>
                ...
                <td style="width: 10%;<?php echo $styl_cadr_bottom; ?>" align="right"><?php echo number_format(@$lr[$ligne_model]['prix'], 2, '.', ' '); ?></td>
    ...
    <table nobr="true"  style="width: 100%;">
            ...
            <td style="width:36%;">
                <table  style="width: 100%;" class="classtable">
                   ...
                   <tr>
                    ...
                    <tr>
                        <td align="left" style="width:50%;border-radius: 0mm 0mm 0mm 3mm;-moz-border-radius: 1mm;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total TTC  </strong></td>  
        ...
        <td   style="width:60%;height:20mm;vertical-align: top;" align="center" >
            <strong>Arreter la présente <?php echo $designation; ?> à la somme de :</strong><br>
