...
<div class="row" >
		...
		echo $this->Form->input('date',array('div'=>'form-group','value'=>date("d/m/Y"),'type'=>'text','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly','required data-bv-notempty-message'=>'Champ Obligatoire') );		
            ...
            <?php if(@$this->request->data['Bordereau']['paiement_id'] ==3){ ?>
                                        ...
                                        <select class="select" id="situation" name="data[Bordereau][situation]">
                                            ...
                                            <option value="Versé" <?php if(@$this->request->data['Bordereau']['situation'] =="Versé"){ ?>selected="selected" <?php } ?>>Versé à l'encaissement</option>
                                            <option value="Versé à escompte" <?php if(@$this->request->data['Bordereau']['situation'] =="Versé à escompte"){ ?>selected="selected" <?php } ?>>Versé à l'escompte</option>
                                        </select>
                                        </div>
                                        </div>
            <?php } ?>
           ...
           <div class="row ligne lb"  <?php if(empty($cheques)){ ?>style="display: none"<?php } ?> >
                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                                ...
                                <?php if(!empty($cheques)){ foreach ($cheques as $i=>$cheque){      ?> 
                                ...
                                <tr class="cc" >
                                   <td style="width:23%">
                                    ...
                                    <td style="width:1%" align='center'> <input <?php  foreach ($this->request->data['Lignebordereau'] as $l){ if($l['piecereglementclient_id']==$cheque['Piecereglementclient']['id']){ ?>checked="checked" <?php }} ?>  type="checkbox" name="data[lignebordereau][<?php echo $i ;?>][ok]" index="<?php echo $i ;?>" class="calculmontantbordereaux" value="1" id='chekbox<?php echo $i ;?>'></td>
