...
<div class="row" >
        ...
        <?php echo $this->Form->create($model,array('autocomplete' => 'off','class'=>'form-horizontal ls_form','id'=>'defaultForm','data-bv-message'=>'This value is not valid','data-bv-feedbackicons-valid'=>'fa fa-check','data-bv-feedbackicons-invalid'=>'fa fa-bug','data-bv-feedbackicons-validating'=>'fa fa-refresh')); ?>
            ...
            <div class="col-md-6">                  
                ...
                echo $this->Form->input('datedeclaration',array('label'=>'Date declaration','div'=>'form-group','value'=>date("d/m/Y"),'type'=>'text','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control datePickerOnly') );		
                }
                ?>
            </div>
            <div class="col-md-6">
                    ...
                    <thead>
                        ...
                        foreach ($tvas as $i => $tva) {?>
                            <tr>
                                <td width="30%">
                                    <?php
                                    echo $this->Form->input('mth', array('name' => 'data[' . $tablesemi . '][' . $i . '][mth]', 'div' => 'form-group','label' => '', 'table' => $tablesemi, 'index' => $i, 'id' => 'mth' . $i, 'champ' => 'mth', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculefactureservice'));
                                    ?>
                                </td>
                                <td width="10%">
                                    <?php
                                ...
                                <td width="30%">
                                    <?php 
                                    echo $this->Form->input('mttc', array('readonly' => 'readonly','name' => 'data[' . $tablesemi . '][' . $i . '][mttc]', 'div' => 'form-group', 'label' => '', 'table' => $tablesemi, 'index' => $i, 'id' => 'mttc' . $i, 'champ' => 'mttc', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control')); 
                                    ?>
                                </td>
                            </tr>
                        <?php } ?>
