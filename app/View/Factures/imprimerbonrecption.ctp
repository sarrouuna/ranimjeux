                ...
                <tr>
                    <td width="45%">
                        <table>
                            ...
                            <tr>
                                <td style="font-size:10;" align="center"><strong>' . $soc['Societe']['adresse'] . '</strong></td>
                            </tr>
                            <tr>
                                <td align="center">' . $soc['Societe']['codepostale'] . '</td>
                            </tr>
                ...
                <tr>
                    <td width="45%">
                        <table cellpadding="2" cellspacing="0" border="1">
                            <tr>
                                <td align="center" width="100%" colspan="3" style="background-color:#b8b8b8"  ><strong> BON RECEPTION ACHAT </strong></td>
                            </tr>
                            <tr>
...
<table cellpadding="2" cellspacing="0"  >
    ...
    <tr>       
        ...
        <td align="center" '.$styl_cadr_ent.' '.$lgtva.'><strong>code</strong></td>
        <td align="center" '.$styl_cadr_ent.' '.$lgarticle.'><strong>Article</strong></td>
        <td align="center" '.$styl_cadr_ent.'  '.$lgqte.'><strong>Qte</strong></td>
        <td align="center" '.$styl_cadr_ent.'  '.$lgqte.'><strong>Prix vente TTC</strong></td>
...
$tbl .='
    ...
    <tr> 
        <td align="left" '.$styl_cadr.' '.$lgtva.'>&nbsp;'.$lr['Article']['code'].'</td>
        <td height="20px" align="left" '.$styl_cadr.' '.$lgarticle.' >&nbsp;'. $lr['Article']['name'].'</td>
        <td align="center" '.$styl_cadr.' '.$lgqte.'>&nbsp;'.$lr['Lignefacture']['quantite'].'</td>  
        <td align="right" '.$styl_cadr.' '.$lgqte.'>&nbsp;'.sprintf('%.3f',$lr['Article']['prixuttc']).'</td>  
...
';
    ...
    <tr>
        ...
        <td align="center" '.$styl_cadr_bottom.' '.$lgqte.'>&nbsp;<br></td>
        <td align="center" '.$styl_cadr_bottom.' '.$lgqte.' height="'.$hauteur.'px">&nbsp;<br></td>  
    </tr> 
...
ob_end_clean();
$pdf->Output('bon_reception_achat.pdf', 'I');
