                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default" >
                                ...
                                <tbody>
                                     ...
                                     <?php //debug($lignereceptions);die;
                                            foreach ($lignereceptions as $i=>$lr){$k=1000*$i;
                                        $datefabrication=date("d/m/Y",strtotime(str_replace('-','/',$lr['Lignefacture']['datefabrication'])));
                                        $datevalidite=date("d/m/Y",strtotime(str_replace('-','/',$lr['Lignefacture']['datevalidite'])));
                                        ?> 
                                <tr>
                                    <td style="width:15%">
                                       <?php echo $this->Form->input('id',array('value'=>$lr['Lignefacture']['id'],'name'=>'data[Lignereception]['.$i.'][id]','id'=>'id'.$i,'champ'=>'id','table'=>'Lignereception','index'=>$i,'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'Nom') );?>
                                ...
                                <tr>
                                    ...
                                    <td align="center" nowrap="nowrap"> Quantite </td>
                                    <td align="center">
                    <a class="btn btn-danger  ajouterligne_reception" table='addtable<?php echo $i; ?>' index='index'  tr="tr"><i class="fa fa-plus-circle"  ></i>  </a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                       <?php echo $this->Form->input('sup',array('name'=>'data[Lignereception]['.$i.'][Detail][0][sup]','id'=>'sup0','champ'=>'sup','table'=>'Lignereception','index'=>'0','div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control ','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'Nom') );?>
                                       <?php echo $this->Form->input('depot_id',array('div'=>'form-group','label'=>'', 'name' => 'data[Lignereception]['.$i.'][Detail][0][depot_id]','table'=>'Lignereception','index'=>$k,'id'=>'depot_id'.$k,'champ'=>'depot_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control','empty'=>'Veuillez Choisir !!') );?>
                                    </td>
                                     <td style="width:40%">
                                        <?php  echo $this->Form->input('qte',array('label'=>'','div'=>'form-group', 'name' => 'data[Lignereception]['.$i.'][Detail][0][qte]','ligne'=>$i,'table'=>'Lignereception','index'=>$k,'id'=>'qte'.$k,'champ'=>'qte','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control testqtebe ','required data-bv-notempty-message'=>'Champ Obligatoire') );?>
                                     </td>
...
<div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                <button type="submit" class="btn btn-primary testallqte">Enregistrer</button>
                                            </div>
                                        </div>
