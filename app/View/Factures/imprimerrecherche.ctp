...
<br><br><br>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr bgcolor="#FFFFFF" align="center">
                        ...
                        <th width="14%" align="center" $zz ><strong>Numero</strong></th>
                        <th width="17%" align="center" $zz ><strong>Importaion</strong></th>
                        <th width="12%" align="center" $zz ><strong>Tot Devise</strong></th>
                        <th width="14%" align="center" $zz ><strong>HT</strong></th> 
                        <th width="14%" align="center" $zz ><strong>TTC</strong></th>
   </tr>';
        $i=0;$total=0;$dev="test";
      
       foreach ($factures as $br){
          // debug($br['Importation']['devise_id']);die; 
//$importation=ClassRegistry::init('Importation')->find('first',array('conditions'=>array('Importation.id'=>$br['Facture']['importation_id']),'recursive'=>-1));   
//debug("$importation");die;
//if(!empty($importation)){
//debug($br['Importation']['devise_id']);           
...
//debug($dev);die;            
    ...
    '<tr bgcolor="#FFFFFF" align="center">    
        ...
        <td width="10%" nobr="nobr" align="center"  $zz>'.date("d/m/Y",strtotime(str_replace('-','/',$br['Facture']['date']))).'</td>
        <td width="14%" nobr="nobr" align="center"  $zz>'.$br['Facture']['numero'].'</td>
        <td width="17%" nobr="nobr" align="right"  $zz>'.$br['Importation']['name'].'</td>
        <td width="12%" nobr="nobr" align="right"  $zz>'.$br['Facture']['totaldevise'].' '.$dev.'</td>
        <td width="14%" nobr="nobr" align="right"  $zz>'.$br['Facture']['totalht'].'</td>
        <td width="14%" nobr="nobr" align="right"  $zz>'.$br['Facture']['totalttc'].'</td>
    </tr>' ;     
}
