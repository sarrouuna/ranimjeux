...
<table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" nobr="true">       
    <tr align="center">
        ...
        <td bgcolor="#CCCCCC" width="18%" align="center"  ><strong>Nom_Prenom</strong></td>
        <td bgcolor="#CCCCCC" width="11%" align="center"  ><strong>Piece Frs</strong></td>
        ...
        <td bgcolor="#CCCCCC" width="8%" align="center"  ><strong>Net a payer</strong></td>
    </tr>
...
//    die;
            ...
            <tr bgcolor="#FFFFFF" align="center">    
                <td width="8%" align="center" heigth="30px"  ><?php echo $br['numero']; ?></td>
                <td width="5%" align="center"  ><?php echo date("d/m/y", strtotime(str_replace('-', '/', $br['date']))); ?></td>
                <td width="5%" align="center"  ><?php echo $br['code']; ?></td>                        
                <td width="18%" align="left"   ><?php echo $br['Fournisseur']; ?></td>
                <td width="11%" align="left"   ><?php echo $br['numerofrs']; ?></td>
                ...
                <td width="8%" align="right"  ><?php echo $br['totalttc']; ?></td>
            </tr>
...
//header("Content-Type: application/download");
    header("Content-Disposition: attachment; filename=Listefacturedepense.xls");
    ?>