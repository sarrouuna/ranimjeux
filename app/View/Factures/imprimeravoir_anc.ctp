...
$pdf->SetAuthor('Sotem');
$pdf->SetTitle('Factures avoir fournisseur');
...
<tr>
    ...
    <td  width="55%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><h1>Liste des factures Avoir Fournisseur' . $m . '</h1></td> 
            </tr> 
        </table>
    </td>
</tr>
...
<br><br><br>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr  bgcolor="#CCCCCC" align="center">
                        <td width="10%" align="center" $zz ><strong>N° FACT</strong></td> 
...
foreach ($tablignefactures as $br) {
    ...
    foreach ($tvas as $t) { //debug($t);die;
        $tv=$t['Tva']['name'];
                ...
                $lignefactavoirzero = $objfactavoir->find('all', array('fields' => array('SUM(Lignefactureavoirfr.totalht) as mtva', 'Lignefactureavoirfr.tva'), 'conditions' => (array('Lignefactureavoirfr.factureavoirfr_id' => $br['id_piece'], 'Lignefactureavoirfr.tva' => 0)), 'recursive' => -1));
            
            
            if ($lignefactavoirzero[0][0]['mtva'] != NULL) {
                $f = $lignefactavoirzero[0][0]['mtva'];
            }
            $lignefactavoir = $objfactavoir->find('all', array('fields' => array('SUM(Lignefactureavoirfr.totalht) as mtva'), 'conditions' => (array('Lignefactureavoirfr.tva' => $tv,'Lignefactureavoirfr.factureavoirfr_id' => $br['id_piece'])), 'recursive' => -1));
...
$tbl .= '
   <tr  bgcolor="#CCCCCC" align="center">    
        ...
        <td colspan="4" nobr="nobr" align="right"  $zz>Total</td>
        ';
...
ob_end_clean();
$pdf->Output('EtatFactureAvoirfrs.pdf', 'I');
