    ...
    <tr>
        ...
        <td  style=" width: 70%;">
            <table style=" width: 100%;font-size: 1.5mm;">
                <tr>
                <br>
                <td height="35px" align="right" ><h3>Liste des factures avoir fournisseur <?php echo $m; ?></h3></td>
    </tr>
</table>
</td>
</tr>
...
<table align="center" cellpadding="0" cellspacing="0"  style=" width: 100%; font-size: 3.5mm;" border="1">
    <tr align="center">
        <td bgcolor="#CCCCCC" style=" width: 10%;  " align="center"  ><strong>N° FACT</strong></td>
        ...
        <td bgcolor="#CCCCCC" style=" width: 12%;  " align="center"  ><strong>Nom_Prenom</strong></td>
...
-->            <td bgcolor="#CCCCCC" style=" width: <?php echo $w; ?>%;" align="center"  ><strong>Brut</strong></td>
    ...
    $tottva12 = 0;
    $tottva18 = 0;
    $objfactavoir = ClassRegistry::init('Lignefactureavoirfr');
    $ccp = 0;
    $listvaall = array();
    $totfactzero = 0;
    $nbpage = 0;
    ...
    if ($tablignefactures != array()) {
        foreach ($tablignefactures as $br) {
            ...
            foreach ($tvas as $t) { //debug($t);die;
                ...
                $lignefactavoirzero = $objfactavoir->find('all', array('fields' => array('SUM(Lignefactureavoirfr.totalht*(1+(COALESCE(Lignefactureavoirfr.fodec,0)/100))) as mtva', 'Lignefactureavoirfr.tva'), 'conditions' => (array('Lignefactureavoirfr.factureavoirfr_id' => $br['id_piece'], 'Lignefactureavoirfr.tva' => 0)), 'recursive' => -1));


                if ($lignefactavoirzero[0][0]['mtva'] != NULL) {
                    $f = $lignefactavoirzero[0][0]['mtva'];
                }
                $lignefactavoir = $objfactavoir->find('all', array('fields' => array('SUM(Lignefactureavoirfr.totalht*(1+(COALESCE(Lignefactureavoirfr.fodec,0)/100))) as mtva'), 'conditions' => (array('Lignefactureavoirfr.tva' => $tv, 'Lignefactureavoirfr.factureavoirfr_id' => $br['id_piece'])), 'recursive' => -1));
...
//    die;
            ...
            <tr bgcolor="#FFFFFF" align="center">
                <td  align="center" heigth="30px"  ><?php echo $br['numero']; ?></td>
