...
<table width="100%">
                ...
                <tr>
                    <td width="45%">
                        <table>
                            <tr>
                                <td style="font-size:20;" align="center"><strong>' . $soc['Societe']['nom'] . '</strong></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td width="45%">
                        <table cellpadding="2" cellspacing="0" border="1">
                            <tr>
                                <td align="center" width="100%" colspan="3" style="background-color:#b8b8b8"  ><strong> FACTURE </strong></td>
                            </tr>
                           <tr>
                             ...
                             <tr>
                                <td height="20px" align="center" width="34%"  >' . $factureclient['Facture']['numero'] . '</td>
								<td height="20px" align="center" width="33%"  >' . $factureclient['Facture']['numerofrs'] . '</td>
                                <td align="center" width="33%"  > ' . date("d/m/Y", strtotime(str_replace('-', '/', $factureclient['Facture']['date']))) . '  </td>
                            </tr>
                        </table>
                    </td>
...
<table cellpadding="2" cellspacing="0"  >
    ...
    <tr>       
        ...
        <td align="center" ' . $styl_cadr_ent . ' ' . $lgcode . '><strong>Code</strong></td>
...
foreach ($lignefactureclients as $i => $lr) {
    ...
    if ($lr['Lignefacture']['remise'] != 0) {
        $remise = sprintf('%.0f', $lr['Lignefacture']['remise']);
    } else {
        $remise = "";
    }

    if ($lr['Lignefacture']['fodec'] != 0) {
        $fodec = sprintf('%.0f', $lr['Lignefacture']['fodec']);
    } else {
        $fodec = "";
    }
    ...
    if ($lr['Lignefacture']['bonreception_id'] != $bl) {


        $tbl .= '<tr> 
                        <td height="20px" align="center" ' . $styl_cadr . ' ' . $lgcode . ' ></td>
                        <td height="20px" align="center" ' . $styl_cadr . ' ' . $lgarticle . ' ><strong>BL ' . $lr['Bonreception']['numeroconca'] . '</strong></td>
                        <td align="center" ' . $styl_cadr . ' ' . $lgremise . '></td> ';
        if ($factureclient['Fournisseur']['devise_id'] == 1) {
            $tbl .= '  <td height="20px" ' . $styl_cadr . ' align="center"  ' . $lgfodec . '></td> ';
        }
        $tbl .= '  <td align="right" ' . $styl_cadr . ' ' . $lgqte . '></td>  
                        <td align="right" ' . $styl_cadr . ' ' . $lgprixht . '></td>  
                        <td align="right" ' . $styl_cadr . ' ' . $lgtotht . '></td> 
                        <td align="center" ' . $styl_cadr . ' ' . $lgtva . '></td>  
                    </tr>';
    }
    $bl = $lr['Lignefacture']['bonreception_id'];



    $n = $n + 30;
    $decimal = $lr['Lignefacture']['tva'] - floor($lr['Lignefacture']['tva']);
    if ($decimal == 0) {
        $tvaa = floor($lr['Lignefacture']['tva']);
    } else {
        $tvaa = $lr['Lignefacture']['tva'];
    }

    $tbl .= '
    
    <tr> 
         <td height="20px" align="left" ' . $styl_cadr . ' ' . $lgcode . ' >' . $lr['Article']['code'] . '</td>
        <td height="20px" align="left" ' . $styl_cadr . ' ' . $lgarticle . ' >' . $lr['Lignefacture']['bonreception_id'] . '&nbsp;' . $lr['Article']['name'] . ' ' . $lr['Article']['code'] . '</td>
        <td align="center" ' . $styl_cadr . ' ' . $lgremise . '>&nbsp;' . $remise . '</td> ';
    if ($factureclient['Fournisseur']['devise_id'] == 1) {
        $tbl .= '  <td height="20px" ' . $styl_cadr . ' align="center"  ' . $lgfodec . '>&nbsp;' . $fodec . '</td> ';
    }
    $tbl .= '  <td align="right" ' . $styl_cadr . ' ' . $lgqte . '>&nbsp;' . $lr['Lignefacture']['quantite'] . '</td>  
        <td align="right" ' . $styl_cadr . ' ' . $lgprixht . '>&nbsp;' . number_format($lr['Lignefacture']['totalht'] / $lr['Lignefacture']['quantite'], 3, '.', ' ') . '</td>  
        <td align="right" ' . $styl_cadr . ' ' . $lgtotht . '>&nbsp;' . number_format($lr['Lignefacture']['totalht'], 3, '.', ' ') . '</td> 
...
foreach ($ligneavrs as $i => $lr) {  //debug($lr);die;
    if ($lr['Lignefacture']['remise'] != 0) {
        $remise = sprintf('%.0f', $lr['Lignefacture']['remise']);
    } else {
        $remise = "";
    ...
    if ($lr['Lignefacture']['factureavoirfr_id'] != $blavr) {
        //debug($lr);die;

        $tbl .= '<tr> 
        
                        <td height="20px" align="center" ' . $styl_cadr . ' ' . $lgarticle . ' ><strong>BL Avoir ' . $lr['Factureavoirfr']['numero'] . '</strong></td>
                        <td align="center" ' . $styl_cadr . ' ' . $lgremise . '></td> ';
        if ($factureclient['Fournisseur']['devise_id'] == 1) {
            $tbl .= '  <td height="20px" ' . $styl_cadr . ' align="center"  ' . $lgfodec . '></td> ';
        }
    ...
    $blavr = $lr['Lignefacture']['factureavoirfr_id'];
    ...
    $tbl .= '  <td align="right" ' . $styl_cadr . ' ' . $lgqte . '>&nbsp;' . $lr['Lignefacture']['quantite'] . '</td>  
        <td align="right" ' . $styl_cadr . ' ' . $lgprixht . '>&nbsp;' . number_format(($lr['Lignefacture']['totalht'] / $lr['Lignefacture']['quantite']) * -1, 3, '.', ' ') . '</td>  
        <td align="right" ' . $styl_cadr . ' ' . $lgtotht . '>&nbsp;' . number_format($lr['Lignefacture']['totalht'], 3, '.', ' ') . '</td> 
        <td align="center" ' . $styl_cadr . ' ' . $lgtva . '>&nbsp;' . $tvaa . '</td>  
    </tr>
...
$tbl .= '
    <tr>
    <td align="center" ' . $styl_cadr_bottom . ' ' . $lgcode . '>&nbsp;<br></td>  
...
foreach ($lignefactureclientstva as $i => $lr) {
    ...
    $mnt = 0;
    $mnt_ttc = 0;
    $mnt = ($lr['Lignefacture']['totalht'] * $lr['Lignefacture']['tva']) / 100;
    $mnt_ttc = $lr['Lignefacture']['totalht'] + $mnt;
...
if ($factureclient['Fournisseur']['devise_id'] == 1) {
    $tbl .= '<tr>
                        ...
                        <td align="right"  width="50%">' . number_format($factureclient['Facture']['fodec'], 3, '.', ' ') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>';
}
$tbl .= '<tr>
                        <td align="left" style="background-color:#b8b8b8;" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total remise  </strong></td>  
                        <td align="right"  width="50%">' . number_format($factureclient['Facture']['remise'], 3, '.', ' ') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="left" style="background-color:#b8b8b8;" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total TVA  </strong></td>  
                        <td align="right"  width="50%">' . number_format($factureclient['Facture']['tva'], 3, '.', ' ') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>  
                     </tr>';
if ($factureclient['Fournisseur']['devise_id'] == 1) {
    $tbl .= '<tr>
...
$tbl .= '<tr>
                        ...
                        <td align="right"  width="50%">' . number_format($factureclient['Facture']['totalht'], 3, '.', ' ') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                    </tr>    
                    <tr>
                        <td align="left" style="background-color:#b8b8b8;" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total TTC  </strong></td>  
                        <td align="right"  width="50%">' . number_format($factureclient['Facture']['totalttc'], 3, '.', ' ') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>  
                    </tr>   
...
<table cellpadding="2" cellspacing="0" border="1">
    <tr>
        ...
        <br>   <br>
            ...
            <br>
            ' . chifre_en_lettre($factureclient['Facture']['totalttc'], 1, 1) . '
        </td>
