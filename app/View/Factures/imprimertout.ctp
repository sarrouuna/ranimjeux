...
<br><br><br>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr  bgcolor="#CCCCCC" align="center">
                        ...
                        <th width="20%" align="center" $zz height="30px" ><strong>Nom_Prenom</strong></th>
...
$tbl.='<th width="10%" align="center" $zz ><strong>Timbre</strong></th>
...
<th width="10%" align="center" $zz >' . $br['numero'] . '</th>    
        
                        <th width="10%" align="center" $zz >' . date("Y-m-d", strtotime(str_replace('/', '-', $br['date']))) . '</th>
                         <th width="20%" align="left" $zz height="30px" >' . $br['client'] . '</th>
<th width="10%" align="center" heigth="30px" $zz >' . $br['code'] . '</th>
                        ';
                        //debug($listva);die;
    ...
    $tbl.='
                        <th width="10%" align="center" $zz >' . $br['timbre'] . '</th>
                        <th width="10%" align="center" $zz >' . $br['totalttc'] . '</th>'
            . '</tr>';
}
}else {
    foreach ($tvas as $t){
...
$tbl .= '
   <tr  bgcolor="#CCCCCC" align="center">    
        ...
        <td width="50%" colspan="4" nobr="nobr" align="right"  $zz>Total</td>
        ';
foreach ($tf as $y){//debug($y);die;
   ...
   $tbl .='<th width="10%" align="center" $zz >' . sprintf("%.3f", $tottimbre) . '</th>
        <th width="10%" align="center" $zz >' . sprintf("%.3f", $totnetapayer) . '</th>
        </tr>
</table>';
