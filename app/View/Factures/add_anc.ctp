...
<div class="row" >
        ...
        <?php echo $this->Form->create('Facture',array('autocomplete' => 'off','class'=>'form-horizontal ls_form','id'=>'','data-bv-message'=>'This value is not valid','data-bv-feedbackicons-valid'=>'fa fa-check','data-bv-feedbackicons-invalid'=>'fa fa-bug','data-bv-feedbackicons-validating'=>'fa fa-refresh')); ?>
		 ...
		 echo $this->Form->input('fournisseur_id',array('div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','id'=>'fc','class'=>'form-control select  artfournisseur','empty'=>'Veuillez Choisir !!') );
	        ...
	        echo $this->Form->input('numero',array('label'=>'Numéro Facture','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','id'=>'numero','class'=>'form-control ','required data-bv-notempty-message'=>'Champ Obligatoire') );
                ?>
		...
		?> 
                ...
                echo $this->Form->input('numeroconca',array('label'=>'Numéro Interne','readonly'=>'readonly','value'=>$mm,'div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control ','required data-bv-notempty-message'=>'Champ Obligatoire') );
...
<!--                                <tr class="cc" >
                                    ...
                                    <td  champ="tdarticle" id="tdarticle0" >
                                        ...
                                        <?php echo $this->Form->input('margeA',array('name'=>'data[Lignereception][0][margeA]','id'=>'margeA0','champ'=>'margeA','table'=>'Lignereception','index'=>'0','div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'Nom') );?>
                                        <?php echo $this->Form->input('pvA',array('name'=>'data[Lignereception][0][pvA]','id'=>'pvA0','champ'=>'pvA','table'=>'Lignereception','index'=>'0','div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'Nom') );?>
                                    </td>
                                    <td >
...
<div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                <button type="submit" class="btn btn-primary testlignesubmit  testnumero TestLigneTTFacture testdateexpiration">Enregistrer</button>
                                            </div>
                                        </div>
