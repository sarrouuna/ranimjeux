                            ...
                            <div class="panel panel-default" >
                                ...
                                <tbody>
                                     ...
                                     <?php
                                        ...
                                        if ($lr['Lignefacture']['datefabrication']){ $datefabrication=date("d/m/Y",strtotime(str_replace('-','/',$lr['Lignefacture']['datefabrication'])));}
                                        if ($lr['Lignefacture']['datevalidite']){ $datevalidite=date("d/m/Y",strtotime(str_replace('-','/',$lr['Lignefacture']['datevalidite'])));}
