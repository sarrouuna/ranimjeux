...
<table align="center" cellpadding="0" cellspacing="0"  style=" width: 100%; font-size: 3mm;" border="1">
    <tr align="center">
        ...
        <td bgcolor="#CCCCCC" style=" width: 10%;"  align="center"  ><strong>Nom_Prenom</strong></td>
        ...
        <?php } ?>
		<td bgcolor="#CCCCCC" style=" width: 5%;"  align="center"  ><strong>Net</strong></td>
		<td bgcolor="#CCCCCC" style=" width: 5%;"  align="center"  ><strong>Brute</strong></td>
		<td bgcolor="#CCCCCC" style=" width: 5%;"  align="center"  ><strong>Net HT</strong></td>
...
//    die;
    ...
    <tr align="center">
        ...
        <td bgcolor="#CCCCCC" width="5%" align="right"  ><?php  ?></td>
        <td bgcolor="#CCCCCC" width="5%" align="right"  ><?php  ?></td>
        <td bgcolor="#CCCCCC" width="5%" align="right"  ><?php  ?></td>
