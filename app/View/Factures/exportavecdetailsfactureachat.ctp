...
//debug($lignereg);die;
        ...
        if ($reg == 0 || $reg == 'Tous' || ($reg == 'Regle' && $totreg != 0) || ($reg == 'Nonregle' && $totreg == 0)) {
            ...
            <tr bgcolor="#FFFFFF" align="center">
                <td width="<?php echo $w; ?>%" align="center"  ><?php echo $br['Facture']['numero']; ?></td>
                <td width="<?php echo $w; ?>%" align="center"  ><?php echo date("d/m/Y", strtotime(str_replace('-', '/', $br['Facture']['date']))); ?></td>
                <td width="<?php echo $w; ?>%" align="center"  ><?php echo $clt['Fournisseur']['code']; ?></td>                      
                <td width="20%" align="left"  ><?php echo $clt['Fournisseur']['name']; ?></td>
                <td width="<?php echo $w; ?>%" align="center"   ><?php echo $br['Facture']['numerofrs']; ?></td>
                <td width="<?php echo $w; ?>%" align="right"  ><?php echo $datedec; ?></td>
                <td width="<?php echo $w; ?>%" align="right"  ><?php echo sprintf("%.3f", $br['Facture']['totalht']); ?></td>
                <td width="<?php echo $w; ?>%" align="right"  ><?php echo sprintf("%.3f", $br['Facture']['tva']); ?></td>
                <td width="<?php echo $w; ?>%" align="right"  ><?php echo sprintf("%.3f", $br['Facture']['totalttc']); ?></td>
...
header("Content-Disposition: attachment; filename=Listefacturesachat.xls");
?>