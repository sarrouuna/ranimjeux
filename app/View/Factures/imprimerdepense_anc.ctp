...
<tr>
    ...
    <td  width="55%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><h1>Liste des factures Depense' . $m . '</h1></td> 
            </tr> 
        </table>
    </td>
</tr>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" nobr="true">       
   <tr  bgcolor="#CCCCCC" align="center">
                       ...
                       <td width="5%" align="center" $zz ><strong>Code Frs</strong></td>                      
                        <td width="18%" align="center" $zz ><strong>Nom_Prenom</strong></td>
                        <td width="11%" align="center" $zz ><strong>Piece Frs</strong></td>
...
foreach ($tvas as $t) { //debug($t);die;
        ...
        $tbl.='<td width="8%" align="center" $zz ><strong>Net a payer</strong></td>
             ';
...
//    $tottva18 = $tottva18 + $tva18;
    $tbl .=
        ...
        <td width="8%" align="center" heigth="30px" $zz >' .$br['numero'] . '</td>
                        ...
                        <td width="18%" align="left" $zz  >' . $br['Fournisseur'] . '</td>
                        <td width="11%" align="left" $zz  >' . $br['numerofrs'] . '</td>
                        ';
    ...
    $tbl.='
                        <td width="8%" align="right" $zz >' . $br['totalttc'] . '</td>
                        '
            . '</tr>';
...
foreach ($tf as $y){//debug($y);die;
    ...
    $tbl .='<td width="8%" align="right" $zz >' . sprintf("%.3f", $totnetapayer) . '</td>
