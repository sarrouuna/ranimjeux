...
if ($add == 1) {
    ...
    <!--            <a class="btn btn btn-danger" href="<?php echo $this->webroot; ?>Factures/add"/> <i class="fa fa-plus-circle"></i> Ajouter </a>-->
            <a class="btn btn btn-danger" href="<?php echo $this->webroot; ?>Factures/add/Facture/Lignefacture/facture_id/achat"/> <i class="fa fa-plus-circle"></i> Ajouter </a>
            <a class="btn btn btn-danger" href="<?php echo $this->webroot; ?>Factures/addfactureservice/Facture/Lignefacture/facture_id"/> <i class="fa fa-plus-circle"></i> Ajouter facture service </a>
        </div>
    </div>
<?php } ?>
<br>
                    ...
                    <table class="table table-bordered table-striped table-bottomless" id="ls-editable-table">
                        <thead>
                            ...
                            foreach ($factures as $facture):
                                ...
                                <tr>
                                    <td style="display:none"><?php echo h($facture['Facture']['date']); ?></td>
                                    <td ><?php echo $facture['Facture']['numero']; ?></td>
                                    <td ><?php echo $facture['Facture']['numerofrs']; ?></td>
                                    <td >
                                    ...
                                    <td ><?php echo h(date("Y/m/d", strtotime(str_replace('-', '/', $facture['Facture']['date'])))); ?></td>
                                    <td ><?php echo h($facture['Facture']['totalttc']); ?></td>
                                    <td align="center">
                                        <?php if ((@$addfa == 1) && ($facture['Facture']['type'] != 'service')) { ?> 
                                    ...
                                    <td align="center">
                                        ...
                                        if ($facture['Facture']['type'] == 'service')
                                            ...
                                            echo $this->Html->link("<button class='btn btn-xs btn-success'><i class='fa fa-search'></i></button>", array('action' => 'view', $facture['Facture']['id'], 'Facture', 'Lignefacture', 'facture_id'), array('escape' => false));
                                        ?>
