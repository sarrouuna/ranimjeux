...
$pontdevente = $ModelSociete->find('first', array('conditions' => array('Pointdevente.id' => $factureclient['Facture']['pointdevente_id'])));
...
foreach ($lignefactureclients as $i => $lr) {
    ...
    <tr> 
        ...
        <td height="20px" align="left" ' . $styl_cadr . ' ' . $lgarticle . ' >&nbsp;' . $lr['Article']['name'] . '</td>
...
foreach ($lignefactureclientstva as $i => $lr) {
    ...
    $tbl .= '
                             <tr>
                                ...
                                <td align="center" >&nbsp;' . $this->requestAction('App/arrd/' . $lr[0]['mtva'] . '/3') . '</td>
                             </tr>';
}
...
$tbl .= '<tr>
                        ...
                        <td align="right"  width="50%">' . number_format($factureclient['Facture']['totalht'] + $factureclient['Facture']['remise'], 3, '.', ' ') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                    </tr>';
$tbl .= '<tr>
...
$tbl .= ' <tr>
                    ...
                    <tr>
                        ...
                        <td align="right"  width="50%">' . number_format($factureclient['Facture']['timbre_id'], 3, '.', ' ') . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                    </tr>';
