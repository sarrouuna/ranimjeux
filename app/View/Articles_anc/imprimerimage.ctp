...
$pdf->SetTitle('factureavoir');

// set default header data
//debug($boncommande['Client']['Raison_Social']);die;

$logo=  CakeSession::read('logo');
$pdf->SetHeaderData($logo, 60,'              Homologation de l\'article '.$article['Article']['name']);
    ...
    <table cellpadding="2" cellspacing="0" width="100%" >
        <tr>
            <td height="35px" align="center"  width="100%">
             <IMG SRC="../webroot/files/upload/'.$article['Article']['homologation'].'" >     
            </td> 
        </tr>   
    </table>
        ';
