...
<div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Modification Article'); ?></h3>
                                </div>
	    ...
	    ?>
            ...
            <select  type="text" id="input-sortable"  class="input-sortable demo-default form-control" multiple="multiple" name="data[Article][tag][]" >
                ...
                <option value="<?php echo $t; ?>" <?php foreach ($this->request->data['Articletag'] as $art_tag){ if($art_tag['tag_id']==$t){ ?> selected="selected" <?php  }  }?>    ><?php echo $tag; ?></option>
                <?php } ?>
            </select>
                </div>
            </div>    
		...
		echo $this->Form->input('stockoptimal',array('label'=>'Stock Optimal','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
                ...
                echo $this->Form->input('coefficient',array('label'=>'Coefficient','type'=>'text','id'=>'coefficient','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control getcoutderevient') );
                echo $this->Form->input('coutrevient',array('label'=>'Cout de revient','type'=>'text','id'=>'coutrevient','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculmarge') );
                echo $this->Form->input('marge',array('label'=>'Marge %','type'=>'text','id'=>'margepourcentage','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculmarge') );
                echo $this->Form->input('prixvente',array('label'=>'Prix De Vente','type'=>'text','id'=>'prixvente','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculmargev') );
       		echo $this->Form->input('margegros',array('label'=>'Marge % en Gros','type'=>'text','id'=>'margepourcentagegros','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control calculmargegros') );
                ...
                echo $this->Form->input('tva',array('label'=>'TVA','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
