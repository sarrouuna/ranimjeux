...
?>
<page backtop="60mm" backbottom="1mm" footer="page">
    <page_header style="margin-top: 0mm " >
        ...
        <table style="width: 100%;" border="0">
            <tr >
                <td style="width: 40%;">
                    <table style="width: 100%; border-radius: 3mm;-moz-border-radius: 1mm;" border="0" align="center">
                        <tr >
                            <td style="width: 100%;border: 3px solid black;height:80px; border-radius: 3mm;-moz-border-radius: 1mm;" align="center"  >
                                <strong style="font-size:4mm;"><?php echo $designation; ?> N°:<?php echo @$factureclient[$model]['numero']; ?></strong><br><br> 
                                <strong style="font-size:3mm;">LE  :<?php echo date("d/m/Y", strtotime(str_replace('-', '/', @$factureclient[$model]['date']))); ?> </strong> <br> 
                    ...
                    <table style="width: 100%;" border="0" align="center">
                        <tr>
                            <td style="font-size:3mm;width: 100%;border: 3px solid black;height:80px; border-radius: 3mm;-moz-border-radius: 1mm;" align="left">
                                ...
                                Ville&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-size:3mm;"><?php echo @$zone['Zone']['name']; ?></strong><br> 
                                Mat.Fisc&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-size:3mm;"><?php echo @$factureclient['Client']['matriculefiscale']; ?> </strong><br>    
                            </td>     
                        </tr>
                    </table>
                </td>
...
//debug($lignefactureclients);die;
        ...
        foreach ($lignefactureclients as $i => $lr) {
            ...
            ?>
            <tr>
                <td style="width: 14%;height: 4mm;<?php echo $styl_cadr_bottom; ?>" align="left"><?php echo substr(@$lr['Article']['code'], 0, 14) ?></td>
                <td style="width: 36%;<?php echo $styl_cadr_bottom; ?>" align="left"><?php echo substr(@$lr[$ligne_model]['designation'], 0, 35) ?></td>
                <td style="width: 7%;<?php echo $styl_cadr_bottom; ?>" align="center"><?php echo @$lr[$ligne_model]['quantite'].'/'.$long ?></td>
    ...
    <table nobr="true"  style="width: 100%;">
        <tr>
            <td style="width:40%;vertical-align: top;">
                <table   style="width:100%;" class="classtable">
                    ...
                    <?php  
                    if (empty($factureclient[$model]['fodec'])){
                        $factureclient[$model]['fodec']=0;
                    }
                    $obj = ClassRegistry::init($ligne_model);
                    $lignefactureclientstva = $obj->find('all', array('fields' => array(
                            'SUM(((' . $ligne_model . '.totalht*(1+('.$factureclient[$model]['fodec'].'/100)))*' . $ligne_model . '.tva)/100)  mtva'
                            , 'SUM(' . $ligne_model . '.totalht*(1+('.$factureclient[$model]['fodec'].'/100))) totalht'
            ...
            <td style="width:36%;">
                <table  style="width: 100%;" class="classtable">
                    ...
                    <tr>
                        <td align="left" style="width:50%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Total FODEC  </strong></td>  
                        <td align="right"  style="width:50%;"><?php echo number_format($factureclient[$model]['ttfodec'], 3, '.', ' ');?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                    </tr>
                    <tr>
        ...
        <td   style="width:60%;height:20mm;vertical-align: top;" align="center" >
            ...
            <?php echo chifre_en_lettre($factureclient[$model]['totalttc'],1,1);?><br>
...
<!--        <tr>
            ...
            <strong>SARL au Capital de : </strong><?php echo $soc['Societe']['capital'] ;?><strong> Adresse :</strong><?php echo $soc['Societe']['adresse'];?><strong> Code T.V.A:</strong><?php echo $soc['Societe']['codetva'] ;?><strong> RIB:</strong><?php echo $soc['Societe']['rib']; ?>
            <strong> Site:</strong><?php echo $soc['Societe']['site'];?><strong> E-mail:</strong><?php echo $soc['Societe']['mail'];?><strong> Tel :</strong><?php echo $soc['Societe']['tel'] ;?><strong> Fax : </strong><?php echo $soc['Societe']['fax'];?> 
            </td>
        </tr>-->
    </table>
</page>
