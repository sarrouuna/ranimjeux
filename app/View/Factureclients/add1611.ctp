                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 text-center pull-right">
                        ...
                        <div style="display:none;" id="typedipliquationdiv" class="pull-right" style="float: right;">
                            <?php
                            echo $this->Form->input('typedipliquation', array('id' => 'typedipliquation', 'label' => '', 'div' => '', 'between' => '<div class="col-sm-10 ">', 'after' => '</div>', 'class' => '', 'empty' => 'Veuillez Choisir !!'));
                            ?>
                        </div>
                    </div>
                </div>
...
//                                    debug($model);die;
                    ...
                    echo $this->Form->input('numero', array('id' => 'numero', 'value' => $numspecial, 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control inputspcial'));
                    ?>
                </div>
                <div class="col-md-4">
                    <?php
...
//                    echo $this->Form->input('typedipliquation', array('label' => 'Changer', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control select', 'empty' => 'Veuillez Choisir !!'));
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" name="data[<?php echo $model; ?>][vent]" id="optionsRadios11" value="detail" checked>Detail
                ...
                <div class="col-md-3">
                    ...
                    <?php if ($model != 'Factureclient') { ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="radio" name="data[<?php echo $model; ?>][auto]" id="optionRadios11" value="automatique" checked>Automatique
                                <input type="radio" name="data[<?php echo $model; ?>][auto]" id="optionRadios12" value="non">Non
                            </div>
                        </div>
                    <?php } ?>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="col-lg-9 col-lg-offset-3">
                            <button type="submit" class="btn btn-primary testautorisation testlignedevente  testpv btnEnregistrerPiece">Enregistrer</button>
                        </div>
                    </div>    
                </div>
