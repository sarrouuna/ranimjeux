                            ...
                            <div class="panel panel-default" >
                               ...
                               <table class="" id="" style="width:90%" align="center">
                                ...
                                <tbody>
                                  ...
                                  <?php  foreach ($lignefactureclients as $i=>$l){  //debug($tabqtestock);die; ?> 
                                ...
                                <tr class="cc" >
                                    ...
                                    <td style="width:25%"  champ="tdarticle" id="tdarticle0" >
                                     ...
                                     <td style="width:15%">
                                        <?php echo $this->Form->input('id',array('value'=>$l['Lignefactureclient']['id'],'name'=>'data[Lignesorti]['.$i.'][id]','id'=>'id'.$i,'champ'=>'id','table'=>'Lignesorti','index'=>$i,'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'Nom') );?>
