...
<page backtop="78mm" backbottom="110mm">
    ...
    <table cellspacing="0" <?php echo $lborder ?>  style=" width: 100%; margin-left: 3mm; font-size: 3.5mm;margin-top: 3mm;">
...
//        }
            ...
            <tr>
                ...
                <td style="width: 41%;"><?php echo substr(@$lr[$ligne_model]['designation'],0,35) ?></td>
                ...
                <td style="width: 6%;" align="center"><?php echo number_format(@$lr[$ligne_model]['remise'],2, '.', ' ') ?></td>
                <td style="width: 11%;" align="right"><?php echo number_format(@$lr[$ligne_model]['totalht'],3, '.', ' ') ?></td>
            </tr>
        <?php } ?>
