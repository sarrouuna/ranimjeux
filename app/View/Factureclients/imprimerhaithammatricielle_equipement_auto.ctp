...
<page backtop="82mm" backbottom="110mm" pagegroup="new">
    ...
    <table cellspacing="0" <?php echo $lborder ?>  style=" width: 100%; margin-left: 5mm; font-size: 3.5mm; ">
		...
		if ($lr['Lignefactureclient']['bonlivraison_id']!=$bl){     ?>
            ...
            <tr>
                ...
                <td style="width: 40%;"><strong><?php echo $lr['Bonlivraison']['numero'];?></strong></td>
...
<!--                    <tr><td>&nbsp;</td></tr>-->
                    <tr><td style="height: 6mm"><strong><?php echo number_format($factureclient[$model]['tva'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
<!--                    <tr><td>&nbsp;</td></tr>-->
                    <tr><td style="height: 6mm"><strong><?php echo number_format($factureclient[$model]['timbre_id'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
