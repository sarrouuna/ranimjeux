...
//        }
            ...
            <tr>
                ...
                <td style="width: 40%;"><?php echo substr(@$lr[$ligne_model]['designation'],0,35) ?></td>
                <td style="width: 8%;" align="center"><?php echo @$lr[$ligne_model]['quantite'] ?></td>
                <td style="width: 10%; " align="right"><?php echo @$lr[$ligne_model]['prix'] ?>&nbsp;</td>
                <td style="width: 6%;" align="center"><?php echo number_format(@$lr[$ligne_model]['tva'],2, '.', ' '); ?></td>
