...
$ligne_model = $this->request->query['ligne_model'];
$attribut = $this->request->query['attribut'];
...
foreach ($factures as $i => $facture) {
    ...
    foreach ($facture as $j => $factureclient) {
        ...
        $Modelpv = ClassRegistry::init('Pointdevente');
        $pontdevente = $Modelpv->find('first', array('conditions' => array('Pointdevente.id' => $factureclient[$model]['pointdevente_id'])));
        ...
        $footer1 = '     Site : ' . $soc['Societe']['site'] . '           E-mail: ' . $soc['Societe']['mail'] . '           Tel : ' . $soc['Societe']['tel'] . '             Fax : ' . $soc['Societe']['fax'] ;
...
//$pdf->Write(0, 'Example of HTML tables', '', 0, 'L', true, 0, false, false, 0);
        ...
        $Modelzone = ClassRegistry::init('Zone');
        $zone = $Modelzone->find('first', array('conditions' => array('Zone.id' => $factureclient['Client']['zone_id'])));
            ...
            <table border="0">
                <tr nobr="true">
                    <td height="40px" align="center" style="border: 1px solid black;" >
                        <strong style="font-size:15;">Facture N°:' . $factureclient[$model]['numero'] . '</strong><br><br> 
...
<table  cellpadding="2" cellspacing="0" >
    ...
    <tr nobr="true">
        <td align="center" style="border: 1px solid black;background-color:#b8b8b8" width="12%"><strong>code</strong></td>
        <td align="center" style="border: 1px solid black;background-color:#b8b8b8" width="33%"><strong>Article</strong></td>
...
<table cellpadding="2" cellspacing="0" >
    ...
    ';
        $objet = ClassRegistry::init($ligne_model);
        $lignefactureclients = $objet->find('all', array(
    ...
    if ($factureclient[$model]['source']=="bl"){     
    if ($lr['Lignefactureclient']['bonlivraison_id']!=$bl){ 
        $nbr_tot++;
    $tbl .='
    <tr nobr="true"> 
        <td height="20px" '.$styl_cadr.' align="center"  width="12%"></td> 
        <td align="left" '.$styl_cadr.' width="33%" ><strong>'.$lr['Bonlivraison']['numero'].'</strong></td>
        <td align="center" '.$styl_cadr.' width="10%">&nbsp;</td>  
        <td align="center" '.$styl_cadr.' width="7%">&nbsp;</td>  
        <td align="center" '.$styl_cadr.' width="10%">&nbsp;</td> 
        <td align="right" '.$styl_cadr.' width="8%">&nbsp;</td> 
        <td align="center" '.$styl_cadr.' width="10%">&nbsp;</td> 
        <td align="center" '.$styl_cadr.' width="10%">&nbsp;</td>    
    </tr>'; 
    $kk++;
    ...
    $bl=$lr['Lignefactureclient']['bonlivraison_id'];   
     ...
     <tr nobr="true"> 
        <td align="left" ' . $styl_cadr_bottom . ' width="12%" >&nbsp;' . $lr['Article']['code'] . '</td>
        <td align="left" ' . $styl_cadr_bottom . ' width="33%" >&nbsp;' . substr($lr[$ligne_model]['designation'], 0, 30) . '</td>
        <td align="center" ' . $styl_cadr_bottom . ' width="10%">&nbsp;' . $lr[$ligne_model]['quantite'] . '/' . $kk . '</td>  
        <td align="right" ' . $styl_cadr_bottom . ' width="7%" >&nbsp;' . number_format($lr[$ligne_model]['tva'], 2, '.', ' ') . '</td>
        <td align="right" ' . $styl_cadr_bottom . ' width="10%" >&nbsp;' . $lr[$ligne_model]['prix'] . '</td>
        <td align="right" ' . $styl_cadr_bottom . ' width="8%" >&nbsp;' . number_format($lr[$ligne_model]['remise'], 2, '.', ' ') . '</td>
...
';
        ...
        <td align="center" ' . $styl_cadr_fin . ' width="33%"></td>
        ...
        $tbl .= '
    <tr nobr="true">
        <td align="center" ' . $styl_cadr_hauteur . ' width="12%" >&nbsp;<br></td>
        <td align="center" ' . $styl_cadr_hauteur . ' width="33%">&nbsp;<br></td>  
...
<tr nobr="true">
        ...
        <td  align="right">' . number_format($factureclient[$model]['remise'], 3, '.', ' ') . '/' . $hauteur . '</td>
        </tr>
        <tr nobr="true">
        ...
        <td align="right">' . number_format($factureclient['Timbre']['timbre'], 3, '.', ' ') . '</td>
        </tr>
        <tr nobr="true">
...
<table >
    <tr nobr="true">
        <td   width="100%" align="left" >
            ...
            <strong style="font-size:15;">' . chifre_en_lettre($factureclient[$model]['totalttc'], 1, 1) . '</strong>
        </td>
    </tr>
</table> 
';
...
ob_end_clean();
$pdf->Output('impression.pdf', 'D');
//$pdf->Output('../webroot/files/test.pdf', 'D');
