...
<page backtop="82mm" backbottom="110mm">
        ...
        <tr>
            <td style="width: 55%;">
                <table cellspacing="0" style=" width: 100%; margin: 1mm; font-size: 3.3mm; ">
                    <tr><td align="center" style="font-size:5mm;padding-left: 17mm;"><strong >Facture <?php echo @$factureclient['Factureclient']['numero'] ?></strong></td></tr>
                    <tr><td style="height: 1mm;" ></td></tr>
                    <tr><td style="padding-left: 30mm;height: 5mm;" ><?php echo date("d/m/Y", strtotime(str_replace('-', '/',  @$factureclient['Factureclient']['date']))) ?></td></tr>
            ...
            <td style="width: 45%;">
                <table cellspacing="0" style=" width: 100%; margin: 1mm; font-size: 3.3mm; ">
                    <tr><td style="width: 100%;height: 6mm;" colspan="2"><strong style="font-size:4mm;"><?php echo @$factureclient['Client']['name'] ?></strong></td></tr>
    ...
    <table cellspacing="0" <?php echo $lborder ?>  style=" width: 100%; margin-left: 5mm; font-size: 3.5mm; ">
        ...
        if($lr['Lignefactureclient']['prix']==0){
        $lr['Lignefactureclient']['prix']="";
        }
        if($lr['Lignefactureclient']['remise']==0){
        $lr['Lignefactureclient']['remise']="";
        }
        if($lr['Lignefactureclient']['tva']==0){
        $lr['Lignefactureclient']['tva']="";
        }
        if($lr['Lignefactureclient']['totalht']==0){
        $lr['Lignefactureclient']['totalht']="";
        }
        if($lr['Lignefactureclient']['totalttc']==0){
        $lr['Lignefactureclient']['totalttc']="";
        }
         
        
            ?>
            <tr>
                <td style="width: 14%;height: 5mm"><?php echo @$lr['Article']['code'] ?></td>
                <td style="width: 40%;"><?php echo substr(@$lr['Lignefactureclient']['designation'],0,35) ?></td>
                <td style="width: 8%;" align="center"><?php echo @$lr['Lignefactureclient']['quantite'] ?></td>
                <td style="width: 10%; " align="right"><?php echo @$lr['Lignefactureclient']['prix'] ?>&nbsp;</td>
                <td style="width: 6%;" align="center"><?php echo number_format(@$lr['Lignefactureclient']['tva'],2, '.', ' '); ?></td>
                <td style="width: 7%;" align="center"><?php echo number_format(@$lr['Lignefactureclient']['remise'],2, '.', ' ') ?></td>
                <td style="width: 10%;" align="right"><?php echo number_format(@$lr['Lignefactureclient']['totalht'],3, '.', ' ') ?></td>
            </tr>
        <?php } ?>
        ...
        <tr>
            <td  style="width: 50%;">
                <table style="width: 100%;" border="0">
                    <?php $obj = ClassRegistry::init('Lignefactureclient');
                    ...
                    'conditions'=>array('Lignefactureclient.factureclient_id' => $factureclient['Factureclient']['id'])
            ...
            <td  style="width: 45%;" align="right">
                <table style="width: 100%;font-size: 3.6mm;">
                    <tr><td style="width: 100%;" ><strong><?php echo number_format($factureclient['Factureclient']['totalht']+$factureclient['Factureclient']['remise'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
                    <tr><td><strong><?php echo number_format($factureclient['Factureclient']['remise'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
                    <tr><td ><strong><?php echo number_format($factureclient['Factureclient']['totalht'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
<!--                    <tr><td>&nbsp;</td></tr>-->
                    <tr><td style="height: 6mm"><strong><?php echo number_format($factureclient['Factureclient']['tva'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
<!--                    <tr><td>&nbsp;</td></tr>-->
                    <tr><td style="height: 6mm"><strong><?php echo number_format($factureclient['Factureclient']['timbre_id'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
                    <tr><td style="height: 7mm;font-size: 5mm;vertical-align: top;"><strong><?php echo number_format($factureclient['Factureclient']['totalttc'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
        ...
        <tr>
            <td colspan="2" style="vertical-align: top;" >
                ...
                <strong style="font-size:4mm;margin-left: 15mm;"><?php echo chifre_en_lettre($factureclient['Factureclient']['totalttc'], 1, 1); ?></strong>
            </td>           
        </tr>
        
        <tr><td colspan="2" style="height: 57mm;" ></td></tr>
