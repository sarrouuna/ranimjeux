...
<table align="center" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" width="100%" >
    ...
    $i=0; $ttc=$ht=0;
       foreach ($factureclients as $br){  
        $ht=$ht+$br['Factureclient']['totalht'];
        $ttc=$ttc+$br['Factureclient']['totalttc'];
       
        ?>
        <tr bgcolor="#FFFFFF" align="center">    
        <td width="19%" nobr="nobr" align="center" height="30px" ><?php  echo $br['Client']['name'];?></td>
        <td width="10%" nobr="nobr" align="center"  ><?php  echo date("d/m/Y",strtotime(str_replace('-','/',$br['Factureclient']['date'])));?></td>
        <td width="14%" nobr="nobr" align="center"  ><?php  echo $br['Factureclient']['numero'];?></td>
        <td width="12%" nobr="nobr" align="right"  ><?php  echo $br['Factureclient']['totalht'];?></td>
        <td width="14%" nobr="nobr" align="right"  ><?php  echo $br['Factureclient']['totalttc'];?></td>
    </tr>
    
    <?php }?>
    <tr bgcolor="#FFFFFF" align="center"> 
        <td  colspan="3" nobr="nobr" align="right"  ><strong>Total</strong></td>
