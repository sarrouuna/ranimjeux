        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    ...
                    echo $this->Form->input('pv', array('value'=>2,'id'=>'pv','div' => 'form-group','label' => '','between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control', 'type' => 'hidden'));
                    ?>
                </div>      
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo __('Impression automatique Flexible'); ?></h3>
            </div>
            <div class="panel-body">
