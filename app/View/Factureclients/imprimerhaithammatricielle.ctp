    ...
    <page_header style="margin-top: 0mm " >
        <table style="width: 100%;"  border="0">
            <tr><td  style="width: 50%;" align="center">
                    <IMG SRC="../webroot/img/<?php echo @$soc["Societe"]["logo"];?>" style="width: 180px; " >
                </td>
...
<!--  <strong>M.F : </strong><?php echo @$soc['Societe']['codetva'] ;?><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RC : </strong><?php echo $soc['Societe']['rc'] ;?><br>
        ...
        <tr>
            ...
            <td align="center" style="width: 26%;border: 1px solid black;background-color:#b8b8b8;" ><strong>Désignation des Articles</strong></td>
        <td align="center" style="width:15%;border: 1px solid black;background-color:#b8b8b8;" ><strong>Image</strong></td>
 <td align="center" style="width: 7%;border: 1px solid black;background-color:#b8b8b8;" ><strong>Qte</strong></td>
            ...
            <td align="center" style="width: 8%;border: 1px solid black;background-color:#b8b8b8;" ><strong>P.U.HT</strong></td>
            <td align="center" style="width: 7%;border: 1px solid black;background-color:#b8b8b8;" ><strong>REM</strong></td>
            <td align="center" style="width: 8%;border: 1px solid black;background-color:#b8b8b8;" ><strong>TOTAL HT</strong></td>
            <td align="center" style="width: 8%;border: 1px solid black;background-color:#b8b8b8; border-radius: 0mm 3mm 0mm 0mm;-moz-border-radius: 1mm;" ><strong>P.U.TTC</strong></td>
        </tr>
        <?php
//debug($lignefactureclients);die;
  ...
  <td align="center" style="width: 7%;border: 1px solid black;background-color:#b8b8b8;" ><strong>Qte</strong></td>
                ...
                <tr>
                    ...
                    <td style="width: 26%;<?php echo $styl_cadr; ?>"><strong><?php echo $lr['Bonlivraison']['numero']; ?></strong></td>
                    <td style="width: 15%;<?php echo $styl_cadr; ?>" align="center"></td>
                    <td style="width: 7%;<?php echo $styl_cadr; ?>" align="center"></td>
                    <td style="width: 6%;<?php echo $styl_cadr; ?>" align="right"></td>
                    <td style="width: 8%;<?php echo $styl_cadr; ?>" align="center"></td>
                    <td style="width: 7%;<?php echo $styl_cadr; ?>" align="center"></td>
                    <td style="width: 8%;<?php echo $styl_cadr; ?>" align="right"></td>
                    <td style="width: 8%;<?php echo $styl_cadr; ?>" align="right"></td>
                </tr>
                <?php
                if($compteur>=41){
            ...
            if($i!=0){
                ...
                <tr>
                <td align="center" style="width: 14%;border: 1px solid black;background-color:#b8b8b8; border-radius: 3mm 0mm 0mm 0mm;-moz-border-radius: 1mm;" ><strong>code</strong></td>
                <td align="center" style="width: 26%;border: 1px solid black;background-color:#b8b8b8;" ><strong>Article</strong></td>
        <td align="center" style="width:15%;border: 1px solid black;background-color:#b8b8b8;" ><strong>Image</strong></td>
...
if ($lr['Article']['homologation']=='')
{
	$photo='';
}
else{
	$photo='<IMG SRC="../webroot/files/upload/'.@$lr['Article']['homologation'].'" height="100" width="150" >';
...
<td style="width: 26%;<?php echo $styl_cadr_bottom; ?>" align="left"><?php echo substr(@$lr[$ligne_model]['designation'], 0, 35) ?></td>
<td style="width: 15%;<?php echo $styl_cadr_bottom; ?>" align="left"><?php echo $photo;?>&nbsp;</td>
                ...
                <td style="width: 8%;<?php echo $styl_cadr_bottom; ?>" align="right"><?php echo number_format(@$lr[$ligne_model]['prix'], 3, '.', ' '); ?></td>
                <td style="width: 7%;<?php echo $styl_cadr_bottom; ?>" align="center"><?php echo number_format(@$lr[$ligne_model]['remise'], 2, '.', ' ') ?></td>
                <td style="width: 8%;<?php echo $styl_cadr_bottom; ?>" align="right"><?php echo number_format(@$lr[$ligne_model]['totalht'], 3, '.', ' ') ?></td>
                <td style="width: 8%;<?php echo $styl_cadr_bottom; ?>" align="right"><?php echo number_format(@$lr[$ligne_model]['puttc'], 3, '.', ' ') ?></td>
        ...
        <?php
            ...
            <tr>
                ...
                <td  style="width: 26%;<?php echo $styl_cadr_bottom; ?>"></td>
                <td  style="width: 15%;<?php echo $styl_cadr_bottom; ?>"></td>
                <td  style="width: 7%;<?php echo $styl_cadr_bottom; ?>"></td>
                <td  style="width: 6%;<?php echo $styl_cadr_bottom; ?>"></td>
                <td  style="width: 8%;<?php echo $styl_cadr_bottom; ?>"></td>
                <td  style="width: 7%;<?php echo $styl_cadr_bottom; ?>"></td>
                <td  style="width: 8%;<?php echo $styl_cadr_bottom; ?>"></td>
                <td  style="width: 8%;<?php echo $styl_cadr_bottom; ?>;border-radius: 0mm 0mm 3mm 0mm;-moz-border-radius: 1mm;"></td>
            </tr>
    </table>
    <?php
...
<table>
 <tr>
            ...
            SARL au Capital de :  <?php echo $soc['Societe']['capital'] ;?>  R.C: <?php echo $soc['Societe']['rc'] ;?> Code T.V.A: <?php echo $soc['Societe']['codetva'] ;?> Code BTS :&nbsp;&nbsp;8585 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    RIB: <?php echo $soc['Societe']['rib']; ?>
