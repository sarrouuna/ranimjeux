    ...
    <div class="col-md-12" >
        <div class="panel panel-default">
            ...
            <div class="panel-body not_height">
                ...
                <div class="col-md-4">
                    <?php
                    echo $this->Form->input('client_id', array('id' => 'client_id', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control select infoclientbb inputspcial', 'empty' => 'Veuillez Choisir !!'));
                ...
                <div class="col-md-4">
                    ...
                    echo $this->Form->input('typeclientid', array('value' => $typeclient_id, 'type' => 'hidden', 'id' => 'typeclientid', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control inputspcial'));
                    ?>
...
//                            else {
//                                $obj = ClassRegistry::init('Articlecomposante');
//                                $articlescomposantes = $obj->find('all', array(
//                                    'conditions' => array('Articlecomposante.article_id' => $l[$ligne_model]['article_id']),
//                                    'recursive'=>-1
//                                ));
//
//                                $minimum = 0;
...
//
//                                    $stock = $objStockdepot->find('first', array(
//                                        'conditions' => array('Stockdepot.article_id' => $articlescomposante['Articlecomposante']['composant'],
//                                            'Stockdepot.depot_id' => $this->request->data[$model]['depot_id'], 'Stockdepot.quantite >' => 0),
//                                        'recursive'=>-1,
//                                        'order' => array('Stockdepot.date_exp' => 'asc'), false));
////                                    debug($stock);
////                                    debug($stock['Stockdepot']['quantite']);
////                                    debug($articlescomposante['Articlecomposante']['qte']);
//                                    $division = $stock['Stockdepot']['quantite'] / $articlescomposante['Articlecomposante']['qte'];
////                                    debug($division);
//                                    if ($k == 0) {
//                                        $minimum = $division;
//                                    } else {
                                ...
                                <td width="1%" id="tdaff<?php echo $i; ?>" >
                                    <?php if ($l[$ligne_model]['composee'] == 1) { ?>
                                        <span title="Nouveau Article" champ="nouveauart" id="nouveauart<?php echo $i; ?>">
                                            <a onClick="flvFPW1(wr + 'Factureclients/recap_nouveau_prix/<?php echo $i; ?>/<?php echo $l['Article']['id']; ?>/<?php echo $l[$ligne_model]['quantite']; ?>/<?php echo $l[$ligne_model]['depotcomposee']; ?>/<?php echo 1; ?>/', 'UPLOAD', 'width=1200,height=600,scrollbars=yes', 0, 2, 2);return document.MM_returnValue" href="javascript:;" > <i class="glyphicon glyphicon-plus" index=<?php echo $i; ?> style="color:#0080FF"></i> </a>
                                        </span>
                                    <?php } else { ?>
...
//                                    echo $this->Form->input('code', array('div' => 'form-group', 'placeholder' => 'Code', 'label' => '', 'name' => '', 'table' => $tablesemi, 'index' => '', 'id' => '', 'champ' => 'code', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control alicode', 'type' => 'text'));
                                ...
                                <td width="7%">
                                    ...
                                    if (empty($l[$ligne_model]['composee'])) {
                                        ...
                                        echo $this->Form->input('quantite', array('readonly' => 'readonly', 'value' => $l[$ligne_model]['quantite'], 'onkeypress' => 'fuckfocus("input","' . $i . '",this.getAttribute("name"))', 'label' => '', 'div' => 'form-group', 'name' => 'data[' . $tablesemi . '][' . $i . '][quantite]', 'table' => $tablesemi, 'index' => $i, 'id' => 'quantite' . $i, 'champ' => 'quantite', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control testqte   calculefacture '));
                                    }
                                    ?>
                                ...
                                <td width="9%">
                                    <?php echo $this->Form->input('pmp', array('value' => @$l[$ligne_model]['pmp'], 'type' => 'hidden', 'div' => 'form-group', 'label' => '', 'name' => 'data[' . $tablesemi . '][' . $i . '][pmp]', 'table' => $tablesemi, 'index' => $i, 'id' => 'pmp' . $i, 'champ' => 'pmp', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control'));
                                    ?>
                                    <?php echo $this->Form->input('prixachat', array('div' => 'form-group', 'label' => '', 'name' => 'data[' . $tablesemi . '][' . $i . '][prixachat]', 'table' => $tablesemi, 'index' => $i, 'id' => 'prixachat' . $i, 'champ' => 'prixachat', 'type' => 'hidden', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control ')); ?>
                                    <?php echo $this->Form->input('prix', array('onkeypress' => 'fuckfocus("input","' . $i . '",this.getAttribute("name"))', 'value' => $l[$ligne_model]['prix'], 'div' => 'form-group', 'label' => '', 'name' => 'data[' . $tablesemi . '][' . $i . '][prixhtva]', 'table' => $tablesemi, 'index' => $i, 'id' => 'prixhtva' . $i, 'champ' => 'prix', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculeinverseputtc')); ?>
                                </td>
                                <td width="5%">
                                    <?php
                                ...
                                <td  width="9%">
                                    <?php
                                    echo $this->Form->input('puttc', array('onkeypress' => 'fuckfocus("input","' . $i . '",this.getAttribute("name"))', 'value' => @$l[$ligne_model]['puttc'], 'div' => 'form-group', 'label' => '', 'name' => 'data[' . $tablesemi . '][' . $i . '][puttc]', 'table' => $tablesemi, 'index' => $i, 'id' => 'puttc' . $i, 'champ' => 'puttc', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  calculeprixvente'));
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="col-lg-9 col-lg-offset-3">
                            <button type="submit" class="btn btn-primary testautorisation testlignedevente  testpv ">Enregistrer</button>
                        </div>
                    </div>   
                </div>
