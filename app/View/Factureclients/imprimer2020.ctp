    ...
    <page_header style="margin-top: 0mm " >
        <table style="width: 100%;"  border="0">
            <tr><td  style="width: 40%;" align="center">
                    <IMG SRC="../webroot/img/<?php echo @$soc["Societe"]["logo"];?>" style="width: 100px; " >
                </td>
                    ...
                    <table>
                        <tr>
                           ...
                           <strong>    Siege:  </strong> <?php echo @$soc['Societe']['adresse'] ;?><br>
                               ...
                               <strong>Site : </strong><?php echo @$soc['Societe']['site'] ;?><br>   
                        ...
                        <tr>
                            <td style="font-size:3mm;width: 100%;border: 3px solid black;height:80px; border-radius: 3mm;-moz-border-radius: 1mm;" align="left">
                              ...
                              &nbsp;  Client&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-size:3mm;"><?php echo @$factureclient[$model]['name']; ?></strong><br>
                               ...
                               &nbsp; Ville&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-size:3mm;"><?php echo @$zone['Zone']['name']; ?></strong><br>&nbsp; Téléphone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-size:3mm;"><?php echo @$factureclient['Client']['tel']; ?></strong><br> 
                            </td>     
                        </tr>
                    </table>
                </td>
