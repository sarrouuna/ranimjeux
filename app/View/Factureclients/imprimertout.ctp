...
<table align="center" cellpadding="0" cellspacing="0"  style=" width: 100%; font-size: 3mm;" border="1">
    <tr  bgcolor="#CCCCCC" align="center" >
        <th style=" width: 5%;" align="center"  ><strong>N° Fact</strong></th>
        <th style=" width: 5%;" align="center"  ><strong>Date</strong></th>
        <th style=" width: 10%;" align="center"  height="30px" ><strong>Nom_Prenom</strong></th>
...
-->               <th style=" width: <?php echo $w; ?>%;" align="center"  ><strong>Total HT Brut</strong></th>
                <th style=" width: <?php echo $w; ?>%;" align="center"  ><strong>Net HT</strong></th>
                 <th style=" width: <?php echo $w; ?>%;" align="center"  ><strong>Remise</strong></th>
               <th style=" width: <?php echo $w; ?>%;" align="center"  ><strong>TVA <?php echo intval(floatval($t['Tva']['name'])); ?>%</strong></th>
        <?php } ?>
        <th style=" width: 5%;" align="center"  ><strong>TVA 18%</strong></th>
        <th style=" width: 5%;" align="center"  ><strong>Fodec</strong></th>
    ...
    foreach ($tablignefactures as $br) {
        ...
        <tr bgcolor="#FFFFFF" align="center">
            ...
            foreach ($tvas as $v) { //debug($v);
                ...
                <td  align="right"  ><?php echo  $br['remise']; ?></td>
                <td  align="right"  ><?php echo $tvav; ?></td>
            <?php } ?>


            <td  align="right"  ><?php echo $tva18; ?></td>
            <td  align="right"  ><?php echo $br['fodec']; ?></td>
    ...
    <tr  bgcolor="#CCCCCC" align="center">
        ...
        foreach ($tf as $y) {?>
            ...
            <th width="<?php echo $w; ?>%" align="right"  ><?php echo sprintf("%.3f", $totnetht); ?></th>
            <th width="<?php echo $w; ?>%" align="right"  ><?php echo sprintf("%.3f",  $totremise); ?></th>
            <th width="<?php echo $w; ?>%" align="right"  ><?php echo sprintf("%.3f", $y['montant']); ?></th>
            <?php } ?>
        <th width="5%" align="right"  ><?php echo sprintf("%.3f", $tva18); ?></th>
        <th width="5%" align="right"  ><?php echo sprintf("%.3f", $totfdec); ?></th>
