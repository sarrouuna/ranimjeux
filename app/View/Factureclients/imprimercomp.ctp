...
<page backtop="60mm" backbottom="10mm" footer="page">
    <page_header style="margin-top: 0mm " >
        ...
        <table cellspacing="0"  style="width: 100%;font-size: 3mm;border: 1px solid black;margin-top:3mm;">
        <tr>
            <td align="center" style="width: 14%;border: 1px solid black;background-color:#b8b8b8;" ><strong>code</strong></td>
            ...
            <td align="center" style="width: 10%;border: 1px solid black;background-color:#b8b8b8;" ><strong>P.U.TTC</strong></td>
        </tr>
        </table>
    </page_header>
...
//debug($lignefactureclients);die;
        ...
        foreach ($lignefactureclients as $i => $lr) {
            ...
            ?>
            <tr>
                <td style="width: 14%;height: 4mm;<?php echo $styl_cadr_bottom; ?>" align="left"><?php echo @$lr['Article']['code']; ?></td>
                <td style="width: 36%;<?php echo $styl_cadr_bottom; ?>" align="left"><?php echo @$lr[$ligne_model]['designation']; ?></td>
        ...
        <?php  
            ...
            <tr>
                <td  style="width: 14%;<?php echo $styl_cadr_bottom; ?>;height: <?php echo @$long; ?>mm;"></td>
