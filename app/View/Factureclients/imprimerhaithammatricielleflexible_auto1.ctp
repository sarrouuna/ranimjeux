...
<page backtop="75mm" backbottom="110mm" pagegroup="new">
    ...
    <table cellspacing="0" <?php echo $lborder ?>  style=" width: 100%; margin-left: 3mm; font-size: 3.5mm;">
       ...
       // debug($lignefactureclients);die;
         $kk=0;$bl=0;
        foreach ($factureclient['Lignefactureclient'] as $i=>$lr){
        $kk++;
        if ($lr['bonlivraison_id']!=$bl){     ?>
        ...
        $bl=$lr['bonlivraison_id'];
        
            ?>
            <tr>
                <td style="width: 14%;height: 5mm"><?php echo substr(@$lr['Article']['code'],0,13) ?></td>
                <td style="width: 41%;"><?php echo substr(@$lr['designation'],0,35) ?></td>
                <td style="width: 8%;" align="center"><?php echo @$lr['quantite'] ?></td>
                <td style="width: 11%; " align="right"><?php echo @$lr['prix'] ?>&nbsp;</td>
                <td style="width: 6%;" align="center"><?php echo number_format(@$lr['tva'],2, '.', ' '); ?></td>
                <td style="width: 6%;" align="center"><?php echo number_format(@$lr['remise'],2, '.', ' ') ?></td>
                <td style="width: 11%;" align="right"><?php echo number_format(@$lr['totalht'],3, '.', ' ') ?></td>
            </tr>
        <?php } ?>
    </table>
...
<!--                    <tr><td>&nbsp;</td></tr>-->
        ...
        <tr><td colspan="2" style="height: 40mm;" ></td></tr>
...
<?php } ?>    
    ...
    try
    {
        ...
        $html2pdf->Output('FC_matricielle.pdf','D');
    }
