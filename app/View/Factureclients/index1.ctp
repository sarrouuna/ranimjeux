                        ...
                        <thead>
                            ...
                            foreach ($factureclients as $factureclient):
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php //if ($factureclient['Factureclient']['Montant_Regler']!=0){ ?>
                                        <a href="#reModal_refuser"  onClick="recap_reglement_client(<?php echo $factureclient['Factureclient']['id'] ?>)"  ><button class="btn ls-red-btn btn-round"><i class='fa fa-dollar'></i></button></a>
                                        <?php // } ?>
                                    </td>
