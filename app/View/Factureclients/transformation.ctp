...
//                    debug($entete);die;
                ...
                <div class="col-md-4">
					...
					echo $this->Form->input('Montant_Regler', array('type'=>'text','value' => $bonliv['Bonlivraison']['Montant_Regler'], 'readonly' => $readonly, 'id' => 'montantreg', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control'));
					?>
                    <?php
...
//debug($l);die;
                            ...
                            <tr class="cc<?php echo $i; ?> testclientvide" >
                                ...
                                <td width="5%">
                                    <?php echo $this->Form->input('tva', array('readonly' => 'readonly', 'value' => $l[$ligne_model_ans]['tva'], 'div' => 'form-group', 'label' => '', 'name' => 'data[' . $tablesemi . '][' . $i . '][tva]', 'table' => $tablesemi, 'index' => $i, 'id' => 'tva1' . $i, 'champ' => 'tva', 'type' => 'text', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculefacture')); ?>
                                </td>
                                <td width="9%">
