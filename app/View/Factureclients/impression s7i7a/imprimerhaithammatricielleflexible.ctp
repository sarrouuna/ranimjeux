...
<page backtop="78mm" backbottom="110mm">
...
//        }
            ...
            <tr>
                ...
                <td style="width: 12%; " align="right"><?php echo @$lr[$ligne_model]['prix'] ?>&nbsp;</td>
...
<!--                    <tr><td>&nbsp;</td></tr>-->
                    <tr><td style="height: 11mm;vertical-align: middle;"><strong><?php echo number_format($factureclient[$model]['tva'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
<!--                    <tr><td>&nbsp;</td></tr>-->
                    <tr><td style="height: 5mm;vertical-align: top;"><strong><?php echo number_format($factureclient[$model]['timbre_id'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
