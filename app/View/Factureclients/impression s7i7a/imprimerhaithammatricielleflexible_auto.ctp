       ...
       // debug($lignefactureclients);die;
        ...
        $bl=$lr['Lignefactureclient']['bonlivraison_id'];
            ...
            <tr>
                ...
                <td style="width: 45%;"><?php echo substr(@$lr['Lignefactureclient']['designation'],0,35) ?></td>
                <td style="width: 9%;" align="center"><?php echo @$lr['Lignefactureclient']['quantite'] ?></td>
                <td style="width: 12%; " align="right"><?php echo @$lr['Lignefactureclient']['prix'] ?>&nbsp;</td>
                <td style="width: 7%;" align="center"><?php echo number_format(@$lr['Lignefactureclient']['tva'],2, '.', ' '); ?></td>
...
<!--                    <tr><td>&nbsp;</td></tr>-->
                    <tr><td style="height: 11mm"><strong><?php echo number_format($factureclient[$model]['tva'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
<!--                    <tr><td>&nbsp;</td></tr>-->
                    <tr><td style="height: 5mm;vertical-align:bottom;"><strong><?php echo number_format($factureclient[$model]['timbre_id'],3, '.', ' ') ?></strong>&nbsp;&nbsp;</td></tr>
        ...
        <tr>
            <td colspan="2" style="vertical-align: top;" >
                <strong style="font-size:4.5mm;margin-left: 5mm;">Arreter la présente Facture Client à  la somme de :</strong>
                <strong style="font-size:4mm;"><?php echo chifre_en_lettre($factureclient[$model]['totalttc'], 1, 1); ?></strong><br>
        ...
        <tr><td colspan="2" style="height: <?php echo $h ;?>mm;" ></td></tr>
