...
<table cellpadding="2" cellspacing="0" >
    ...
    $tbl .='
    <tr> 
        <td '.$styl_cadr.'  width="15%"></td> 
        <td '.$styl_cadr.'  width="36%" ><strong>'.$lr['Bonlivraison']['numero'].'</strong></td>
        <td '.$styl_cadr.'  width="7%">&nbsp;</td>  
        <td '.$styl_cadr.'  width="7%">&nbsp;</td>  
        <td '.$styl_cadr.' width="10%">&nbsp;</td> 
        <td '.$styl_cadr.' width="5%">&nbsp;</td> 
        <td '.$styl_cadr.' width="10%">&nbsp;</td>  
        <td '.$styl_cadr.' width="10%">&nbsp;</td> 
    </tr>'; 
    $kk++;
