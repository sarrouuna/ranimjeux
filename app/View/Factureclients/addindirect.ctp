...
<div class="row" >
		...
		echo $this->Form->input('model',array('id'=>'model','type'=>'hidden','value'=>'Factureclient','div'=>'form-group','readonly'=>'readonly','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control') );
              ...
              // debug($this->request->data);die;
                ...
                <input id="vente" name="data[Factureclient][vente]" value="<?php echo $vente; ?>" type="hidden">
                <div class="form-group" >
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="radio"  name="data[Factureclient][vent]" id="optionsRadios11" value="detail" <?php if($vente=='detail'){ ?> checked <?php } ?> >Detail

                        <!-- </label>
                         <label class="radio-inline">-->
                        <input type="radio"  name="data[Factureclient][vent]" id="optionsRadios12" value="gros" <?php if($vente=='gros'){ ?> checked <?php } ?> >Gros
                            ...
                            <div class="panel panel-default" >
                               ...
                               <tr class="tr" style="display:none;" >
                                   ...
                                   <td >
                                    ...
                                    <td >
                                        <?php echo $this->Form->input('ans',array('name'=>'','id'=>'','champ'=>'ans','table'=>'Lignefactureclient','index'=>'','div'=>'form-group','between'=>'<div class="col-sm-10">','after'=>'</div>','type'=>'hidden','class'=>'form','label'=>'') );?>
                              ...
                              <tr class="tr" style="display:none;" >
                                 ...
                                 <?php //debug($lignelivraisons);die;
                                 
                                 foreach ($lignelivraisons as $i=>$l){  //debug($l);die; ?>
                                     <?php
                                     $qtestock=0;
                                     $objStockdepot = ClassRegistry::init('Stockdepot');
                                     $stock = $objStockdepot->find('first',array('conditions'=> array('Stockdepot.article_id' => $l['Lignelivraison']['article_iddd'],
...
//debug($stock);die;
                                     ...
                                     $article = $objArticle->find('first',array('conditions'=> array('Article.id' => $l['Lignelivraison']['article_iddd']),'recursive'=>-1));
                                     ?>
                                 <tr class="cc testclientvide" >
                                   ...
                                   <span title="Ancien prix"> <a  onclick="recap_rapport(<?php echo $i; ?>)" href="#reModal_refuser" champ="order" id="order<?php echo $i; ?>" value="<?php echo $i; ?>" <button class='  '><i class='fa fa fa-pencil'></i></a></span>
                                    ...
                                    <td   >
                                       <?php //echo $this->Form->input('article_id',array('value'=>$l[0]['article_id'],'div'=>'form-group','label'=>'',  'name' => 'data[Lignefactureclient]['.$i.'][article_id]','table'=>'Lignefactureclient','index'=>$i,'id'=>'article_id'.$i,'champ'=>'article_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control select articleidbl','empty'=>'Veuillez choisir !!') );?>
                                        <div class="" style="display:inline; position: relative;">
                                            <?php
                                     ...
                                     <td >
                                        <?php echo $this->Form->input('id',array('value'=>$l['Lignelivraison']['id'],'name'=>'data[Lignefactureclient]['.$i.'][id]','id'=>'id'.$i,'champ'=>'id','table'=>'Lignefactureclient','index'=>$i,'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control') );?>
                                        <?php echo $this->Form->input('ans',array('value'=>1,'name'=>'data[Lignefactureclient]['.$i.'][ans]','id'=>'ans'.$i,'champ'=>'ans','table'=>'Lignefactureclient','index'=>$i,'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control') );?>
                                        <?php echo $this->Form->input('sup',array('name'=>'data[Lignefactureclient]['.$i.'][sup]','id'=>'sup'.$i,'champ'=>'sup','table'=>'Lignefactureclient','index'=>$i,'div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control') );?>
                                    ...
                                    <td >
                                     ...
                                     <?php echo $this->Form->input('prix',array('value'=>sprintf("%.3f",$l[0]['prix']/$l[0]['quantite']),'onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','div'=>'form-group','label'=>'', 'name' => 'data[Lignefactureclient]['.$i.'][prixhtva]','table'=>'Lignefactureclient','index'=>$i,'id'=>'prixhtva'.$i,'champ'=>'prix','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeinverseputtc') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('remise',array('value'=>$l[0]['remise']/$l[0]['quantite'],'div'=>'form-group','onkeypress'=>'fuckfocus("input","'.$i.'",this.getAttribute("name"))','label'=>'', 'name' => 'data[Lignefactureclient]['.$i.'][remise]','table'=>'Lignefactureclient','index'=>$i,'id'=>'remise'.$i,'champ'=>'remise','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculeprix_net_ttc calculefacture') );
                                     ...
                                     echo $this->Form->input('totalhtans',array('value'=>$l[0]['prix']/$l[0]['quantite'],'type'=>'hidden','div'=>'form-group','label'=>'','readonly'=>'readonly', 'name' => 'data[Lignefactureclient]['.$i.'][totalhtans]','table'=>'Lignefactureclient','index'=>$i,'id'=>'totalhtans'.$i,'champ'=>'totalhtans','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php
                                     echo $this->Form->input('totalht',array('value'=>$l[0]['totalht'],'div'=>'form-group','label'=>'','readonly'=>'readonly', 'name' => 'data[Lignefactureclient]['.$i.'][totalht]','table'=>'Lignefactureclient','index'=>$i,'id'=>'totalht'.$i,'champ'=>'totalht','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control ') );?>
                                    </td>
                                    <td >
                                     <?php echo $this->Form->input('tva',array('value'=>$l[0]['tva'],'div'=>'form-group','readonly'=>'readonly','label'=>'', 'name' => 'data[Lignefactureclient]['.$i.'][tva]','table'=>'Lignefactureclient','index'=>$i,'id'=>'tva'.$i,'champ'=>'tva','type'=>'text','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control calculefacture') );?>
                                    </td>
                                    <td >
