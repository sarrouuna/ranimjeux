...
<tr>
    ...
    <td  width="45%">
        <table width="100%">
            <tr>
            <br> 
                <td height="35px" align="left" ><strong>Bon d\'entre N° : '.$bonentre['Bonentre']['numero'].'</strong></td> 
            </tr> 
        </table>
    </td>
</tr>
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" >
                        <strong>'.$bonentre['Fournisseur']['name'].'</strong>
                        <br>
                        '.$bonentre['Fournisseur']['adresse'].'
                    </td> 
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        ...
                        <br>
                        '.$bonentre['Fournisseur']['matriculefiscale'].'
                    </td> 
        ...
        <td width="49%">
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" >
                       <br><br> 
              <strong>Bon d\'entre N° </strong>'.$bonentre['Bonentre']['numero'].'
    </td> 
            ...
            <table border="0">
                <tr>
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Date</strong>
                        <br>
                        '.date("d/m/Y",strtotime(str_replace('-','/',($bonentre['Bonentre']['date'])))).'
                    </td>
                    
                    <td height="40px" align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;">
                        <strong>Fournisseur N°</strong>
                        <br>
                        '.$bonentre['Fournisseur']['code'].'
                    </td>
...
<table cellpadding="2" cellspacing="0" >
    ...
    <tr>
         <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="25%"><strong>Dépot</strong></td>
        ...
        <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="25%"><strong>Date de validité</strong></td>
        <td align="center" style="border-bottom:solid #000 2px;border-top:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="25%"><strong>Quantité</strong></td>
      </tr>
    </thead>';

$long="670";
          $n=0;
                     foreach ($ligneentres as $i=>$lr){
                                       
                       if ($lr['Ligneentre']['date']){   $datevalidite=date("d/m/Y",strtotime(str_replace('-','/',$lr['Ligneentre']['date'])));}
...
$tbl .='
     ...
     <tr> 
        <td align="center" style="border-bottom:solid #000 2px;border-left:solid #000 2px;border-right:solid #000 2px;" width="25%" >&nbsp;<br>'. $lr['Depot']['designation'].'</td>
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="25%">&nbsp;<br>'. $lr['Article']['name'].'</td>   
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="25%">&nbsp;<br>'.@$datevalidite.'</td>  
        <td align="center" style="border-bottom:solid #000 2px;border-right:solid #000 2px;" width="25%">&nbsp;<br>'.$lr['Ligneentre']['quantite'].'</td>  
