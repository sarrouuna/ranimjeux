                   ...
                   <div class="row ligne" >
                    ...
                    <a class="btn btn-danger  ajouterligne_be" table='addtable<?php echo $i; ?>' index='index'  tr="tr"><i class="fa fa-plus-circle"  ></i>  </a>
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%">
                                       <?php echo $this->Form->input('sup',array('name'=>'data[Lignefactureavoir]['.$i.'][Detail][0][sup]','id'=>'sup0','champ'=>'sup','table'=>'Lignefactureavoir','index'=>'0','div'=>'form-group','between'=>'<div class="col-sm-10">','type'=>'hidden','after'=>'</div>','class'=>'form-control ','required data-bv-notempty-message'=>'Champ Obligatoire','label'=>'Nom') );?>
                                       <?php echo $this->Form->input('depot_id',array('div'=>'form-group','label'=>'', 'name' => 'data[Lignefactureavoir]['.$i.'][Detail][0][depot_id]','table'=>'Lignefactureavoir','index'=>$k,'id'=>'depot_id'.$k,'champ'=>'depot_id','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control','empty'=>'Veuillez Choisir !!') );?>
                                    </td>
                                    <td  style="width:30%">
                                        <?php echo $this->Form->input('datevalidite',array('label'=>'','div'=>'form-group', 'name' => 'data[Lignefactureavoir]['.$i.'][Detail][0][datevalidite]','ligne'=>$i,'table'=>'Lignefactureavoir','index'=>$k,'id'=>'datevalidite'.$k,'champ'=>'datevalidite','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control datePickerOnly','type'=>'text','required data-bv-notempty-message'=>'Champ Obligatoire') );?>
                                    </td>
                                     <td style="width:30%">
                                        <?php  echo $this->Form->input('qte',array('label'=>'','div'=>'form-group', 'name' => 'data[Lignefactureavoir]['.$i.'][Detail][0][qte]','ligne'=>$i,'table'=>'Lignefactureavoir','index'=>$k,'id'=>'qte'.$k,'champ'=>'qte','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control testqtebe testle ','required data-bv-notempty-message'=>'Champ Obligatoire') );?>
                                     </td>
