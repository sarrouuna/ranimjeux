    ...
    <div class="col-md-12" >
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo __('modification Inventaire par article'); ?></h3>
            </div>
...
//                    echo $this->Form->input('article_id', array('value' => $articleinventaires['Ligneinventaire']['article_id'], 'id' => 'article_id', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control', 'empty' => 'Veuillez Choisir !!'));
                    echo $this->Form->input('article_id', array('value' => $articleinventaires['Ligneinventaire']['article_id'],'div' => 'form-group', 'index' => '0', 'id' => 'article_id0', 'champ' => 'article_id', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control', 'type' => 'hidden'));
                    echo $this->Form->input('dateinv', array('label' => 'Date', 'value' => date("d/m/Y", strtotime(str_replace('/', '-', $inventaire['Inventaire']['date']))), 'div' => 'form-group', 'type' => 'text', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control datePickerOnly'));
                    ?>
                    <div class="col-dm-6" style="display:inline; position: relative;">
                        <?php echo $this->Form->input('designation', array('value' => $articleinventaires['Article']['nom'],'div' => 'form-group', 'placeholder' => 'Designation', 'label' => 'Article', 'index' => '0', 'id' => 'designation0', 'champ' => 'designation', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control haithamselect', 'type' => 'text')); ?>
                                        ...
                                        foreach ($ligneinventaires as $i => $af) {
                                            ...
                                            <tr>
                                                <td style="width:70%">
                                                    ...
                                                    <?php echo $this->Form->input('depot_id', array('value' => $af['Ligneinventaire']['depot_id'], 'div' => 'form-group', 'label' => '', 'name' => 'data[Ligneinventaire][' . $i . '][depot_id]', 'table' => 'Ligneinventaire', 'index' => $i, 'id' => 'depot_id' . $i, 'champ' => 'depot_id', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control select ', 'empty' => 'Veuillez choisir !!')); ?>
                                                </td>
                                                <td style="width:28%">
